...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/union/union_exp_appr/add.js"
            charset="utf-8"></script>
...
<div class="modal fade" style="display: none;pointer-events:auto" id="checkModal" tabindex="-1" role="dialog"
