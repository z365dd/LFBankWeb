...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/union/union_exp_appr/info.js"
            charset="utf-8"></script>
                        ...
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="signDate"
                                               name="signDate" style="width: 200px" readonly/>
                                    </div>
                                ...
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="brch"
                                               name="brch" style="width: 200px" readonly/>
                                    </div>
                                    <span style="margin: 1% 0 0 6%;color: red">  </span>
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="unsignDate"
                                               name="unsignDate" style="width: 200px" readonly/>
                                    </div>
                                ...
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="custMngName"
                                               name="custMngName" style="width: 200px" readonly/>
                                    </div>
                                    <span style="margin: 1% 0 0 6%;color: red">  </span>
                                ...
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="stat"
                                               name="stat" style="width: 200px" readonly/>
                                    </div>
