...
<head>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/com/limit_mng/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="缴费明细列表查询" aria-expanded="true" url="${ctx}/limitMng/page/list">
                        商户限额列表查询
                    </a>
                </li>
                <li>
                    <a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/limitMng/page/add">
                        商户限额新增
                    </a>
                </li>
                <li>
                    <a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/limitMng/page/modify">
                        商户限额修改
                    </a>
                </li>
<%--                <li>--%>
