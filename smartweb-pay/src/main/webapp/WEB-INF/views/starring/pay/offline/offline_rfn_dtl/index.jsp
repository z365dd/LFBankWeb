...
<head>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/offline/offline_rfn_dtl/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="批量退款明细查询" aria-expanded="true" url="${ctx}/offline_rfn_dtl/page/list">
                        批量退款明细查询
                    </a>
                </li>
                <li>
                    <a href="#tab_info" data-toggle="tab" aria-expanded="false" url="${ctx}/offline_rfn_dtl/page/info">
                        批量退款明细详情
                    </a>
                </li>
            </ul>
