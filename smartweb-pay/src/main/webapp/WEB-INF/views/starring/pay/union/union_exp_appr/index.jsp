...
<head>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/union/union_exp_appr/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="报销审批" aria-expanded="true" url="${ctx}/union_exp_appr/page/list">
                        报销审批
                    </a>
                </li>
                <li>
                    <a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/union_exp_appr/page/add">
                        新增报销
                    </a>
                </li>
                <li>
                    <a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/union_exp_appr/page/modify">
                        报销修改
                    </a>
                </li>
                <li>
                    <a href="#tab_info" data-toggle="tab" aria-expanded="false" url="${ctx}/union_exp_appr/page/info">
                        报销删除
                    </a>
                </li>
            </ul>
