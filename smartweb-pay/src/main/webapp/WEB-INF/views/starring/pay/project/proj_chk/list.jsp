...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/project/proj_chk/list.js"
            charset="utf-8"></script>
                    ...
                    <form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="from" method="post">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                            ...
                            <div class="col-md-12 column">
                                ...
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="efftFlg" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            协议有效性：
                                        </label>
                                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12 column">
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            >
                                                <option value="">不限</option>
                                                <option value="10">已签约</option>
                                                <option value="20">已解约</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="inspStat" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            巡检状态：
                                        </label>
                                        <div class="col-sm-6">
                                            ...
                                            >
                                                <option value="">不限</option>
                                                <option value="01">已巡检</option>
                                                <option value="02">未巡检</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
