...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/buscard/buscard_unconfm_qry/list.js"
            charset="utf-8"></script>
                    ...
                    <form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="from" method="post">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                            ...
                            <div class="col-md-12 column">
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="acct" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            账号：
                                        </label>
                                        <div class="col-sm-6">
                                ...
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="appId" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            应用标识号：
                                        </label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" placeholder="" id="appId"
                                                   name="appId"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="strDate" name="strDate" type="text" readonly="readonly"
                                                   ...
                                                   style="width:200px"
                                                   value=""
                                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false, minDate:'{%y-3}-%M-%d',maxDate: '#F{$dp.$D(\'endDate\')}'});"/>
                                        </div>
                                    ...
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input id="endDate" name="endDate" type="text" readonly="readonly"
                                                   ...
                                                   style="width:200px"
                                                   value=""
                                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false, minDate: '#F{$dp.$D(\'strDate\',maxDate: new Date())}'});"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 column" hidden>
                                ...
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="confmStat" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            确认状态：
                                        </label>
                                        <div class="col-sm-4">
