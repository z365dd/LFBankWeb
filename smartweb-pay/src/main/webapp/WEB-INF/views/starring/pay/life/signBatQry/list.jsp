...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/life/signBatQry/list.js"
            charset="utf-8"></script>
                    ...
                    <form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="from" method="post">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                                        ...
                                        <div ravo="rainbow_fx" class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input id="strDate" name="strDate" type="text" readonly="readonly"
                                                       ...
                                                       style="width: 200px"
                                                       value=""
                                                       onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true, maxDate: new Date()});"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 column">
                            ...
                            <div class="col-md-12 column">
                                ...
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="custNo" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            核心客户号：
                                        </label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" placeholder="" id="custNo"
                                                   name="custNo" style="width: 200px"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 column">
                                ...
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="signStat" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            签约状态：
                                        </label>
                                        <div class="col-sm-5">
                            ...
                            <div class="col-md-12 column">
                                <div class="col-md-6 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="signBrch" class="col-sm-3 control-label control-label"
                                               style="visibility: visible">
                                            签约机构：
                                        </label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" placeholder="" id="signBrch"
                                                   name="signBrch" style="width: 200px"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
