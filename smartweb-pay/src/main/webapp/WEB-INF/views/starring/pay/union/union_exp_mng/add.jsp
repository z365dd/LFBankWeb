...
info.jsp
list.jsp
update.jsp<%@ page language="java" contentType="text/html; charset=utf-8" %>
...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/union/union_exp_mng/add.js"
            charset="utf-8"></script>
                        ...
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                                ...
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        <select
                                                ...
                                                checkBtn="projTp"
                                        >
                                            <option value="01">代收</option>
                                            <option value="02">代付</option>
                                            <option value="03">缴费</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="custName"
                                               name="custName" style="width: 200px"/>
                                    </div>
                                    <span style="margin: 1% 0 0 6%;color: red">*  </span>
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="acct"
                                               name="acct" style="width: 200px"/>
                                    </div>
                                    <span id="input1" style="display:none;margin: 1% 0 0 6%;color: red" >*  </span>
                                </div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        >
                                            ...
                                            <option value="02">半年</option>
                                            <option value="03">一年</option>
                                        </select>
                                    </div>
                                    <span style="margin: 1% 0 0 6%;color: red">*  </span>

                                    <label for="signDate" class="col-sm-2 control-label control-label"
                                           style="visibility: visible">
                                        协议签约日期：
                                    </label>
                                    <div class="col-sm-3">
                                        <input id="signDate" name="signDate" type="text" readonly="readonly"
                                               class="input-medium Wdate"
                                               style="width: 200px"
                                               value=""
                                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,maxDate: '#F{$dp.$D(\'unsignDate\')}'});"/>
                                    </div>
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-md-8 column"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="brch"
                                               name="brch" style="width: 200px"/>
                                    </div>
                                    <span style="margin: 1% 0 0 6%;color: red">*  </span>

                                    <label for="unsignDate" class="col-sm-2 control-label control-label"
                                           style="visibility: visible">
                                        协议到期日期：
                                    </label>
                                    <div class="col-sm-3">
                                        <input id="unsignDate" name="unsignDate" type="text" readonly="readonly"
                                               class="input-medium Wdate"
                                               style="width: 200px"
                                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false, minDate: '#F{$dp.$D(\'signDate\')}'});"/>
                                    </div>
                                    <span id="input3" style="display:none;margin: 1% 0 0 6%;color: red" >*  </span>
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-md-8 column"
                                     style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;">
                                    <label for="custManaName"
                                           class="col-sm-2 control-label control-label"
                                           style="visibility: visible">
                                        拓展人：
                                    </label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="custManaName"
                                               name="custManaName" style="width: 200px"/>
                                    </div>
                                    <span style="margin: 1% 0 0 6%;color: red">*  </span>
