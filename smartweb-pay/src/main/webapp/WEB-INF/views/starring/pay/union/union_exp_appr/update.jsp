...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/project/union/union_exp_appr/update.js"
            charset="utf-8"></script>
                    ...
                    <form id="from" method="post" enctype="multipart/form-data">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-md-8 column"
                                     style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;">
                                    <label for="custMngName"
                                           class="col-sm-2 control-label control-label"
                                           style="visibility: visible">
                                        拓展人：
                                    </label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" placeholder="" id="custMngName"
                                               name="custMngName" style="width: 200px"/>
                                    </div>
                                    <span style="margin: 1% 0 0 6%;color: red">*  </span>
                                    ...
                                    <div class="col-sm-3">
                                        <a href="#" id="downloadLink" download><span id="fileName">${data.name}</span></a>
                                    </div>
                                    <button type="button" onclick="showFilePicker()">更换文件</button>
                                    <div id="fileDiv" class="col-sm-2" hidden>
