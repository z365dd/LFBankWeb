...
<script type="text/javascript" src="<%=basePath%>/b_base/jquery-migrate-3.4.0.min.js" charset="utf-8"></script>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/offline/offline_clearRule/com.js"
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/offline/offline_clearRule/add.js"
            charset="utf-8"></script>
...
<%--                                    </div>--%>
<%--                                    &lt;%&ndash;                                    <div id="acctErrInfo" class="col-md-3" style="color:red;display:none">请填写垫款账号</div>&ndash;%&gt;--%>
<%--                                </div>--%>
<%--                                <div class="col-md-2 column"></div>--%>
<%--                            </div>--%>
<%--                            <div class="col-md-12 column lineMaginTop">--%>
