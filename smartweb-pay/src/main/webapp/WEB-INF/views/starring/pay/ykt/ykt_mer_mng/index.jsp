...
<script type="text/javascript" src="<%=basePath%>/b_base/jquery-migrate-3.4.0.min.js" charset="utf-8"></script>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/ykt/ykt_mer_mng/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="商户查询" aria-expanded="true" url="${ctx}/ykt_mer_mng/page/list">
                        商户查询
                    </a>
                </li>
                <li>
                    <a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/ykt_mer_mng/page/add">
                        商户新增
                    </a>
                </li>
                <li>
                    <a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/ykt_mer_mng/page/update">
                        商户修改
                    </a>
                </li>
            </ul>
