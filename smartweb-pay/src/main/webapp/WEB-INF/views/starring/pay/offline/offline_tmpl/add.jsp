...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/offline/offline_tmpl/add.js"
            charset="utf-8"></script>
                    ...
                    <form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="from">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2"></div>
                                <div ravo="rainbow_fx" class="form-group">
                                    <label for="keyNo" class="col-sm-2 control-label control-label"
                                           style="visibility: visible">
                                        字段名称：
                                    </label>
                                    <div class="col-sm-3">
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" placeholder="" id="keyDesc"
                                           name="keyDesc" readonly/>
                                </div>
                                <span style="margin: 1% 4% 0 0;"></span>
                            </div>
                            <div class="col-md-12 column lineMaginTop" style="padding-top: 1%">
                                <div class="col-md-2"></div>
                                <div ravo="rainbow_fx" class="form-group">
                                    <label for="excelStat" class="col-sm-2 control-label control-label"
                                           style="visibility: visible">
                                        模板启用状态：
                                    </label>
                                    <div class="col-sm-3">
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2"></div>
                                <div ravo="rainbow_fx" class="form-group">
                                    <label for="queryStat" class="col-sm-2 control-label control-label"
                                           style="visibility: visible">
                                        明细启用状态：
                                    </label>
                                    <div class="col-sm-3">
