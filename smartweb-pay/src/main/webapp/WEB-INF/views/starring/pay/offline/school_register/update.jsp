...
<head>
    ...
    <script src="${ctx}/b_base/views/starring/pay/offline/school_register/update.js"></script>
...
<form id="from" class="form-horizontal" style="margin:20px;">
    ...
    <div class="form-group"><label class="col-sm-2 control-label">业务编号</label><div class="col-sm-4"><input id="busiNo" name="busiNo" class="form-control" readonly/></div></div>
    ...
    <div class="form-group"><label class="col-sm-2 control-label">机构号</label><div class="col-sm-4"><input id="officeId" name="officeId" class="form-control"/></div></div>
    ...
    <div class="form-group"><label class="col-sm-2 control-label">清算周期</label><div class="col-sm-4"><input id="clrCycle" name="clrCycle" class="form-control" readonly/></div></div>
    <div class="form-group"><label class="col-sm-2 control-label">是否拆分</label><div class="col-sm-4"><input id="sepaFlg" name="sepaFlg" class="form-control" readonly/></div></div>
