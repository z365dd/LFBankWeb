...
<head>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/project/proj_chk/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="项目巡检" aria-expanded="true" url="${ctx}/proj_chk/page/list">
                        项目巡检查询
                    </a>
                </li>
                <li>
                    <a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/proj_chk/page/add">
                        项目巡检录入
                    </a>
                </li>
                <li>
                    <a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/proj_chk/page/modify">
                        项目巡检录入
                    </a>
                </li>
                <li>
                    <a href="#tab_info" data-toggle="tab" aria-expanded="false" url="${ctx}/proj_chk/page/info">
                        项目巡检详情
                    </a>
                </li>
            </ul>
