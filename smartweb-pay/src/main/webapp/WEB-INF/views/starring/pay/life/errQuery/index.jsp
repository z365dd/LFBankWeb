...
<script type="text/javascript" src="<%=basePath%>/b_base/jquery-migrate-3.4.0.min.js" charset="utf-8"></script>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/life/errQuery/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="差错查询" aria-expanded="true" url="${ctx}/errQuery/page/list">
                        差错查询
                    </a>
                </li>
                <li>
                    <a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/errQuery/page/info">
                        差错详情
                    </a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div id="tab_detail" class="tab-pane">
                    <iframe id="iframe_detail" name="iframe_detail" src=""
                            style="width: 100%; height: 750px; border: 0px;" scrolling="no" frameborder="no"></iframe>
                </div>
            </div>
        </div>
    </div>
