...
<script type="text/javascript" src="<%=basePath%>/b_base/jquery-migrate-3.4.0.min.js" charset="utf-8"></script>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/life/merTranDetails/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="商户交易明细查询" aria-expanded="true" url="${ctx}/merTranDetails/page/list">
                        商户交易明细查询
                    </a>
                </li>
                <li>
                    <a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/merTranDetails/page/info">
                        商户交易明细详情
                    </a>
                </li>
            </ul>
            <div id="comDiv" hidden></div>
            <div id="flg" hidden></div>
