...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/buscard/buscard_white_qry/list.js"
            charset="utf-8"></script>
                ...
                <div class="tab-pane in active" id="panel1">
                    <form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="from">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                            <div class="col-md-12 column">
                                <%--隐藏业务选择框--%>
                                <div class="col-md-1 column" hidden>
                                ...
                                <div class="col-md-3 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="custNo" class="col-sm-5 control-label control-label"
                                               style="visibility: visible">
                                            客户号：
                                        </label>
                                        <div class="col-sm-6">
                            ...
                            <div class="col-md-12 column">
                                <div class="col-md-3 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="acct" class="col-sm-5 control-label control-label"
                                               style="visibility: visible">
                                            账号：
                                        </label>
                                        <div class="col-sm-6">
                                ...
                                <div class="col-md-3 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="stat" class="col-sm-5 control-label control-label"
                                               style="visibility: visible">
                                            状态：
                                        </label>
                                        <div class="col-sm-4">
