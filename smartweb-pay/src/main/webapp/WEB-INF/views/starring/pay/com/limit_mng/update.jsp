...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/com/limit_mng/update.js"
            charset="utf-8"></script>
                                    ...
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" placeholder="" id="busiNo"
                                                   name="busiNo" style="width: 225px;" readonly/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" placeholder="" id="busiName"
                                                   name="busiName" style="width: 225px;" readonly/>
                                        </div>
                            ...
                            <div class="col-md-12 column">
                                ...
                                <div class="col-md-9">
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" placeholder="" id="lmtAmt"
                                                   name="lmtAmt" style="width: 225px;"/>
                                        </div>
                                        <span style="margin: 1% 0 0 6%;color: red">*  </span>
                                        <span id="lmtAmtError" style="display:none;color: red; margin-left:2%">请输入正确格式的单笔限额</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 column">
                                ...
                                <div class="col-md-9">
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" placeholder="" id="dayAmt"
                                                   name="dayAmt" style="width: 225px;"/>
                                        </div>
                                        <span style="margin: 1% 0 0 6%;color: red">*  </span>
                                        <span id="dayAmtError" style="display:none;color: red; margin-left:2%">请输入正确格式的日累计限额</span>
                                    </div>
                                </div>
                            </div>
