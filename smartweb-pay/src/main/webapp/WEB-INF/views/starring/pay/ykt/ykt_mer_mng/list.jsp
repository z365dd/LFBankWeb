...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/ykt/ykt_mer_mng/list.js"
            charset="utf-8"></script>
                    ...
                    <form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="from">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                                    ...
                                    <div ravo="rainbow_fx" class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" placeholder="" id="busiName"
                                                   name="busiName" style="width: 180px"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-4 column" style="padding-left: 5%">
                                    <label for="office" class="col-sm-5 control-label control-label"
                                           style="visibility: visible">
                                        所属机构：
                                    </label>
                                    <%--                                <div class="col-sm-2">--%>
                                    <sys:treeselect id="office" css_style="width:180px"
                                                    ...
                                                    treesearch_required="false" checked="true" />
                                    <%--                                </div>--%>
                                </div>
