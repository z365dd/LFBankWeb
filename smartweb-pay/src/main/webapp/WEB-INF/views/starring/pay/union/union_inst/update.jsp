...
<head>
    ...
    <script type="text/javascript"
            ...
            charset="utf-8"></script>
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/union/union_inst/update.js"
            charset="utf-8"></script>
                    ...
                    <form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="from">
                        <div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px">
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-md-3" id="busiNameErrTip" style="color: red;padding-left: 4%">单位名称不能为空</div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
                                <label for="brchTp" class="col-sm-3 control-label control-label"
                                       style="visibility: visible">
                                    机构类型：
                                </label>
                                <div class="col-sm-2">
                            ...
                            <div class="col-md-12 column lineMaginTop" hidden>
                                <div class="col-md-2 column"></div>
                                <label for="officeId" class="col-sm-3 control-label control-label"
                                       style="visibility: visible">
                                    所属机构：
                                </label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" placeholder="" id="officeId"
                                           name="officeId" style="width: 200px"/>
                                </div>
                                <%--                                <div class="col-sm-2">--%>
                            ...
                            <div class="col-md-12 column lineMaginTop" hidden>
                                <div class="col-md-2 column"></div>
                                <label for="officeName" class="col-sm-3 control-label control-label"
                                       style="visibility: visible">
                                    所属机构：
                                </label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" placeholder="" id="officeName"
                                           name="officeName" style="width: 200px"/>
                                </div>
                                <%--                                <div class="col-sm-2">--%>
                                <%--<sys:treeselect id="office" css_style="width:200px"
                                                name="officeId" value="${office.id}"
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-md-3" id="acctErrTip" style="color: red;padding-left: 4%">账户不能为空</div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
                                ...
                                <div class="col-md-3" id="acctNameErrTip" style="color: red;padding-left: 4%">账户名称不能为空</div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" placeholder="" id="clrCycle"
                                           name="clrCycle" style="width: 200px" readonly/>
                                </div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" placeholder="" id="sepaFlg"
                                           name="sepaFlg" style="width: 200px" readonly/>
                                </div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
                            ...
                            <div class="col-md-12 column lineMaginTop">
                                ...
                                <div class="col-md-3" id="phoneNoErrTip" style="color: red;padding-left: 4%">咨询电话不能为空</div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
                                ...
                                <div class="col-md-3" id="nameErrTip" style="color: red;padding-left: 4%">联系人不能为空</div>
                            </div>
                            <div class="col-md-12 column lineMaginTop">
                                <div class="col-md-2 column"></div>
