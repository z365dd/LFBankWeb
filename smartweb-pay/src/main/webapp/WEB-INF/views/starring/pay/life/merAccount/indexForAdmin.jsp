...
<script type="text/javascript" src="<%=basePath%>/b_base/jquery-migrate-3.4.0.min.js" charset="utf-8"></script>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript"
            src="<%=basePath%>/b_base/views/starring/pay/life/merAccount/index.js"
            charset="utf-8"></script>
            ...
            <ul class="nav nav-tabs" data-toggle="tabs">
                <li class="active">
                    <a id="tPipAtomProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
                       title="商户入账查询" aria-expanded="true" url="${ctx}/merAccount/page/listForAdmin">
                        商户入账查询
                    </a>
                </li>
                <li>
<%--                    url标明的是通过后端进入到前端哪个页面--%>
                    <a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/merAccount/page/info">
                        商户入账明细
                    </a>
                </li>
                <%--                <li>--%>
