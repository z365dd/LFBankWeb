...
* 功能描述: 文件格式字段转换汇总参数表数据定义
* 类 名 称  : TfsvrFileColChgTotParaDO.java
* 软件版权: 北京先进数通信息技术股份公司
* 开发人员: chenyl <br>
* 开发时间: 20200630<br>
* 系统版本: V1.0.0<br>
 ...
 * @version 20200630
 */
public class TfsvrFileColChgTotParaDO extends BaseDO {
	...
	public TfsvrFileColChgTotParaDO() {
		chgNo="";		// chg_no
		chgName="";		// chg_name
		regDate="";		// reg_date
		regBrch="";		// reg_brch
	...
	public TfsvrFileColChgTotParaDO(String id){
		super(id);
	}
	...
	public String toString() {
		...
		sb.append("TfsvrFileColChgTotParaDO [ ");
