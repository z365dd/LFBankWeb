 ...
 * @version 20200618
 */
public class TfsvrSvrParaInfoDO extends BaseDO {
	...
	public List<TfsvrSvrDeponParaDO> getList() {
		return list;
	}

	public void setList(List<TfsvrSvrDeponParaDO> list) {
		this.list = list;
	}

	public TfsvrSvrParaInfoDO() {
		super();
	}

	public TfsvrSvrParaInfoDO(String id){
		super(id);
	}
