 ...
 * @version 20200624
 */
public class TfsvrInSvrParaDO extends BaseDO {
	
	private static final long serialVersionUID = 1L;
	private String fileSvrId;		// 主机名
	private String svrDesc;		// 描述
	...
	public TfsvrInSvrParaDO() {
		super();
	}

	public TfsvrInSvrParaDO(String id){
		super(id);
	}

	@Length(min=1, max=64, message="主机名长度必须介于 1 和 64 之间")
	...
	@Length(min=1, max=512, message="描述长度必须介于 1 和 512 之间")
	...
	@Length(min=0, max=10, message="通信协议组类型长度必须介于 0 和 10 之间")
	...
	@Length(min=0, max=60, message="用户号长度必须介于 0 和 60 之间")
	...
	public String getFileSvrStat() {
		return fileSvrStat;
	}

	public void setFileSvrStat(String fileSvrStat) {
		this.fileSvrStat = fileSvrStat;
	}
	
	@Length(min=1, max=128, message="下载文件路径长度必须介于 1 和 128 之间")
	...
	@Length(min=1, max=64, message="参与者ID长度必须介于 1 和 64 之间")
	...
	public String toString() {
		...
		sb.append("pwd="+pwd+" , ");
		sb.append("fileSvrStat="+fileSvrStat+" , ");
