 ...
 * @version 20200624
 */
public class TfsvrNetInfoMngDO extends BaseDO {
	...
	private String deponNetRegion;		// 依赖网络区域
	private String shortRmrk;		// 短备注
	private String midRmrk;		// 中备注
	private String longRmrk;		// 长备注
	private String dac;		// DAC
	
	List<TfsvrInSvrParaDO> svrList;
	List<TfsvrSvrDeponParaDO> deponList;
	//List<TfsvrSvrDeponNetParaDO> deponNetList;
	
	public List<TfsvrSvrDeponParaDO> getDeponList() {
		return deponList;
	}

	public void setDeponList(List<TfsvrSvrDeponParaDO> deponList) {
		this.deponList = deponList;
	}

	public List<TfsvrInSvrParaDO> getSvrList() {
		return svrList;
	}

	public void setSvrList(List<TfsvrInSvrParaDO> svrList) {
		this.svrList = svrList;
	}


	public TfsvrNetInfoMngDO() {
		super();
	}

	public TfsvrNetInfoMngDO(String id){
		super(id);
	}
	...
	@Length(min=0, max=5, message="资源类型长度必须介于 0 和 5 之间")
	...
	@Length(min=0, max=32, message="依赖网络区域长度必须介于 0 和 32 之间")
	public String getDeponNetRegion() {
		return deponNetRegion;
	}

	public void setDeponNetRegion(String deponNetRegion) {
		this.deponNetRegion = deponNetRegion;
	}
