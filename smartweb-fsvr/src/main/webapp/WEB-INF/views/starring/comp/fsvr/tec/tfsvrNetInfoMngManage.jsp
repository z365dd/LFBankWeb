...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrNetInfoMngManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tfsvrNetInfoMngList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="网络信息管理列表" aria-expanded="true" url="${ctx}/comp/fsvr/tec/tfsvrNetInfoMng/tfsvrNetInfoMngList">
							网络信息管理列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrNetInfoMng/tfsvrNetInfoMngAdd">
							网络信息管理添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrNetInfoMng/tfsvrNetInfoMngUpdate">
							网络信息管理更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrNetInfoMng/tfsvrNetInfoMngDetail">
							网络信息管理详情
						</a>
					</li>
				</ul>
