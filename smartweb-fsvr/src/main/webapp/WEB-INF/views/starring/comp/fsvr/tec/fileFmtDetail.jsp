...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/fileFmtDetail.js"
	charset="utf-8"></script>
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-7">
										<select data-role="multiselect" id="fileFmt" name="fileFmt"
											data-url="${ctx}/sys/dict/selectData?type=HEAD_FMT_FLG" disabled="disabled"  checkbtn="fileFmt">
											<option value="">请选择</option>
										</select>
									</div>
								</div>
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-4 control-label">
										文件编码 </label>
									<div class="col-sm-7">
										<select data-role="multiselect" id="fileCode" disabled="disabled" data-url="${ctx}/sys/dict/selectData?type=FILE_CODE" name="fileCode">
											<option value="">请选择</option>
										</select>
									</div>
								</div>
					...
					<div id='confDiv'>
						...
						<div id='headDiv'>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="flg_head" class=""
												name="flg_head" data-url="${ctx}/sys/dict/selectData?type=FILE_FLG" checkbtn="flg_head">
												<option value="">请选择</option>
											</select>
										</div>
									</div>
							...
							<div style="display: none;">
								<select data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=FILE_FLG" id="tempFlg_head" class=""
									name="tempFlg_head">
									<option value=""></option>
								...
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="inputEmail3" class="col-sm-4 control-label">
											是否转换 </label>
										<div class="col-sm-2">
											<select data-role="multiselect" id="chgFlg_head" disabled="disabled" 
						...
						<div id="bodyDiv">
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="flg_body" class=""
												name="flg_body" data-url="${ctx}/sys/dict/selectData?type=FILE_FLG" checkbtn="flg_body">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div class="col-md-4 column">
									<div style="display: none;">
										<select data-role="multiselect" id="tempFlg_body" data-url="${ctx}/sys/dict/selectData?type=FILE_FLG" class=""
											name="tempFlg_body">
											<option value=""></option>
											<option value="2">体</option>
								...
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="inputEmail3" class="col-sm-4 control-label">
											是否转换 </label>
										<div class="col-sm-2">
											<select data-role="multiselect" id="chgFlg_body" disabled="disabled"
