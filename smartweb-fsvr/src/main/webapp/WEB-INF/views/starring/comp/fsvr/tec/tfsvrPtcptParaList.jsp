...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrPtcptParaList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-7">
										<input id="callerId" name="callerId" class="form-control " maxlength="64">
									</div>
								</div>
							</div>
							<div class="col-md-4 column">
					...
					<table class="table table-hover" id="tfsvrPtcptParaTable" data-side-pagination="server"
					data-toggle="table" data-url="${ctx}/comp/fsvr/tec/tfsvrPtcptPara/list"
					...
					data-first-load="true">
						<thead>
							<tr>
								...
								<th data-field="callerId" data-title="调用方参与者">
									调用方参与者
								</th>
								<th data-field="stat" data-title="状态" data-visible="false" data-switchable="false">
									状态的值
								</th>
								<th data-field="statStr" data-title="状态">
									状态
								</th>
								<th data-field="encrpFlg" data-title="是否加密" data-visible="false" data-switchable="false">
									是否加密的值
								</th>
								<th data-field="encrpFlgStr" data-title="是否加密">
									是否加密
								</th>
								<th data-field="attestFlg" data-title="是否签名" data-visible="false" data-switchable="false">
									是否签名的值
								</th>
								<th data-field="attestFlgStr" data-title="是否签名">
									是否签名
								</th>
