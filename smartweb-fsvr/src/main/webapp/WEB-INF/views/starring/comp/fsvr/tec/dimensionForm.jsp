...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/dimensionForm.js"
	charset="utf-8"></script>
				...
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl=""
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" id="commonDiv">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 业务编号 </label>
								<div class="col-sm-4">
									<!-- <input id="companyId" name="company.id"
										class="form-control input-small" type="hidden" value=""> -->
									<input input_type="treesearch" search_url="/comp/prod/oper/entrManage/busiData" id="companyName"
										name="companyName" type="text" value="" data-msg-required=""
										class="form-control input-small" style="" data-bv-="true"
										readonly="readonly">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group hide">
								<label for="inputEmail3" class="col-sm-3 control-label">
									业务名称 </label>
								<div class="col-sm-3">
									<input type="text" class="form-control" placeholder=""
										data-bv-="true" id="BUSI_NAME" name="BUSI_NAME" readonly>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 渠道编号 </label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="CHNL_NO" class=""
										name="CHNL_NO">
										<option value="">请选择</option>
										<option value="000001">默认渠道号</option>
									</select>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 交易码 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 单位编号 </label>
								<div class="col-sm-4">
									<!-- <input type="text" class="form-control" placeholder=""
										id="ENTR_NO" name="ENTR_NO"> -->
										<select data-role="multiselect" id="ENTR_NO" class=""
										name="ENTR_NO">
										<option value="">请选择</option>
									</select>
								</div>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<select data-role="multiselect" id="LEGA_NO" class=""
										name="LEGA_NO"
										data-url="${ctx}/sys/dict/selectData?type=open_law"
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 自定义维度 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="DEF_VAL" name="DEF_VAL">
								</div>
							</div>
						</div>
					</div>
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="DIM_DESC" name="DIM_DESC" check-empty="true">
								</div>
							</div>
						</div>
					</div>
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 使用权限 </label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="COMP_NO" class=""
										name="COMP_NO" data-max-height="300" data-include-select-all-option="true"
										 multiple="multiple" checkbtn="COMP_NO">
										<option value="">请选择</option>
									</select>
								</div>
							</div>
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 文件服务标识符  </label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="FILE_SVR_NO" class=""
										name="FILE_SVR_NO">
										<option value="">请选择</option>
									</select>
								</div>
								...
								<div class="col-md-4 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button"
											class="btn btn-primary" contenteditable="false" id="addBtn"
											name="addBtn">提交</button>
									</shiro:haspermission>
								</div>
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div class="col-md-4 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button"
											class="btn btn-default" contenteditable="false" id="closeBtn"
											name="closeBtn">返回</button>
									</shiro:haspermission>
								</div>
								<div class="col-md-5 column"></div>
							</div>
