...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrPortParaDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tfsvrSvrPortParaForm" style="margin-top:10px;">
				<input type="hidden" value="" name="compNo" id="HID_compNo"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="compNo" name="compNo" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="compName" name="compName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="port" name="port" class="form-control "  maxlength="10" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
