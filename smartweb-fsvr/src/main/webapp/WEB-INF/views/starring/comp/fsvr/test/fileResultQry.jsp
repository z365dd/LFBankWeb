...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/test/fileResultQry.js"
	charset="utf-8"></script>
									...
									<form ravo="rainbow_fx_layout_bd" class="form-horizontal"
										...
										<div ravo="rainbow_fx_layout_panel"
											...
											<div class="panel-body" contenteditable="false">
														...
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-7">
																<input type="text" class="form-control" placeholder=""
																	id="FILE_SET_SEQ" name="FILE_SET_SEQ" check-empty="true">
															</div>
														</div>
													</div>
												...
												<div ravo="rainbow_fx_layout" class="row clearfix">
													<div class="col-md-12 column" style="margin-left:4.5%">
														<div ravo="rainbow_fx" class="form-group" >
															<label for="inputEmail3"
																class="col-sm-2 control-label control-label">请求流水号
															</label>
															<div class="col-sm-4">
																<input type="text" class="form-control" maxlength="64" check-integer="true"
																	id="FILE_SET_SEQ" name="FILE_SET_SEQ" check-empty="true">
															</div>
														</div>
													</div>
											...
											<div class="panel-body" contenteditable="false">
														...
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-5">
																<input type="text" class="form-control" readonly="readonly"
																	id="SRC_PUB_FILE_PATH" name="SRC_PUB_FILE_PATH">
															</div>
														</div>
													</div>
												</div>
												...
												<div ravo="rainbow_fx_layout" class="row clearfix">
													<div class="col-md-12 column" style="margin-left: 4.3%">
														<div ravo="rainbow_fx" class="form-group" >
															<label for="inputEmail3"
																class="col-sm-2 control-label control-label"> 描述
															</label>
															<div class="col-sm-7">
																<input type="text" class="form-control" placeholder=""
																	id="RET_MSG" name="RET_MSG" readonly >
															</div>
														</div>
													</div>
												</div>
														...
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-7">
																<table id="table" data-toggle="table"
																	...
																	<thead style="">
																		<tr>
																			<th data-field="SRC_FILE_NAME">文件名</th>
																			<th data-field="ALIAS_FILE_NAME">文件别名</th>
																			<th data-field="SRC_SUB_FILE_PATH">文件子目录</th>
																		</tr>
																	</thead>
																</table>
															</div>
