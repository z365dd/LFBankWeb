...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/test/fsvrFileDownload.js"
	charset="utf-8"></script>
								...
								<div class="col-md-6 column">
										...
										<div class="col-md-2 column">
											<shiro:haspermission name="anno">
												<button ravo="rainbow_fx" type="button"
													...
													id="submitBtn" name="submitBtn">提交</button>
											</shiro:haspermission>
										</div>
										<div class="col-md-5 column">
											<shiro:haspermission name="anno">
												<button ravo="rainbow_fx" type="button"
													class="btn btn-default" contenteditable="false"
													id="cancelBtn" name="cancelBtn">取消</button>
											</shiro:haspermission>
										</div>
								</div>
								<div class="col-md-6 column"></div>
											...
											<table id="table" data-toggle="table"
												...
												<thead style="">
													<tr>
														...
														<th data-field="fULL_FILE_PATH" data-visible="false">文件路径</th>
