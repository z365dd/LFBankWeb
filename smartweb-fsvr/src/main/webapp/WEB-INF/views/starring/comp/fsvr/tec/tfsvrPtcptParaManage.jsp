...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrPtcptParaManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tfsvrPtcptParaList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="调用方信息列表" aria-expanded="true" url="${ctx}/comp/fsvr/tec/tfsvrPtcptPara/tfsvrPtcptParaList">
							调用方信息列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrPtcptPara/tfsvrPtcptParaAdd">
							调用方信息添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrPtcptPara/tfsvrPtcptParaUpdate">
							调用方信息更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrPtcptPara/tfsvrPtcptParaDetail">
							调用方信息详情
						</a>
					</li>
				</ul>
