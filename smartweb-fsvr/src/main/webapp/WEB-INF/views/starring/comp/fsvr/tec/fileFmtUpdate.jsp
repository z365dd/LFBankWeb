...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/fileFmtUpdate.js"
	charset="utf-8"></script>
...
<body>
							...
							<div class="col-md-6 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-5 control-label">
										文件格式转换号 </label>
									<div class="col-sm-5">
										<input type="text" class="form-control" id="chgNo"
											name="chgNo" check-empty="true" readonly="readonly">
									</div>
								</div>
							</div>
							<div class="col-md-6 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="fmtName"
											name="fmtName" check-empty="true" readonly="readonly">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-4 control-label">
										格式类型 </label>
									<div class="col-sm-7">
										<select data-role="multiselect" id="fileFmt" data-url="${ctx}/sys/dict/selectData?type=HEAD_FMT_FLG" name="fileFmt"
											checkbtn="fileFmt">
											<option value="">请选择</option>
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-4 control-label">
										文件编码 </label>
									<div class="col-sm-7">
										<select data-role="multiselect" id="fileCode" data-url="${ctx}/sys/dict/selectData?type=FILE_CODE" name="fileCode">
											<option value="">请选择</option>
					...
					<div id='confDiv'>
						...
						<div id='headDiv'>
                                ...
                                <div class="col-md-4 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">
                                              模板报文头尾字段</label>
                                        <div class="col-sm-7">
                                            <select data-role="multiselect" id="tmplTableRows_head" class=""
                                                name="tmplTableRows_head"   data-max-height="300" 
                                                 data-enable-filtering="true" data-enable-full-value-filtering="false" 
                                                 data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索">
                                                <option value="">请选择</option>
                                            </select>
                                        </div>
                                    </div>
								...
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="inputEmail3" class="col-sm-4 control-label">
											位置 </label>
										<div class="col-sm-7">
											<select data-role="multiselect" id="flg_head" data-url="${ctx}/comp/fsvr/tec/fsvrFileFmt/selectDataHeadTail?type=FILE_FLG" class=""
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="colTp_head"
												name="colTp_head" class="" data-url="${ctx}/sys/dict/selectData?type=FILE_COL_TP" checkbtn="colTp_head">
												<option value="">请选择</option>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="alignMeth_head"
												name="alignMeth_head" class="" data-url="${ctx}/sys/dict/selectData?type=ALIGN_METH" checkbtn="alignMeth_head">
												<option value="">请选择</option>
							...
							<div style="display: none;">
								<select data-role="multiselect" id="tempFlg_head" data-url="${ctx}/comp/fsvr/tec/fsvrFileFmt/selectDataHeadTail?type=FILE_FLG&isblank=true" class=""
									name="tempFlg_head">
									<option value=""></option>
									<option value="1">头</option>
									<option value="3">尾</option>
									...
									<select data-role="multiselect" id="clobFlg_head" data-url="${ctx}/sys/dict/selectData?type=CHG_CLOB_FLG" class=""
											name="clobFlg_head" data-async="true">
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-2">
											<select data-role="multiselect" id="chgFlg_head"
												name="chgFlg_head" class="" data-url="${ctx}/sys/dict/selectData?type=CHG_FLG" checkbtn="chgFlg_head">
												<option value="">请选择</option>
												<option value="1">是</option>
									...
									<table id="tmplTable_head" data-toggle="table"
										...
										<thead style="">
											<tr>
												...
												<th data-field="fileFlg" data-visible="false">模板位置</th>
												<th data-field="ser" data-visible="false">模板序号</th>
												<th data-field="colName">字段名称</th>
												<th data-field="fileColTp" data-visible="false">字段类型</th>
											</tr>
										</thead>
									</table>
								</div>
									...
									<table id="table_head" data-toggle="table"
										...
										<thead style="">
											<tr>
												...
												<th data-field="fileFlg" data-visible="false">位置</th>
												...
												<th data-field="fileColTp" data-visible="false">字段类型的值</th>
												<th data-field="colTpStr">字段类型</th>
						...
						<div id="bodyDiv">
                                ...
                                <div class="col-md-4 column">
                                    <div ravo="rainbow_fx" class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">
                                              模板报文体字段</label>
                                        <div class="col-sm-7">
                                            <select data-role="multiselect" id="tmplTableRows_body" class=""
                                                name="tmplTableRows_body"   data-max-height="300" 
                                                 data-enable-filtering="true" data-enable-full-value-filtering="false" 
                                                 data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索">
                                                <option value="">请选择</option>
                                            </select>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="flg_body" class=""
												name="flg_body" data-url="${ctx}/comp/fsvr/tec/fsvrFileFmt/selectDataBody?type=FILE_FLG" checkbtn="flg_body">
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="colTp_body"
												name="colTp_body" class="" data-url="${ctx}/sys/dict/selectData?type=FILE_COL_TP" checkbtn="colTp_body">
												<option value="">请选择</option>
												<option value="1">整型</option>
												<option value="2">浮点型</option>
												<option value="3">字符串</option>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="alignMeth_body"
												name="alignMeth_body" class="" data-url="${ctx}/sys/dict/selectData?type=ALIGN_METH" checkbtn='alignMeth_body'>
												<option value="">请选择</option>
												<option value="1">左对齐，右补0</option>
												<option value="2">左对齐，右补空格</option>
												<option value="3">右对齐，左补0</option>
								...
								<div class="col-md-4 column">
									<div style="display: none;">
										<select data-role="multiselect" id="tempFlg_body" data-url="${ctx}/comp/fsvr/tec/fsvrFileFmt/selectDataBody?type=FILE_FLG&isblank=true" class=""
											name="tempFlg_body">
											<option value=""></option>
											<option value="2">体</option>
											...
											<select data-role="multiselect" id="clobFlg_body" data-url="${ctx}/sys/dict/selectData?type=CHG_CLOB_FLG" class=""
											name="clobFlg_body"  data-async="true">
											<option value="0" selected>否</option>
											<option value="1">是</option>
										</select>
									</div>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-2">
											<select data-role="multiselect" id="chgFlg_body"
												name="chgFlg_body" class="" data-url="${ctx}/sys/dict/selectData?type=CHG_FLG" checkbtn='chgFlg_body'>
												<option value="">请选择</option>
											</select>
										</div>
	...
	<div class="modal fade text-center" id="modalDiv" tabindex="-1"
		...
		<div class="modal-dialog" style="position:fixed;width:700px;height:450px;top:50%;left:50%;margin:-225px 0 0 -300px;"> 
