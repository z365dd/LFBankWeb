...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/inFileSerForm.js" charset="utf-8"></script>
...
<div class="" >
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_299274" style="margin-top: 10px">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="IP" name="IP" check-empty="true">
							</div>
						</div>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="PORT" name="PORT" check-empty="true">
							</div>
						</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column" style="margin-left: 4.4%">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" placeholder="" id="SVR_DESC" name="SVR_DESC" check-empty="true">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="OPEN_SVC_FLG" class="" name="OPEN_SVC_FLG" data-url="${ctx}/sys/dict/selectData?type=OPEN_SVC_FUNC"
												data-async="true" blank-item=true checkbtn="OPEN_SVC_FLG">
									<option value="1">
										option 1
									</option>
									<option value="2">
					...
					<div ravo="rainbow_fx" class="form-group">
						...
						<div class="col-sm-7">
							<select data-role="multiselect" id="DEPON_FILE_SVR_ID" class="" name="DEPON_FILE_SVR_ID" 
									multiple="multiple"	data-async="true" blank-item=true
