...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrNetInfoMngAddForm.js"
	charset="utf-8"></script>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<select data-role="multiselect" id="deponNetRegion" class=""
										...
										data-enable-full-value-filtering="true" data-non-selected-text="请选择"
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="fileSvrStat" class="" name="fileSvrStat"
											...
											data-async="true" blank-item="true" checkbtn="fileSvrStat">
										</select>
									</div>
								</div>
								<!-- <div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<input id="downloadFilePath" name="downloadFilePath"
											class="form-control " maxlength="128" check-empty="true">
									</div>
								</div> -->
							</div>
						</div>
