...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/portManageQry.js"
	charset="utf-8"></script>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
									...
									<div class="col-md-3 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-4 control-label control-label"> 组件号 </label>
											<div class="col-sm-8">
												<select data-role="multiselect" id="COMP_NO" class=""
													name="COMP_NO" data-max-height="300" data-url="${ctx}/comp/prod/oper/prodAttr/getComp"
													>
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/comp/fsvr/tec/fileTec/portQry"
