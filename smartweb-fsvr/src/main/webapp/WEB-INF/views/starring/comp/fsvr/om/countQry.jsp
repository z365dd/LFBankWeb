...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/om/countQry.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">文件传输流水统计</a></li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2">文件传输流水查询 </a></li>
						<li class=""><a href="#panel3" data-toggle="tab"
							aria-expanded="false" class="" id="tab3" name="tab3">文件传输流水详细</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<form ravo="rainbow_fx_layout_bd" class="form-horizontal"
								pourl="" id="formId_175337" style="margin-top: 20px">
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class=" col-sm-5 control-label">
												流水统计类型 </label>
											<div class="col-sm-7">
												<select data-role="multiselect" id="JRNL_STATS_TP" class=""
													name="JRNL_STATS_TP" data-max-height="300" data-async="true"
													blank-item=true data-url="${ctx}/sys/dict/selectData?type=JRNL_STATS_TP" checkbtn="JRNL_STATS_TP">
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-7">
												<select data-role="multiselect" id="COMP_NO" class=""
													name="COMP_NO"  data-enable-filtering="true" data-max-height="300" data-filter-placeholder="搜索">
													<option value="">请选择</option>
												</select>
											</div>
										</div>
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class=" col-sm-3 control-label">
												文件交易状态 </label>
											<div class="col-sm-4">
												<select data-role="multiselect" id="FILE_TRAN_STAT" class=""
													name="FILE_TRAN_STAT" data-max-height="300" data-async="true"
													blank-item=true data-url="${ctx}/comp/fsvr/om/qryCount/selectData?type=FILE_TRAN_STAT" checkbtn="FILE_TRAN_STAT">
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<div class="input-append">
													<input input_type="treesearch"
														search_url="/comp/fsvr/om/qryCount/busiList"
														id="companyName" name="companyName" type="text" value=""
														data-msg-required="" class="form-control input-small"
														style="" data-bv-="true" readonly="readonly">
												</div>
											</div>
											<div class="col-sm-5">
												<div ravo="rainbow_fx_layout" class="row clearfix">
							...
							<table id="table" data-toggle="table" data-first-load="false"
								data-url="${ctx}/comp/fsvr/om/qryCount/getCountQry"
								...
								<thead style="" >
									<tr>
										<th data-field="TRAN_DATE">统计类型值</th>
										<th data-field="COMP_NO">组件号</th>
										<th data-field=BUSI_NO>业务编号</th>
										<th data-field="SVC_CALL_NUM">调用次数</th>
										<th data-field="FILE_NUM">文件数</th>
										<th data-field="FILE_TRAN_STAT">文件交易状态</th>
						...
						<div class="tab-pane in" id="panel3"></div>
