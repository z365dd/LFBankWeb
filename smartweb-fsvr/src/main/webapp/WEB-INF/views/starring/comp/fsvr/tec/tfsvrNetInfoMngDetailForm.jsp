...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrNetInfoMngDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tfsvrNetInfoMngForm" style="margin-top:10px;">
					<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						...
						<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									依赖网络区域 </label>
								<div class="col-sm-4">
									<select data-role="multiselect"  id="deponNetRegion" class="" name="deponNetRegion" multiple="multiple"
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									开通功能 </label>
								<div class="col-sm-4">
									<select data-role="multiselect"  id="openSvcFlg" class="" name="openSvcFlg" data-url="${ctx}/sys/dict/selectData?type=OPEN_SVC_FUNC"
