...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/test/upLoadPut.js"
	charset="utf-8"></script>
										...
										<div ravo="rainbow_fx_layout_panel"
											...
											<div class="panel-body" contenteditable="false">
												<div ravo="rainbow_fx_layout" class="row clearfix">
														...
														<!-- <div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-7 btn-group col-sm-4">
																<div class="input-append">
																	<input input_type="treesearch" search_url="/comp/prod/oper/entrManage/busiList"
																		id="companyName" name="companyName" type="text"
																		value="" data-msg-required=""
																		class="form-control input-small" style=""
																		data-bv-="true" readonly="readonly">
																</div>
															</div>
														</div>
														<div ravo="rainbow_fx" class="form-group">
															<label for="inputEmail3" class="  col-sm-5 control-label"
																style="visibility: visible"> 单位编号</label>
													...
													<div class="col-md-6 column">
														<%-- <div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-4">
																<select data-role="multiselect" id="LEGA_NO" class=""
																	...
																	data-async="true" blank-item=true data-max-height="300">
																	<option value="">请选择</option>
																</select>
															</div>
														</div>
														...
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-4">
																<input type="text" class="form-control" 
																	id="CHK_DEF_DIM_VAL" name="CHK_DEF_DIM_VAL">
															</div>
														</div> --%>
													</div>
												</div>
												...
												<div id="commonFile" class="hide">
													<div ravo="rainbow_fx_layout" name="fileDivName" class="row clearfix" style="padding-left:4%;">
														<div class="col-md-5 column">
															<div ravo="rainbow_fx" class="form-group">
																<input type="hidden" value="" id="hidden_FILE_NAME"
																	name="FILE_NAME"> <label for="inputEmail3"
																	class="col-sm-5 control-label">文件名</label>
																<div class="col-sm-7 fileInput">
																	<input id="FILE_NAME" class="file" type="file"
																		name="file">
																</div>
															</div>
														</div>
