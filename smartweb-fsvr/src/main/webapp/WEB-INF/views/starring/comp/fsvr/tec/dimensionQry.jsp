...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/dimensionQry.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true"> 消费方维度查询
						</a></li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2"> 消费方维度新增
						</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<input input_type="treesearch" search_url="/comp/prod/oper/entrManage/busiData"
									...
									<div class="col-md-6 column">
										...
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-3 control-label control-label"> 自定义维度
											</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" placeholder=""
							...
							<table id="table" data-toggle="table" data-first-load="false"
								data-url="${ctx}/comp/fsvr/tec/fileTec/conDimensionQry"
								...
								<thead style="">
									<tr>
										...
										<th data-field="ENTR_NO">单位编号</th>
										<th data-field="CHNL_NO">渠道号</th>
										<th data-field="LEGA_NO">法人编号</th>
										<th data-field="TRAN_CODE">交易码</th>
										<th data-field="DEF_VAL">自定义维度</th>
										<th data-field="DIM_DESC">描述</th>
										<th data-field="STAT">开关状态</th>
