...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrPtcptParaUpdateForm.js"
	charset="utf-8"></script>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input id="callerId" name="callerId" class="form-control "
										maxlength="6" check-empty="true" readonly="readonly">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input id="callerDesc" name="callerDesc" class="form-control "
										maxlength="1024" check-empty="true">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input id="userNo" name="userNo" class="form-control "
										maxlength="30" check-empty="true" check-alphanumericSymbols="true">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input id="pwd" name="pwd" class="form-control " maxlength="80"
										check-empty="true" check-password="true">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									是否限速 </label>
								<div class="col-sm-4">
									<select id="speedlimFlg" name="speedlimFlg" checkbtn=""
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									发送限速大小 </label>
								<div class="col-sm-4">
									<input id="sndSpeedlimSize" name="sndSpeedlimSize" check-integer-pos-neg="true"
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									接收限速大小 </label>
								<div class="col-sm-4">
									<input id="recvSpeedlimSize" name="recvSpeedlimSize" check-integer-pos-neg="true"
										class="form-control  digits" maxlength="18">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									分包发送文件大小 </label>
								<div class="col-sm-4">
									<input id="subctrctSendFileSize" name="subctrctSendFileSize" check-integer-pos-neg="true"
										class="form-control  digits" maxlength="18">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									分包接收文件大小 </label>
								<div class="col-sm-4">
									<input id="subctrctRecvFileSize" name="subctrctRecvFileSize" check-integer-pos-neg="true"
										class="form-control  digits" maxlength="18">
								</div>
							</div>
						</div>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input id="downloadFilePath" name="downloadFilePath"
										class="form-control " maxlength="256" check-empty="true">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
