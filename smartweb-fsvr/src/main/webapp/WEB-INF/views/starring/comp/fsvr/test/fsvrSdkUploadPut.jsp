...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/test/fsvrSdkUploadPut.js" charset="utf-8"></script>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-12 column">
									<form ravo="rainbow_fx_layout_bd" class="form-horizontal"
										...
										<div ravo="rainbow_fx_layout_panel"
											...
											<div class="panel-body" contenteditable="false">
												...
												<div id="commonFile" class="hide">
													<div ravo="rainbow_fx_layout" name="fileDivName" class="row clearfix" >
														<div class="col-md-6 column">
															<div ravo="rainbow_fx" class="form-group">
										...
										<div ravo="rainbow_fx_layout_panel"
											class="panel panel-default" id="resultDiv">
											<div class="panel-heading">
												<div ravo="rainbow_fx_bj">
