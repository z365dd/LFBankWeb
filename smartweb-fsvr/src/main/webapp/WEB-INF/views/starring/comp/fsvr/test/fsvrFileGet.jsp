...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/test/fsvrFileGet.js" charset="utf-8"></script>
										...
										<div ravo="rainbow_fx_layout_panel"
											...
											<div class="panel-body" contenteditable="false">
														...
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-5">
																<input type="text" class="form-control" placeholder=""
																	id="PUB_FILE_PATH" name="PUB_FILE_PATH">
															</div>
														</div>
													</div>
													<div class="col-md-6 column">
												...
												<div id="commonFile" class="hide">
													<div ravo="rainbow_fx_layout"  name="fileDivName" class="row clearfix" style="padding-left:8%;">
