...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrParaDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tfsvrSvrParaForm" style="margin-top:10px;">
				<input type="hidden" value="" name="fileSvrId" id="HID_fileSvrId"/>
			<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-6 column">
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly" maxlength="64"  id="fileSvrId" name="fileSvrId" check-empty="true">
				</div>
			</div>
		</div>
		<div class="col-md-6 column">
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column" style="margin-left: 4.4%">
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-7">
					<input type="text" class="form-control" readonly="readonly" maxlength="80" id="svrDesc" name="svrDesc" check-empty="true">
				</div>
			</div>
		</div>
	</div>
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-6 column">
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly"  maxlength="30" id="ip" name="ip" check-empty="true">
				</div>
			</div>
		</div>
		<div class="col-md-6 column">
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly"  maxlength="10" id="port" name="port" check-empty="true">
				</div>
			</div>
		</div>
	</div>
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-6 column">
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly"  maxlength="30" id="userNo" name="userNo">
				</div>
			</div>
			<div ravo="rainbow_fx" class="form-group">
				<label for="inputEmail3" class="col-sm-5 control-label control-label">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly"  maxlength="80" id="pwd1" name="pwd1">
				</div>
			</div>
			<div ravo="rainbow_fx" class="form-group">
				<label for="inputEmail3" class="col-sm-5 control-label control-label">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly"  maxlength="256" id="uploadFilePath" name="uploadFilePath">
				</div>
			</div>
		</div>
		<div class="col-md-6 column">
			...
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly"   id="pwd2" name="pwd2">
				</div>
			</div>
			<div ravo="rainbow_fx" class="form-group">
				<label for="inputEmail3" class="col-sm-3 control-label control-label">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" readonly="readonly"  maxlength="256" id="downloadFilePath" name="downloadFilePath">
				</div>
			</div>
		</div>
	</div>
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-6 column">
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-7">
					<select data-role="multiselect"  id="contFlg" class="" name="contFlg" data-url="${ctx}/sys/dict/selectData?type=CONT_FLG" 
					data-async="true" blank-item="true" checkbtn="contFlg">
						<option value="">
							--请选择--
						</option>
						<option value="Y">
			...
			<div ravo="rainbow_fx" class="form-group">
				...
				<div class="col-sm-7">
					<select data-role="multiselect"  id="deponFileSvrId" class="" name="deponFileSvrId" multiple="multiple"
					 data-async="true" blank-item="true" data-enable-filtering="true" data-enable-full-value-filtering="true"
