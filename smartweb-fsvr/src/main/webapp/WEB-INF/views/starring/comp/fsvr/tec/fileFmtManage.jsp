...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/fileFmtManage.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					...
					<li class="active">
						...
						title="文件格式列表" aria-expanded="true" url="${ctx}/comp/fsvr/tec/fsvrFileFmt/fileFmtList"
						class="">
							文件格式转换列表
						</a>
					</li>
					<li class="">
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/fsvrFileFmt/fileFmtAdd"
						class="">
							文件格式转换新增
						</a>
					</li>
					<li class="">
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/fsvrFileFmt/fileFmtUpdate"
						class="">
							文件格式转换更新
						</a>
					</li>
					<li class="">
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/fsvrFileFmt/fileFmtDetail"
						class="">
							文件格式转换详情
						</a>
					</li>
				...
				<div class="tab-content">
					...
					<div id="tab_add" class="tab-pane">
						<iframe id="iframe_add" name="iframe_add" src="" style="width: 100%; height: 2000px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div id="tab_update" class="tab-pane">
						<iframe id="iframe_update" name="iframe_update" src="" style="width: 100%; height: 2000px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div id="tab_detail" class="tab-pane">
						<iframe id="iframe_detail" name="iframe_detail" src="" style="width: 100%; height: 2000px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
				</div>
