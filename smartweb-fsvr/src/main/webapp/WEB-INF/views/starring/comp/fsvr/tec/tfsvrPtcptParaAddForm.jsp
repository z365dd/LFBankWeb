...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrPtcptParaAddForm.js"
	charset="utf-8"></script>
		...
		<div ravo="rainbow_fx_layout" class="row clearfix">
			<div class="col-md-12 column">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal breadcrumb"
					pourl="" id="addForm" style="margin-top: 10px;">
					<div ravo="rainbow_fx_layout" class="row clearfix">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input id="callerDesc" name="callerDesc" class="form-control "
										maxlength="256" check-empty="true">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<select id="speedlimFlg" name="speedlimFlg"
										checkbtn="speedlimFlg" data-role="multiselect">
										<option value="">--请选择--</option>
										<option value="Y">是</option>
										<option value="N">否</option>
									</select>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input id="sndSpeedlimSize" name="sndSpeedlimSize"
										class="form-control  digits" maxlength="18" check-integer-pos-neg="true">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
