...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/ptcptManageQry.js"
	charset="utf-8"></script>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" placeholder=""
													id="FILE_PTCPT_NO" name="FILE_PTCPT_NO">
											</div>
										</div>
									</div>
									<div class="col-md-3 column">
							...
							<table id="table" data-toggle="table" data-first-load="false"
								data-url="${ctx}/comp/fsvr/tec/fileTec/ptcptQry"
								...
								<thead style="">
									<tr>
										<th data-field="FILE_PTCPT_NO">文件参与者标识号</th>
										<th data-field="PTCPT_DESC">描述</th>
										<th data-field="PTCPT_GRP_TP">调用方类型</th>
