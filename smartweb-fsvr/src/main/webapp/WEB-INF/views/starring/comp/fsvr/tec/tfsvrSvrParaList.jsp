...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrParaList.js"
	charset="utf-8"></script>
			...
			<div class="col-md-12 column">
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
					<div class="panel-body" contenteditable="false">
								...
								<div class="col-md-3 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="inputEmail3" class="col-sm-4 control-label">
											文件服务器状态 </label>
										<div class="col-sm-8">
											<select data-role="multiselect" id="fileSvrStat" class=""
												name="fileSvrStat"
												data-url="${ctx}/sys/dict/selectData?type=FILE_SVR_STAT"
										...
										<div class="col-md-8 column">
											<shiro:haspermission name="anno">
												<button ravo="rainbow_fx" type="button"
													...
													id="listBtn" name="listBtn">查询</button>
											</shiro:haspermission>
										</div>
									</div>
								</div>
						...
						<table class="table table-hover" id="tfsvrSvrParaTable"
							data-side-pagination="server" data-toggle="table"
							data-url="${ctx}/comp/fsvr/tec/tfsvrSvrPara/list"
							...
							<thead>
								<tr>
									...
									<th data-field="fileSvrId" data-title="文件服务器标识号">文件服务器标识号</th>
									<th data-field="svrDesc" data-title="服务器描述">描述</th>
									<th data-field="ip" data-title="主机名">主机名</th>
									<th data-field="port" data-title="端口">端口</th>
									<th data-field="fileSvrStat" data-title="状态" data-visible="false"
										data-switchable="false">状态的值</th>
									<th data-field="statStr" data-title="文件服务器状态">文件服务器状态</th>
