...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/test/sdkDownload.js"
	charset="utf-8"></script>
...
<link rel="stylesheet" href="<%=basePath%>/b_base/jquery-ui.css">
<script src="<%=basePath%>/b_ide/bootstrap/js/jquery-ui.min.js"></script>
<link rel="stylesheet" href="<%=basePath%>/b_ide/bootstrap/module/bootstrap-table/docs/assets/css/style.css">
<style>
  .ui-progressbar {
    position: relative;
  }
										...
										<div ravo="rainbow_fx_layout_panel"
											...
											<div class="panel-body" contenteditable="false">
													...
													<div class="col-md-6 column">
														<div ravo="rainbow_fx" class="form-group">
															<label for="inputEmail3" class="col-sm-5 control-label">
																文件服务器 </label>
															<div class="col-sm-4">
																<select data-role="multiselect" id="SVR_NO" class=""
																	name="SVR_NO" blank-item=true data-max-height="300">
												...
												<div id="commonFile" class="hide">
													<div ravo="rainbow_fx_layout" class="row clearfix" style="padding-left:8%;">
																...
																<div class="col-sm-7 fileInput">
																	<div ravo="rainbow_fx_layout" class="row clearfix">
																		...
																		<div class="col-md-3 column">
																			<a href="#" id="downLoadBtnFile" style="display: none" target="_self" download>下载</a>
																		</div>
																	</div>
																</div>
															</div>
											...
											<div class="panel-body" contenteditable="false">
												...
												<div ravo="rainbow_fx_layout" class="row clearfix">
													...
													<div class="col-md-2 column">
														<div id="progressbar" style="display: none"><div class="progress-label">加载...</div></div>
													</div>
													<div class="col-md-2 column">
													</div>
												</div>
