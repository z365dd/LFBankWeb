...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrParaManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tfsvrSvrParaList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="文件服务器列表" aria-expanded="true" url="${ctx}/comp/fsvr/tec/tfsvrSvrPara/tfsvrSvrParaList">
							文件服务器查询
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrSvrPara/tfsvrSvrParaAdd">
							文件服务器新增
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrSvrPara/tfsvrSvrParaUpdate">
							文件服务器修改
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrSvrPara/tfsvrSvrParaDetail">
							文件服务器详细
						</a>
					</li>
				</ul>
