...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/fileFmtList.js" charset="utf-8"></script>
			...
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="listForm" >
				<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-top:20px">
					...
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class=" col-sm-4 control-label" style="visibility:visible">
								组件
							</label>
							<div class="col-sm-7">
								<select data-role="multiselect" id="compNo" name="compNo" data-enable-filtering="true" data-filter-placeholder="搜索">
									<option value="">
										请选择
									</option>
								</select>
					...
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="tempFmtNo" name="tempFmtNo" data-enable-filtering="true" data-filter-placeholder="搜索">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-4 column">
                        <div ravo="rainbow_fx" class="form-group">
                            <label for="inputEmail3"
                                class="col-sm-4 control-label control-label"> 文件格式转换号 </label>
                            <div class="col-sm-6">
					...
					<div class="col-md-4 column">
                        <div ravo="rainbow_fx" class="form-group">
                            <label for="inputEmail3"
                                class="col-sm-4 control-label control-label"> 文件格式转换名称 </label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder=""
                                    id="chgName" name="chgName">
                            </div>
                        </div>
                    </div>
					<div class="col-md-3 column">
				...
				<table class="table table-hover" id="table" data-side-pagination="server"
					data-toggle="table" data-url="${ctx}/comp/fsvr/tec/fsvrFileFmt/list" ravo="rainbow_fx_bj"
					...
					<thead style="">
						<tr>
							<th data-field="compNo">
								组件号
							</th>
							<th data-field="compName">
								组件
							</th>
							<th data-field="chgNo">
								文件格式转换号
							</th>
							<th data-field="chgName">
                                                                文件格式转换名称
                            </th>
							<th data-field="tempName">
								模板名称
							</th>
							<th data-field="inFmtNo">
								输入文件格式编号
							</th>
							<th data-field="outFmtNo">
								输出文件格式编号
							</th>
							<th data-field="modDate">
								修改日期
							</th>
