...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrNetInfoMngList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="netRegion" name="netRegion" class="form-control "  maxlength="32" >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="tfsvrNetInfoMngTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/comp/fsvr/tec/tfsvrNetInfoMng/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="netRegion" data-title="网络区域">网络区域</th>
								<th data-field="deponNetRegion" data-title="依赖网络区域">依赖网络区域</th>
