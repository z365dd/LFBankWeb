...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/fileFmtAdd.js"
	charset="utf-8"></script>
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="fmtName"
											name="fmtName" maxlength="120" check-empty="true">
									</div>
								</div>
							</div>
							<div class="col-md-4 column">
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-4 control-label">
										格式类型 </label>
									<div class="col-sm-7">
										<select data-role="multiselect" id="fileFmt" blank-text="--请选择--"  data-url="${ctx}/sys/dict/selectData?type=HEAD_FMT_FLG" name="fileFmt"
											checkbtn="fileFmt" blank-item=true>
											<option value="">请选择</option>
										</select>
									</div>
								</div>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="flg_head" class=""
												name="flg_head" data-url="${ctx}/comp/fsvr/tec/fsvrFileFmt/selectDataHeadTail?type=FILE_FLG" checkbtn="flg_head">
												<option value="">请选择</option>
											</select>
										</div>
									</div>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="colLen_head"
												...
												name="colLen_head" maxlength="7" check-empty="true">
										</div>
									</div>
								</div>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="colLen_body"
											     onkeyup="if(this.value.length==1){this.value=this.value.replace(/\D/g,'')}else{this.value=this.value.replace(/\D/g,'')}" 
												 onafterpaste="if(this.value.length==1){this.value=this.value.replace(/\D/g,'0')}else{this.value=this.value.replace(/\D/g,'')}" 
												name="colLen_body" maxlength="7" check-empty="true">
										</div>
									</div>
								</div>
								<div class="col-md-4 column">
									<div style="display: none;">
										<select data-role="multiselect" id="tempFlg_body" class=""
											...
											<select data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CHG_CLOB_FLG" id="clobFlg_body" class=""
