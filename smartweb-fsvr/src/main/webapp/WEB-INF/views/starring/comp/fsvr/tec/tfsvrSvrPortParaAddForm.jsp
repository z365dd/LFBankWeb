...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrPortParaAddForm.js"
	charset="utf-8"></script>
						...
						<div class="col-md-12 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 组件号 </label>
								<div class="col-sm-3">
											<select data-role="multiselect" id="compNo" class="" name="compNo" check-empty="true" data-max-height="300" data-non-selected-text="请选择"
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 端口号 </label>
								<div class="col-sm-3">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-3">
									<select data-role="multiselect" id="netRegion" class=""
										...
										data-filter-placeholder="搜索" data-non-selected-text="请选择">
									</select>
								</div>
							</div>
						</div>
						...
						<div class="col-md-2 column">
							<shiro:haspermission name="anno">
								<button ravo="rainbow_fx" type="button" class="btn btn-primary"
									contenteditable="false" id="saveBtn" name="saveBtn">提交</button>
							</shiro:haspermission>
						</div>
						<div class="col-md-2 column">
							<shiro:haspermission name="anno">
								<button ravo="rainbow_fx" type="button" class="btn btn-default"
									contenteditable="false" id="cancleBtn" name="cancleBtn">返回</button>
							</shiro:haspermission>
						</div>
					</div>
				</form>
