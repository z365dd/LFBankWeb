...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrParaUpdateForm.js"
	charset="utf-8"></script>
		...
		<div ravo="rainbow_fx_layout" class="row clearfix">
			<div class="col-md-12 column">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal breadcrumb"
					pourl="" id="tfsvrSvrParaForm" style="margin-top: 10px;">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" maxlength="64"
										id="fileSvrId" name="fileSvrId" check-empty="true" readonly="readonly">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<select data-role="multiselect" id="openSvcFlg" class=""
										name="openSvcFlg"
										data-url="${ctx}/sys/dict/selectData?type=OPEN_SVC_FLG"
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-12 column" style="margin-left: 4.4%">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-2 control-label control-label"> 描述 </label>
								<div class="col-sm-7">
									<input type="text" class="form-control" maxlength="80"
										id="svrDesc" name="svrDesc" check-empty="true">
								</div>
							</div>
						</div>
					</div>
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 主机IP </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" maxlength="30" id="ip"
										name="ip" check-empty="true">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 端口 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" maxlength="10"
										id="port" name="port" check-empty="true">
								</div>
							</div>
						</div>
					</div>
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 用户名 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" maxlength="30"
										id="userNo" name="userNo" check-empty="true">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 密码 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" maxlength="80"
										id="pwd1" name="pwd1" check-empty="true">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label"> 上传路径 </label>
								<div class="col-sm-4">
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class=" col-sm-3 control-label">
									通讯协议 </label>
								<div class="col-sm-7">
									<select data-role="multiselect" id="commProtGrpTp" class=""
										name="commProtGrpTp"
										data-url="${ctx}/sys/dict/selectData?type=COMM_PROT_GRP_TP"
										data-async="true" blank-item="true" checkbtn="commProtGrpTp">
										<option value="1">获取参数失败</option>
									</select>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 确认密码 </label>
								<div class="col-sm-4"> 
									<input type="text" class="form-control" id="pwd2" name="pwd2" check-empty="true">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label"> 下载路径 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" maxlength="256"
										id="downloadFilePath" name="downloadFilePath">
								</div>
							</div>
						</div>
					</div>
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class=" col-sm-5 control-label">
									断点续传 </label>
								<div class="col-sm-7">
									<select data-role="multiselect" id="contFlg" class=""
										name="contFlg" 
										data-url="${ctx}/sys/dict/selectData?type=CONT_FLG"
						...
						<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									依赖网络区域 </label>
								<div class="col-sm-7">
									<select data-role="multiselect" id="deponFileSvrId" class=""
										name="deponFileSvrId" multiple="multiple" data-async="true"
										blank-item="true" data-enable-filtering="true"
								...
								<div class="col-md-4 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button"
											class="btn btn-info" contenteditable="false" id="saveBtn"
											name="saveBtn">提交</button>
									</shiro:haspermission>
								</div>
								...
								<div class="col-md-4 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button"
											...
											id="cancleBtn" name="cancleBtn">返回</button>
									</shiro:haspermission>
								</div>
								<div class="col-md-5 column"></div>
							</div>
