...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrPortParaList.js"
	charset="utf-8"></script>
			...
			<div class="col-md-12 column">
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
					<div class="panel-body" contenteditable="false">
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3"
													class="col-sm-4 control-label control-label"> 组件名称 </label>
												<div class="col-sm-7">
						...
						<table class="table table-hover" id="tfsvrSvrPortParaTable"
							data-side-pagination="server" data-toggle="table"
							data-url="${ctx}/comp/fsvr/tec/tfsvrSvrPortPara/list"
							...
							<thead>
								<tr>
									...
									<th data-field="compNo" data-title="组件号" data-visible="false"
										data-switchable="false">组件号的值</th>
									<th data-field="compNoStr" data-title="组件号">组件号</th>
