...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/test/fsvrFileSearch.js" charset="utf-8"></script>
													...
													<div class="col-md-6 column">
														...
														<div ravo="rainbow_fx" class="form-group">
															<label for="inputEmail3" class="col-sm-5 control-label">
																搜索类型 </label>
															<div class="col-sm-4">
																<select data-role="multiselect" id="SEARCH_TP" class=""
																	name="SEARCH_TP" data-url="${ctx}/sys/dict/selectData?type=SEARCH_TP" checkbtn="SEARCH_TP">
																	<option value="">请选择</option>
																</select>
															</div>
														</div>
														...
														<div ravo="rainbow_fx" class="form-group">
															<label for="inputEmail3"
																...
																文件名表达式</label>
															<div class="col-sm-5">
																<input type="text" class="form-control" placeholder="请输入正则表达式"
																	id="EXPR" name="EXPR">
															</div>
														</div>
													</div>
													...
													<div class="col-md-6 column">
														<div ravo="rainbow_fx" class="form-group">
															<label for="inputEmail3"
																...
																文件名</label>
															<div class="col-sm-7">
															<textarea class="form-control" id="FILE_NAME"
																		name="FILE_NAME" rows="5" readonly="readonly">
															</textarea>
															</div>
														</div>
													</div>
