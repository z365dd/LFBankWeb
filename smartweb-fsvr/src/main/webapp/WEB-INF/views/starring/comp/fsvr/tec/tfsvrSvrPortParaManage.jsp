...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/fsvr/tec/tfsvrSvrPortParaManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tfsvrSvrPortParaList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="组件文件传输端口列表" aria-expanded="true" url="${ctx}/comp/fsvr/tec/tfsvrSvrPortPara/tfsvrSvrPortParaList">
							组件文件传输端口列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrSvrPortPara/tfsvrSvrPortParaAdd">
							组件文件传输端口添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrSvrPortPara/tfsvrSvrPortParaUpdate">
							组件文件传输端口更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/fsvr/tec/tfsvrSvrPortPara/tfsvrSvrPortParaDetail">
							组件文件传输端口详情
						</a>
					</li>
				</ul>
