...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/center/centerDetailForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_fold" class="panel-group" id="myAccordion">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<a class="btn  btn-xs btn-default" data-toggle="collapse" data-parent="#myAccordion"
								...
								<div ravo="rainbow_fx_layout" class="row clearfix" >
									<div class="col-md-12 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-2">
												<input type="text" style="display:none" class="form-control" placeholder="" id="centerId" name="centerId">
												<input type="text" readonly="readonly" class="form-control" placeholder="" id="chName" name="chName">
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class="col-sm-5 control-label control-label"
											...
											<div class="col-sm-2">
												<input type="text" readonly="readonly" class="form-control" placeholder="" id="engName" name="engName">
											</div>
										</div>
										<div ravo="rainbow_fx_checkbox" class="form-group">
											...
											<div class="col-sm-5" >
												<input type="text" name="cacheMode" style="display: none;">
												<select data-role="multiselect" id="cacheMode" name="" >
													<option value="00">
														ZooKeeper + Redis
													</option>
												</select>
										...
										<!-- <div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-2">
												<input type="text" class="form-control" placeholder="" id="basePath" name="basePath"
								...
								<div ravo="rainbow_fx_layout" class="row clearfix" id="zkInfo">
									<div class="col-md-12 column zkNode">
										<div ravo="rainbow_fx_layout" class="row clearfix zkNode-add" data-node="zk_0" style="display: none;">
											<div class="col-md-12 column nodeinfo">
												<div ravo="rainbow_fx_layout" class="row clearfix">
													...
													<div class="col-md-10 column">
														<p>
															...
															<button ravo="rainbow_fx" type="button" class="btn btn-default" contenteditable="false" onclick="hide(this)">
																显示/隐藏
															</button>
														</p>
													</div>
												...
												<div ravo="rainbow_fx_layout" class="row clearfix nodeShow" data-nodeinfo="zk_0" >
													<div class="col-md-12 column">
																...
																<div ravo="rainbow_fx_layout" class="row clearfix">
																	...
																	<div class="col-md-4 column"> 
																		<div ravo="rainbow_fx" class="form-group">
																			...
																			<div class="col-sm-5">
																				<input type="text" readonly="readonly" class="form-control" placeholder="" id="ip" name="ip" >
																			</div>
																		</div>
																	</div>
																	<div class="col-md-4 column">
																		<div ravo="rainbow_fx" class="form-group">
																			...
																			<div class="col-sm-5">
																				<input type="text" readonly="readonly" class="form-control" placeholder="" id="port" name="port">
																			</div>
																		</div>
																	</div>
																	<div class="col-md-3 column">
																		<div ravo="rainbow_fx" class="form-group" style="display:none">
																			...
																			<div class="col-sm-5">
																				<input type="text" readonly="readonly" class="form-control" placeholder="" id="myId" name="myId">
																			</div>
																		</div>
																	</div>
																</div>
							...
							<div class="panel-body" contenteditable="false">
								<div ravo="rainbow_fx_layout" class="row clearfix" id="rsInfo">
									<div class="col-md-12 column rsNode">
										<div ravo="rainbow_fx_layout" class="row clearfix rsNode-add" data-node="rs_0" style="display: none;">
											<div class="col-md-12 column nodeinfo">
												...
												<div ravo="rainbow_fx_layout" class="row clearfix nodeShow" data-nodeinfo="rs_0">
													<div class="col-md-12 column">
														...
														<div ravo="rainbow_fx_layout" class="row clearfix">
															...
															<div class="col-md-3 column">
																<div ravo="rainbow_fx" class="form-group">
																	...
																	<div class="col-sm-8">
																		<input type="text" readonly="readonly" class="form-control" placeholder="" id="rsIp" name="rsIp">
																	</div>
																</div>
															</div>
															<div class="col-md-3 column"> 
																<div ravo="rainbow_fx" class="form-group">
																	...
																	<div class="col-sm-8">
																		<input type="text" readonly="readonly" class="form-control" placeholder="" id="rsPort" name="rsPort">
																	</div>
																</div>
															</div>
															<div class="col-md-4 column">
														...
														<div class="slaveNode">
															<div ravo="rainbow_fx_layout" class="row clearfix slaveNode-add"  style="display:none" >
																<input type="text" style="display:none" class="form-control" placeholder="" id="id" name="id">
																<div class="col-md-1 column">
																</div>
																<div class="col-md-1 column">
																	<p><span class="label pull-right" style="font-size:12px;color:#328ee3;margin-top:10px">从节点</span></p>
																</div>
																<div class="col-md-3 column">
																	<div ravo="rainbow_fx" class="form-group">
																		<label for="inputEmail3" class="col-sm-4 control-label">
																		...
																		<div class="col-sm-8">
																			<input type="text" readonly="readonly" class="form-control" placeholder="" id="rsSlaveIp" name="rsSlaveIp">
																		</div>
																	</div>
																</div>
																<div class="col-md-3 column">
																	<div ravo="rainbow_fx" class="form-group">
																		...
																		<div class="col-sm-8">
																			<input type="text" readonly="readonly" class="form-control" placeholder="" id="rsSlavePort" name="rsSlavePort">
																		</div>
																	</div>
																</div>
																<div class="col-md-4 column">
