...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/rules/stgList.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 10px 0px 0px 10px;">
					<div class="col-md-3 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-8">
								<select data-role="multiselect" id="syncFlg" class="" name="syncFlg"
										data-url="${ctx}/sys/dict/selectData?type=SYNC_FLG"
			...
			<table id="rulesTable" data-toggle="table" data-first-load="true" data-url="${ctx}/para/rules/stg/list"
