...
<script type="text/javascript" src="<%=basePath%>/b_base/jquery-migrate-3.4.0.min.js" charset="utf-8"></script><script type="text/javascript" src="<%=basePath%>/b_base/jqueryForm.js" charset="utf-8"></script>
	...
	<!-- Self reference JS-->
	<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/center/centerUpdateForm.js" charset="utf-8"></script>
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-2">
												<input type="text" class="form-control" placeholder="" id="chName" name="chName"
													   check-minlength="2" maxlength="8" check-chinese="true" check-empty="true">
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class="col-sm-5 control-label control-label"
											...
											<div class="col-sm-2">
												<input type="text" class="form-control" placeholder="" id="engName" name="engName" readonly="readonly"
													   check-minlength="2" maxlength="16" check-alphanumericsymbols="true" check-empty="true">
											</div>
										</div>
											...
											<div class="col-md-12 column ">
												...
												<div ravo="rainbow_fx_layout" class="row clearfix nodeShow" data-nodeinfo="rs_0">
													<div class="col-md-12 column">
														...
														<div class="slaveNode">
															<div ravo="rainbow_fx_layout" class="row clearfix slaveNode-add" data-slavenode="rs_0" data-slave="slave_1" style="display: none">
																<div class="col-md-1 column">
																</div>
																<div class="col-md-1 column">
