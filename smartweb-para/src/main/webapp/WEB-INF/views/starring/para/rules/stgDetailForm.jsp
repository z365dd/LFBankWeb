...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/rules/stgDetailForm.js" charset="utf-8"></script>
					...
					<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="addForm">
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-3 column">
								<input readonly="readonly" type="text" class="form-control" placeholder="" id="id" name="id" style="display: none;">
								<input readonly="readonly" type="text" class="form-control" placeholder="" id="tenant" name="tenant" style="display: none;">
							</div>
							<div class="col-md-8 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<input readonly="readonly" type="text" class="form-control" placeholder="" id="engName" name="engName" readonly="readonly"
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<input readonly="readonly" type="text" class="form-control" placeholder="" id="tabName" name="tabName" readonly="readonly"
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<input readonly="readonly" type="text" class="form-control" placeholder="" id="chName" name="chName"
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<select data-role="multiselect" id="sameDbFlg" data-url="${ctx}/sys/dict/selectData?type=SAME_DB_FLG" class="" name="sameDbFlg" checkbtn="sameDbFlg">
											<option value="#">
												请选择
											</option>
										</select>
								...
								<div ravo="rainbow_fx" class="form-group divSrcDataSrc">
									...
									<div class="col-sm-5">
										<input readonly="readonly" type="text" class="form-control" placeholder="" id="srcDataSrc" name="srcDataSrc"
										check-empty="true" check-minlength="2" maxlength="8" check-chinese="true">
									</div>
								</div>
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<select data-role="multiselect" id="busiNoFlg" data-url="${ctx}/sys/dict/selectData?type=BUSI_NO_FLG" class="" name="busiNoFlg" checkbtn="busiNoFlg">
											<option value="#">
												请选择
											</option>
										</select>
