...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/agentManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a href="#tab_list" data-toggle="tab" class="" aria-expanded="true" url="${ctx}/para/chk/agent/listPage">
							代理列表
						</a>
					</li>
					<li>
						<a href="#tab_data" data-toggle="tab" class="" aria-expanded="false" url="${ctx}/para/chk/agent/agentData">
							代理数据
						</a>
					</li>
					<li>
						<a href="#tab_agentData" data-toggle="tab" class="" aria-expanded="false" url="${ctx}/para/chk/agent/agentDataPage">
							代理存储规则
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div  class="tab-pane in active" id="tab_list">
						<iframe id="iframe_list" name="iframe_list" src="" style="width: 100%; height: 900px; border: 0px;" scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_data">
						<iframe id="iframe_data" name="iframe_data" src="" style="width: 100%; height: 900px; border: 0px;" scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_agentData">
						<iframe id="iframe_agentData" name="iframe_agentData" src="" style="width: 100%; height: 900px; border: 0px;" scrolling="no" frameborder="no">
						</iframe>
					</div>
				</div>
			</div>
