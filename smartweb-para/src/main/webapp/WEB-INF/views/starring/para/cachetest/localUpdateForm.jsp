...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/cache/cachetest/localUpdateForm.js" charset="utf-8"></script>
	...
	<div class="col-md-12 column">
		<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
			...
			<div class="panel-body" contenteditable="false">
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-left:50px">
						<div class="col-md-12 column">
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="addForm">
									<input type="hidden" class="form-control" placeholder="" id="dataKey" name="dataKey">
									<input type="hidden" class="form-control" placeholder="" id="rules" name="rules">
									<input type="hidden" class="form-control" placeholder="" id="colJson" name="colJson">
								</form>
								<div class="col-md-2 column">
									<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="addForm">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-5">
												<select data-role="multiselect" id="rulesSelect" class="" name="rulesSelect">
													<option value="">
														请选择
													</option>
												</select>
								...
								<div class="col-md-5 column uniqueKey" >
									<div ravo="rainbow_fx" class="form-group">
										<label for="inputEmail3" class="col-sm-3 control-label" style="visibility:visible">
											唯一索引组合：
										</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" placeholder="" id="uniqueKey"  disabled="disabled">
										</div>
									</div>
								</div>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-12 column">
									<div id="data">
										<form ravo="rainbow_fx_layout_bd" class="form-horizontal"  id='form' style='margin-top: 10px;'>
											<div ravo="rainbow_fx_layout" class="row clearfix colInfo">
												...
												<div class="col-md-3 column">
													<div ravo="rainbow_fx" class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" placeholder="" id="colId" name="colId">
														</div>
													</div>
												</div>
												<div class="col-md-3 column">
													<div ravo="rainbow_fx" class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" placeholder="" id="colName" name="colName" >
														</div>
													</div>
												</div>
												<div class="col-md-3 column">
													<div ravo="rainbow_fx" class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" placeholder="" id="rmrk" name="rmrk"  >
															<input type="hidden" class="form-control" placeholder="" id="nullFlg" name="nullFlg"  >
															<input type="hidden" class="form-control" placeholder="" id="uniqFlg" name="uniqFlg"  >
														</div>
													</div>
												</div>
											</div>
											<div ravo="rainbow_fx_layout col" class="row clearfix" style="margin-top: 20px">
												<div class="col-md-4 column">
												</div>
													...
													<div class="col-sm-7">
														<table id="table" data-toggle="table" data-first-load="false"
															...
															<tr>
																...
																<th data-field="nullFlg">是否为空</th>
																<th data-field="uniqFlg">唯一索引</th>
																<th data-field="rmrk">值</th>
