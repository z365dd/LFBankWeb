...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/cachetest/transferDataForm.js" charset="utf-8"></script>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-left:50px">
						...
						<div class="col-md-8 column">
							<div ravo="rainbow_fx" class="form-group divCacheCertrId">
								...
								<div class="col-sm-3">
									<select data-role="multiselect" id="cacheCentrId" class="" name="cacheCentrId" checkbtn="cacheCentrId" data-max-height="300"
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class=" col-sm-3 control-label" style="display:none">
									 所属租户：
								</label>
								<div class="col-sm-3" style="display:none">
									<select data-role="multiselect" id="tenant" class="" name="tntNo" checkbtn="tntNo" data-max-height="300"
									data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true"  data-filter-placeholder="搜索" >
										<option value="">
											请选择
										</option>
							...
							<div ravo="rainbow_fx" class="form-group divStorgRuleTp">
								<label for="storgRuleTp" class="col-sm-3 control-label">
									存储规则类型：
								</label>
								<div class="col-sm-5">
							...
							<div ravo="rainbow_fx" class="form-group divReadAuthLvl">
<%--								<input type="hidden" class="form-control" placeholder="" id="readAuthLvl" name="readAuthLvl" value="00">--%>
								<label for="readAuthLvl" class="col-sm-3 control-label">
									读取等级：
								</label>
								<div class="col-sm-5">
							...
							<div ravo="rainbow_fx" class="form-group" style="margin-top: 40px">
								<label for="inputEmail3" class=" col-sm-3 control-label">
								</label>
								<div class="col-sm-3">
									<input id="" name="mfile" type="file" style="width:330px" />
								</div>
							</div>
						</div>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" >
						...
						<div class="col-md-8 column" style="margin: 20px 0px 0px 0px">
							<div ravo="rainbow_fx_layout" class="row clearfix" >
								<div class="col-md-3 column">
								</div>
								<div class="col-md-3 column">
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" >
						...
						<div class="col-md-8 column" style="margin: 20px 0px 0px 0px">
							<div ravo="rainbow_fx_layout" class="row clearfix" >
								...
								<div class="col-md-1 column">
									<shiro:haspermission name="anno">
										<a href="${ctx}/para/test/local/template" id="exprotBtn" ravo="rainbow_fx" type="button" class="btn btn-default" data-original-title="" title="">
											下载模板
										</a>
									</shiro:haspermission>
								</div>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" id="tableDiv"
						style="margin-bottom: 20px; margin-top: 50px; display:none">
						<div class="col-md-12 column">
							<div ravo="rainbow_fx_layout" class="row clearfix">
