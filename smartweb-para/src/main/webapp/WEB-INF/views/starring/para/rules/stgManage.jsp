...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/rules/stgManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a href="#tab_list" data-toggle="tab" class="" aria-expanded="true" id="centerList" url="${ctx}/para/rules/stg/listPage">
							存储规则列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/para/rules/stg/addPage">
							存储规则新增
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/para/rules/stg/updatePage">
							存储规则更新
						</a>
					</li>
					<!--  <li>
						<a href="#tab_grant" data-toggle="tab" aria-expanded="false" url="${ctx}/para/rules/stg/grantPage">
							存储规则授权
						</a>
					</li>-->
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/para/rules/stg/detailPage">
							存储规则详情
						</a>
					</li>
					<li>
						<a href="#tab_import" data-toggle="tab" aria-expanded="false" url="${ctx}/para/test/local/transferDataForm">
							存储规则导入
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane in active" id="tab_list">
						<iframe id="iframe_list" name="iframe_list" src="" style="width: 100%; height: 750px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div id="tab_add" class="tab-pane">
						<iframe id="iframe_add" name="iframe_add" src="" style="width: 100%; height: 600px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_update" class="tab-pane">
						<iframe id="iframe_update" name="iframe_update" src="" style="width: 100%; height: 750px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_grant" class="tab-pane">
						<iframe id="iframe_grant" name="iframe_grant" src="" style="width: 100%; height: 750px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_detail" class="tab-pane">
						<iframe id="iframe_detail" name="iframe_detail" src="" style="width: 100%; height: 750px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_import" class="tab-pane">
						<iframe id="iframe_import" name="iframe_import" src="" style="width: 100%; height: 750px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
				</div>
			</div>
		</div>
