...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/rules/stgUpdateForm.js" charset="utf-8"></script>
					...
					<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="addForm">
						<div ravo="rainbow_fx_layout" class="row clearfix" id="colForm">
							<div class="col-md-3 column">
								...
								<input type="hidden" class="form-control" placeholder="" id="tntNo" name="tntNo">
							</div>
							<div class="col-md-8 column">
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<select data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=SAME_DB_FLG" id="sameDbFlg" class="" name="sameDbFlg" checkbtn="sameDbFlg">
											<option value="">
												请选择
											</option>
										</select>
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-5">
										<select data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=BUSI_NO_FLG" id="busiNoFlg" class="" name="busiNoFlg" checkbtn="busiNoFlg">
											<option value="">
												请选择
											</option>
										</select>
								...
								<div ravo="rainbow_fx" class="form-group divcacheCertrId">
									<label for="inputEmail3" type="hidden" class="col-sm-2 control-label">
										所属缓存中心：
									</label>
									<div class="col-sm-5">
										<select data-role="multiselect" type="hidden" id="cacheCentrId" class="" name="cacheCentrId" checkbtn="centerId">
											<option value="">
												请选择
											</option>
										</select>
								...
								<div ravo="rainbow_fx" class="form-group divstorgRuleTp">
									...
									<div class="col-sm-5">
										<select data-role="multiselect" type="hidden" id="storgRuleType" class="" name="storgRuleType"
												data-url="${ctx}/sys/dict/selectData?type=STORG_RULE_TP">
										</select>
									</div>
								</div>
								<div ravo="rainbow_fx" class="form-group readAuthLevel">
									<input type="hidden" class="form-control" placeholder="" id="readAuthLvl" name="readAuthLvl" style="display: none;">
									<label for="inputEmail3" type="hidden" class="col-sm-2 control-label">
										读取等级：
									</label>
									<div class="col-sm-5">
										<select data-role="multiselect" type="hidden" id="readAuthLevel" class="" name=""  disabled="disabled">
											<option value="00">
												公共
											</option>
										</select>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix colInfo">
								...
								<div class="col-md-3 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" placeholder="" id="colId" name="colId" check-empty="true" check-minlength="2" maxlength="30" check-alphanumericsymbols="true">
										</div>
									</div>
								</div>
								<div class="col-md-3 column">
