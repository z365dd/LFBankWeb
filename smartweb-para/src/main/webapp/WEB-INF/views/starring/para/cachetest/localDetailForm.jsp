...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/cache/cachetest/localDetailForm.js" charset="utf-8"></script>
			...
			<div class="panel-body" contenteditable="false">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column" >
							...
							<div class="col-md-3 column" style="margin-left:50px">
								<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-5">
											<select data-role="multiselect" id="rules" class="" name="rules">
												<option value="">
													请选择
												</option>
											</select>
						...
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-12 column">
								<table id="detailTable" data-toggle="table" data-first-load="false" data-url="${ctx}/cache/test/local/getData"
								...
								data-striped="true">
									<thead style="">
										<tr>
											...
											<th data-field="object" data-width="80%">
												值
											</th>
										</tr>
									</thead>
