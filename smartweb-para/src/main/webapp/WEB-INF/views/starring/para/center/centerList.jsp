...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/center/centerList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			...
			<div ravo="rainbow_fx_layout" class="row clearfix">
				<div class="col-md-12 column">
					...
					<table id="centerTable" data-toggle="table" data-first-load="true" data-url="${ctx}/para/center/list"
					...
					data-striped="true">
						<thead style="">
							<tr>
								<th data-field="engName">
									英文名称
								</th>
								<th data-field="chName">
									中文名称
								</th>
								<th data-field="cacheMode_str">
									缓存方式
								</th>
								<th data-field="runStat_str" class="">
									运行状态
								</th>
