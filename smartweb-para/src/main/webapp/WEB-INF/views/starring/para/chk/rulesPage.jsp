...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/rulesPage.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="listForm">
				<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 10px 0px 0px 10px;">
					...
					<div class="col-md-5 column">
						<div ravo="rainbow_fx" class="form-group divCacheCentrId">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 10px 0px 0px 10px;">
					<div class="col-md-3 column" style="display: none">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-8">
								<select data-role="multiselect" id="tntNo" class="" name="tntNo"
			...
			<table id="rulesTable" data-toggle="table" data-first-load="true" data-url="${ctx}/para/chk/data/ruleList"
					...
					ravo="rainbow_fx_bj" class="table table-hover" data-side-pagination="server">
						<thead style="">
							<tr>
								<th data-field="engName" data-width="200px">
									英文名称
								</th>
								<th data-field="chName" data-width="200px">
									中文名称
								</th>
								<th data-field="tabName" data-width="200px">
								              表名
								</th>
								<th data-field="uniqKey" data-width="400px">
									唯一索引组合
								</th>
								<th data-field="centerName" data-visible="false">
									所属缓存中心
								</th>
								<th data-field="tenantName" data-visible="false">
									所属租户
								</th>
								<th data-field="storgRuleTp_str" data-visible="false">
									存储规则类型
								</th>
								<th data-field="readAuthLvl_str" data-width="50px" data-visible="false">
									读取等级
								</th>
								<th data-field="syncFlg_str" data-width="50px">
									同步标志
								</th>
