...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/dataManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a href="#tab_rules" data-toggle="tab" aria-expanded="false" url="${ctx}/para/chk/data/rulesPage">
							数据查询交易
						</a>
					</li>
					<li>
						<a href="#tab_data" data-toggle="tab" aria-expanded="false" url="${ctx}/para/chk/data/dataPage">
							数据列表
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/para/chk/data/dataDetail">
							数据详情
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div id="tab_rules" class="tab-pane" class="tab-pane in active">
						<iframe id="iframe_rules" name="iframe_rules" src="" style="width: 100%; height: 750px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_data" class="tab-pane">
						<iframe id="iframe_data" name="iframe_data" src="" style="width: 100%; height: 700px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_detail" class="tab-pane">
						<iframe id="iframe_detail" name="iframe_detail" src="" style="width: 100%; height: 700px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
				</div>
			</div>
		</div>
