...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/agentRulesPage.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 10px 0px 0px 10px;">
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" placeholder="" id="name" name="name" check-chinesedigitalsymbols="true" check-space="true">
							</div>
						</div>
					</div>
					<input type="hidden" value="" id="agentKey" name="agentKey">
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">
								英文名称：
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" placeholder="" id="enname" name="enname"  check-alphanumericsymbols="true">
							</div>
						</div>
					</div>
					<div class="col-md-4 column">
			...
			<table id="rulesTable" data-toggle="table" data-first-load="false" data-url="${ctx}/para/chk/agent/agentRulesList"
					...
					ravo="rainbow_fx_bj" class="table table-hover" data-side-pagination="server">
						<thead style="">
							<tr>
								...
								<th data-field="enname">
									英文名称
								</th>
								<th data-field="uniqueKey">
									唯一索引组合
								</th>
								<th data-field="readAuthLevel_str">
									可读等级
								</th>
