...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/cache/cachetest/localManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a href="#tab_list" data-toggle="tab" class="" aria-expanded="true"  url="${ctx}/cache/test/local/listPage">
							缓存列表
						</a>
					</li>
					<li class="active">
						<a href="#tab_tables" data-toggle="tab" class="" aria-expanded="true"  url="${ctx}/cache/test/local/tablesPage">
							缓存多表查询
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/cache/test/local/addPage">
							新增缓存
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/cache/test/local/updatePage">
							更新缓存
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/cache/test/local/detailPage">
							缓存详情
						</a>
					</li>
				</ul>
				<div class="tab-content">
					...
					<div id="tab_tables" class="tab-pane">
						<iframe id="iframe_tables" name="iframe_tables" src="" style="width: 100%; height: 600px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					...
					<div id="tab_update" class="tab-pane">
						<iframe id="iframe_update" name="iframe_update" src="" style="width: 100%; height: 600px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_detail" class="tab-pane">
						<iframe id="iframe_detail" name="iframe_detail" src="" style="width: 100%; height: 600px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
				</div>
			</div>
		</div>
