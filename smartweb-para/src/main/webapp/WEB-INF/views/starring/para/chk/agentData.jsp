...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/agentData.js" charset="utf-8"></script>
		...
		<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
			<div class="panel-heading">
				<div ravo="rainbow_fx_bj">
					<h3 id="h3_agentSeq" class="" contenteditable="false">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx_layout" class="row clearfix">
							...
							<div class="col-md-3 column" style="margin-left:50px">
								<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" >
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-5">
											<select data-role="multiselect" id="rules" class="" name="rules" data-max-height="300">
												<option value="">
													请选择
												</option>
											</select>
						...
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-12 column">
								<table id="detailTable" data-toggle="table" data-first-load="true" data-url="${ctx}/para/chk/agent/agentDataDetail"
								data-click-to-select="true" data-show-export="false" data-show-refresh="false"
								data-show-toggle="false" data-show-columns="false" data-pagination="false"
								...
								data-striped="true">
									<thead style="">
										<tr>
											...
											<th data-field="object" data-width="1000px">
												值
											</th>
										</tr>
									</thead>
							...
							<div class="col-md-4 column" style="margin: 20px 0px 0px 0px">
								<div ravo="rainbow_fx_layout" class="row clearfix" >
									<!--  <div class="col-md-6 column">
										<button ravo="rainbow_fx" type="button" class="btn btn-primary cancleBtn" contenteditable="false" id="cancleBtn_">
											确定
										</button>
									</div>-->
									<div class="col-md-6 column">
										<button ravo="rainbow_fx" type="button" class="btn btn-default cancleBtn" contenteditable="false" id="cancleBtn">
											返回
										</button>
									</div>
								</div>
