...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/cache/cachetest/localTables.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			...
			<div ravo="rainbow_fx_layout" class="row clearfix">
				<div class="col-md-12 column">
					...
					<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="listForm">
						<div id="query">
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px 0px 0px 10px;">
							<div class="col-md-3 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="rules" class="" name="rules" checkbtn="true" data-max-height="300"
							...
							<div class="col-md-3 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4" id="key">
										<select data-role="multiselect" id="uniqueKey" class="" name="uniqueKey" data-max-height="300"
												data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true"  data-filter-placeholder="搜索">
							...
							<div class="col-md-3 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-6" id="value">
										<input type="text" class="form-control" placeholder="" id="uniqueValue" name="uniqueValue">
									</div>
								</div>
							</div>
							<div class="col-md-3 column">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px 0px 0px 10px;">
							<div class="col-md-3 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
<%--										<select data-role="multiselect" id="fRulesSelect" class="" name="fRulesSelect" checkbtn="fRulesSelect" data-max-height="300" multiple="multiple"--%>
<%--												data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索">--%>
<%--											<option value="">--%>
<%--												请选择--%>
<%--											</option>--%>
<%--										</select>--%>
										...
										<select data-role="multiselect" id="fRulesSelect" class="" name="fRulesSelect"
										...
										<input type="hidden" class="form-control" placeholder="" id="fRules" name="fRules">
									</div>
								</div>
							</div>
							<div class="col-md-3 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" placeholder="" id="fKey" name="fKey">
									</div>
								</div>
							</div>
							<div class="col-md-3 column">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px 0px 0px 0px;">
					...
					<table id="localTable" data-toggle="table" data-first-load="false" data-url=""
					...
					ravo="rainbow_fx_bj" class="table table-hover" data-side-pagination="client"
					data-striped="true">
						<thead style="">
							<tr>
								<th data-field="paramType">
									存储规则
								</th>
								<th data-field="uniqueKey" class="">
									唯一索引组合
								</th>
								<th data-field="unixKey" class="">
									唯一索引组合值
								</th>
