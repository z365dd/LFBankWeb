...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/dataDetail.js" charset="utf-8"></script>
					...
					<div class="col-md-12 column">
						...
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="listForm">
							<div ravo="rainbow_fx" class="form-group">
								<div class="col-sm-8">
									<input type="hidden" class="form-control" placeholder="" name="redisKey" id="redisKey">
								</div>
							</div>
						</form>
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-12 column">
								<table id="detailTable" data-toggle="table" data-first-load="true" data-url="${ctx}/para/chk/data/getData"
