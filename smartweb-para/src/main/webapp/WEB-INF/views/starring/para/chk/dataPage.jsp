...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/dataPage.js" charset="utf-8"></script>
					...
					<div class="col-md-12 column">
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="qryForm">
							<div ravo="rainbow_fx" class="form-group" style="display:none">
								<label for="inputEmail3" class="col-sm-4 control-label" style="visibility:hidden">
									Rainbow：
								</label>
								<div class="col-sm-8">
									<input type="hidden" class="form-control" placeholder="" name="engName"
									id="engName">
								</div>
							</div>
							<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 0px 0px 10px 10px;">
	                            <div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
		                                ...
		                                <div class="col-sm-6">
		                                    <input type="text" class="form-control" placeholder="" name="unixKey"
		                                    id="unixKey">
		                                </div>
		                            </div>
	                            </div>
							...
							<div class="col-md-4 column" style="margin: 20px 0px 0px 0px">
								<div ravo="rainbow_fx_layout" class="row clearfix" >
									<div class="col-md-6 column">
										<button ravo="rainbow_fx" type="button" class="btn btn-default" contenteditable="false" id="cancleBtn_">
											返回
										</button>
									</div>
								</div>
