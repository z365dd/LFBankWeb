...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/agentDataPage.js" charset="utf-8"></script>
	...
	<div class="col-md-12 column">
		<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
			...
			<div class="panel-body" contenteditable="false">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="qryForm">
							<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 0px 0px 10px 10px;">
								<div class="col-md-3 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input type="hidden" class="form-control" placeholder="" name="agentKey" id="agentKey">
											<input type="hidden" class="form-control" placeholder="" name="rule" id="rule">
											<input type="hidden" class="form-control" placeholder="" name="token" id="token">
						...
						data-undefined-text="**" data-height="600" data-content-type="application/x-www-form-urlencoded"
						ravo="rainbow_fx_bj" class="table table-hover" data-side-pagination="client"
						data-striped="true">
							<thead style="">
								<tr>
									<th data-field="paramType" class="">
										存储规则
									</th>
									<th data-field="unixKey">
										唯一索引组合值
									</th>
									<th data-field="cacheSeq">
									             本地缓存序号
									</th>
									<th data-field="redisSeq">
									    redis缓存序号
									</th>
							...
							<div class="col-md-4 column" style="margin: 20px 0px 0px 0px">
								<div ravo="rainbow_fx_layout" class="row clearfix" >
									<!--  <div class="col-md-6 column">
										<button ravo="rainbow_fx" type="button" class="btn btn-primary" contenteditable="false" id="cancleBtn_">
											确定
										</button>
									</div>-->
									<div class="col-md-6 column">
