...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/center/centerManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a href="#tab_list" data-toggle="tab" class="" aria-expanded="true" id="centerList" url="${ctx}/para/center/listPage">
							缓存节点列表
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/para/center/updatePage">
							缓存节点更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/para/center/detailPage">
							缓存节点详情
						</a>
					</li>
				</ul>
