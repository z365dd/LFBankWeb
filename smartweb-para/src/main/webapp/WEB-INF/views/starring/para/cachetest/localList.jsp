...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/cache/cachetest/localList.js" charset="utf-8"></script>
						...
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px 0px 0px 10px;">
							...
							<div class="col-md-2 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="custom" class="" name="custom" data-max-height="300">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px 0px 0px 10px;">
							...
							<div class="col-md-2 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="oper" class="" name="oper" data-max-height="300">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px 0px 0px 0px;">
							<div class="col-md-8 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-8">
										<table id="coltable" data-toggle="table" data-first-load="false"
