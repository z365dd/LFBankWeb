...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/para/chk/agentList.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="listForm">
				<div ravo="rainbow_fx_layout" class="row clearfix" style="margin: 10px 0px 0px 10px;">
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="tenant" class="" name="tenant" data-max-height="300" 
					...
					<div class="col-md-4 column" style="display: none">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label control-label"
							style="visibility:visible">
								参与者：
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="partId" class="" name="partId" data-max-height="300"
								data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true"  data-filter-placeholder="搜索">
									<option value="">
										请选择
									</option>
			...
			<table class="table table-hover" data-click-to-select="true" data-content-type="application/x-www-form-urlencoded"
			data-first-load="true" data-height="600" data-method="post" data-pagination="true"
			data-query-params="queryParams" data-search="false" data-show-columns="false"
			data-show-export="false" data-show-refresh="false" data-show-toggle="false"
			data-side-pagination="client" data-toggle="table" data-undefined-text="**"
			data-url="" id="agentTable" ravo="rainbow_fx_bj">
				<thead style="">
					<tr>
						<th data-field="agentSeq">
							代理编号
						</th>
						<th data-field="partInstSeq">
							参与者编号
						</th>
						<th data-field="addr">
							网络地址
						</th>
						<th data-field="tenant_str">
							租户
						</th>
						<th data-field="partId_str" data-visible="false">
							参与者
						</th>
						<th data-field="token" data-visible="false">
							令牌-测试
						</th>
						<th data-field="partVersion" data-visible="false">
							参与者版本
						</th>
						<th data-field="status_str">
							状态
						</th>
						<th data-field="access" data-width="150px" data-visible="false" data-formatter="accessFormat">
							是否接入缓存中心
						</th>
