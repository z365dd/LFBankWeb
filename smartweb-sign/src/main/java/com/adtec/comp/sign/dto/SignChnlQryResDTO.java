...
public class SignChnlQryResDTO {
	private String BUSI_NO;
	private String SUB_BUSI_NO;
	private String ENTR_NO;
	private long NUM;
	private List<SignChnlQryListDTO> LIST = new ArrayList<SignChnlQryListDTO>();
	...
	public List<SignChnlQryListDTO> getLIST() {
		return LIST;
	}
	public void setLIST(List<SignChnlQryListDTO> lIST) {
		LIST = lIST;
	}
}
