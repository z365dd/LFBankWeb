...
public class FSignFuncCustModSimpleListReqDTO {
	...
	//private FSignFuncCustModSimpleANReqDTO ACCT_NODE;
	private List<FSignFuncCustModSimpleANReqDTO> ACCT_NODE = new ArrayList<FSignFuncCustModSimpleANReqDTO>();
	private List<FSignFuncCustModSimpleLimitListReqDTO> LIMIT_LIST = new ArrayList<FSignFuncCustModSimpleLimitListReqDTO>();
	private List<FSignFuncCustModSimpleChnlListReqDTO> CHNL_LIST = new ArrayList<FSignFuncCustModSimpleChnlListReqDTO>();
	...
	public List<FSignFuncCustModSimpleANReqDTO> getACCT_NODE() {
		return ACCT_NODE;
	}
	public void setACCT_NODE(List<FSignFuncCustModSimpleANReqDTO> aCCT_NODE) {
		ACCT_NODE = aCCT_NODE;
	}
	public List<FSignFuncCustModSimpleLimitListReqDTO> getLIMIT_LIST() {
		return LIMIT_LIST;
	}
	public void setLIMIT_LIST(List<FSignFuncCustModSimpleLimitListReqDTO> lIMIT_LIST) {
		LIMIT_LIST = lIMIT_LIST;
	}
	public List<FSignFuncCustModSimpleChnlListReqDTO> getCHNL_LIST() {
		return CHNL_LIST;
	}
	public void setCHNL_LIST(List<FSignFuncCustModSimpleChnlListReqDTO> cHNL_LIST) {
		CHNL_LIST = cHNL_LIST;
	}
