console.log('signVerifyFileList.js');
$(function(){
	disabledS("BAT_STAT");
...
function batQry(){
	if(proof()){
		$.get(ctx+"/comp/sign/test/signVerifyFile/signVerifFileQry",{
...
function setVal(Data){
	...
	if(""==Data.FILE_SET_SEQ || undefined==Data.FILE_SET_SEQ ){
		...
		$("#downLoadBtnFile").attr("href",ctx+"/comp/sign/test/signVerifyFile/downLoad?file="+encodeURIComponent(Data.FILE_SET_SEQ));
