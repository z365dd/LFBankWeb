console.log('signVerifyFileForm.js');
...
$(function(){
	...
	//提交
	$('#addBtn').on('click',signVerifyFileAdd);
...
function resetFile(Id){
	...
	$('#'+Id).fileinput({
		...
		uploadUrl:ctx+'/comp/sign/test/signVerifyFile/upload',//上传的地址  
...
function signVerifyFileAdd(){
	if(proof()){
		...
		Ewin.confirm({
			...
			$.post(ctx+"/comp/sign/test/signVerifyFile/verifFileAdd",{
				//TODO
