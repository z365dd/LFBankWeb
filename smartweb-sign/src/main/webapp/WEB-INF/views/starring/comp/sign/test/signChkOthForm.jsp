...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/sign/test/signChkOthForm.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						<li class="active"><a href="#panel1" data-toggle="tab"
							id="tab1" name="tab1">第三方系统签约对账</a></li>
					</ul>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-12 column">
									<form ravo="rainbow_fx_layout_bd" class="form-horizontal"
										pourl="" id="formId_683647" style="margin-top: 20px">
										<div ravo="rainbow_fx_layout" class="row clearfix">
											<div class="col-md-6 column">
												<div ravo="rainbow_fx" class="form-group">
													...
													<div class="col-sm-4">
														<input input_type="treesearch"
															search_url="/comp/sign/test/signChkOth/busiList"
															id="BUSI_NO" name="BUSI_NO" readonly="readonly" type="text"
															value="" data-msg-required="" class="form-control input-small"
															style="" placeholder="" check-jbox-empty="true"> 
													</div>
												</div>
												<div ravo="rainbow_fx" class="form-group">
												...
												<div class="input-group-sm  col-sm-4">
													<input type="text" readonly="readonly" maxlength="20"
														...
														datetime-skin="twoer" datetime-date-fmt="yyyyMMdd "
														...
														data-link-field="val_CHK_DATE"
														id="CHK_DATE"
														onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('CHK_DATE');}});"
														onchange="writeDateValue('CHK_DATE');">
													<input type="hidden" id="val_CHK_DATE" value=""
														data-bv-="true" name="CHK_DATE">
												</div>
											</div>
												<div ravo="rainbow_fx" class="form-group">
													<input type="hidden" value="" id="hidden_FILE_SET_SEQ"
														name="FILE_SET_SEQ"> <label for="inputEmail3"
														class="col-sm-5 control-label"> 文件 </label>
													<div class="col-sm-5 fileInput">
														<input id="FILE_SET_SEQ" class="file" type="file"
															name="file">
													</div>
												</div>
											</div>
