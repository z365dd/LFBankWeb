...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/sign/test/signVerifyFileForm.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						<li class="active"><a href="#panel1" data-toggle="tab"
							id="tab1" name="tab1">签约校验（文件）</a></li>
					</ul>
											...
											<div class="col-md-6 column">
												<div ravo="rainbow_fx" class="form-group">
													<label for="inputEmail3"
														...
														签约协议类型 </label>
													<div class="col-sm-4">
														<select data-role="multiselect" id="SIGN_PROT_TP_ID" name="SIGN_PROT_TP_ID"
