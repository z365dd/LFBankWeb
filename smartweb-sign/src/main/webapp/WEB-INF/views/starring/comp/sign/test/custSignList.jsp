...
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/test/custSignList.js" charset="utf-8"></script>
	...
	<div class="tab-content">
		<div class="tab-pane active in" id="panel1">
			<div class="panel-body" contenteditable="false" id="chkEmpty">
						...
						<div class="col-md-6 column">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="input-group-sm  col-sm-4">
									...
									id="ACCT" name="ACCT" check-empty="ACCT">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label class=" control-label col-sm-5 control-label">
				...
				<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/sign/test/custsign/signCustQry"
