...
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/tec/paraBusiList.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-751707">
		...
		<div class="tab-content">
			<div class="tab-pane active in" id="panel1">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="OPEN_STAT" class="" name="OPEN_STAT" data-max-height="300">
												<option value="">
													全部
												</option>
												<option value="1">
				...
				<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/sign/tec/parabusi/paraBusiQry"
