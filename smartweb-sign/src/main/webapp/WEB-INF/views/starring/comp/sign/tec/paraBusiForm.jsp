...
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/tec/paraBusiForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="panel-body" contenteditable="false" id="chkEmpty">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_735139">
					<div ravo="rainbow_fx_layout" class="row clearfix">
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="input-group-sm  col-sm-4">
									...
									id="BUSI_NO" name=""BUSI_NO"" readonly="readonly">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<select data-role="multiselect" id="SIGN_FLG" class="" name="SIGN_FLG"  data-max-height="300" checkbtn="SIGN_FLG">
										<option value="">请选择</option>
										<option value="Y">可被签约</option>
										<option value="N">不可被签约</option>
									</select>
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="input-group-sm  col-sm-6">
									<input type="text" class="form-control" placeholder="" 
									id="BUSI_NAME" name="BUSI_NAME" check-empty="true" maxlength="40">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<select data-role="multiselect" id="OPEN_STAT" name="OPEN_STAT" class="" name="OPEN_STAT"  data-max-height="300" checkbtn="OPEN_STAT">
										<option value="">请选择</option>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<select data-role="multiselect" id="FLG" name="FLG" class="" name="FLG"  data-max-height="300" checkbtn="FLG">
										<option value="">请选择</option>
								...
								<div class="col-md-5 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button"
											...
											id="addBtn" name="addBtn">提交</button>
									</shiro:haspermission>
								</div>
							</div>
						</div>
								...
								<div class="col-md-5 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button"
											...
											id="retuBtn" name="retuBtn">返回</button>
									</shiro:haspermission>
								</div>
							</div>
						</div>
