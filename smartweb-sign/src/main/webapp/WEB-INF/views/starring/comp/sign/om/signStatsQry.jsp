...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/om/signStatsQry.js" charset="utf-8"></script>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<form ravo="rainbow_fx_layout_bd" class="form-horizontal"
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-5 control-label"> 组件号 </label>
											<div class="col-sm-6">
										...
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-5 control-label"> 子业务编号
											</label>
											<div class="col-sm-3">
												<select id="SUB_BUSI_NO" name="SUB_BUSI_NO" class="">
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="input-group-sm  col-sm-4">
												<input type="text" readonly="readonly" maxlength="20"
													...
													onchange="writeDateValue('STR_DATE');" check-startTime-two="true">
													<input type="hidden" id="STR_DATE" value="" data-bv-="true"
													name="STR_DATE">
											</div>
										</div>
									</div>
									<div class="col-md-6 column">
										...
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-3 control-label"> 单位编号
											</label>
											<div class="col-sm-3">
												<select data-role="multiselect" id="ENTR_NO" name="ENTR_NO" class="" data-max-height="300">
													<option value="">请选择</option>
												</select>
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="input-group-sm  col-sm-4">
												<input type="text" readonly="readonly" maxlength="20"
													...
													onchange="writeDateValue('END_DATE');" check-endTime-two="true"> 
													<input type="hidden" id="END_DATE" value="" data-bv-="true"
													name="END_DATE">
											</div>
											<div class="col-sm-3">
											<div ravo="rainbow_fx_layout" class="row clearfix">
												...
												<div class="col-md-10 column">
													<shiro:haspermission name="anno">
														<button ravo="rainbow_fx" type="button" class="btn btn-primary" contenteditable="false" id="qryBtn">查询</button>
													</shiro:haspermission>
												</div>
											</div>
										</div>
							...
							<table id="table" data-toggle="table" data-first-load="false"
								data-url="${ctx}/comp/sign/om/signStats/qry"
								...
								<thead style="">
									<tr>
										...
										<th data-field="COMP_NAME">组件名称</th>
										<th data-field="BUSI_NO">业务编号</th>
										<th data-field="BUSI_NAME">业务名称</th>
										<th data-field="SUB_BUSI_NO">子业务编号</th>
										<th data-field="SUB_BUSI_NAME">子业务名称</th>
										<th data-field="ENTR_NO">单位编号</th>
										<th data-field="ENTR_NAME">单位名称</th>
										<th data-field="SUCC_TOT_NUM">签约数量</th>
										<th data-field="FAIL_TOT_NUM">解约数量</th>
									</tr>
								</thead>
							</table>
						</div>
