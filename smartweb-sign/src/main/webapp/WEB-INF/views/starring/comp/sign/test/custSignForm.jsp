...
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/test/custSignForm.js" charset="utf-8"></script>
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="input-group-sm  col-sm-4">
									...
									id="ACCT" name="ACCT" check-empty="true" maxlength="64">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label class=" control-label col-sm-5 control-label">
								...
								<div class="input-group-sm  col-sm-4">
									...
									id="ACCT_PASS" name="ACCT_PASS" check-empty="true" disabled="disabled">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="input-group-sm  col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="ACCT_NAME" name="ACCT_NAME" check-empty="true" maxlength="90">
								</div>
							</div>
						</div>
					</div>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									客户类型 </label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="CUST_TP" class="" name="CUST_TP"  data-max-height="300" checkbtn="CUST_TP">
										<option value="">请选择</option>
										<option value="01">个人</option>
										<option value="02">集体</option>
										<option value="03">金融客户</option>
										<option value="04">客户群</option>
									</select>
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-3">
									<select data-role="multiselect" id="SIGN_STAT" name="SIGN_STAT"  data-max-height="300" checkbtn="SIGN_STAT">
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="BANK" name="BANK" check-empty="true" maxlength="20">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="TEL_NO" name="TEL_NO" check-empty="true" maxlength="20">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="BANK_NAME" name="BANK_NAME" check-empty="true" maxlength="60">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="WCHAT_NO" name="WCHAT_NO" check-empty="true" maxlength="30">
								</div>
							</div>
						</div>
					</div>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-12 column" style="margin-left: 4.4%">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" 
									id="COMM_ADDR" name="COMM_ADDR" check-empty="true" maxlength="120">
								</div>
							</div>
						</div>
					</div>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="POST_ECD" name="POST_ECD" check-empty="true" maxlength="6">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="EMAIL_ADDR" name="EMAIL_ADDR" check-empty="true" check-mail="true" maxlength="120">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="CERT_NO" name="CERT_NO" check-empty="true" maxlength="60">
								</div>
							</div>
						</div>
					</div>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<select data-role="multiselect" id="SIGN_STAT1"  name="SIGN_STAT1"  data-max-height="300" checkbtn="">
										<option value="0">已签约</option>
										<option value="1" disabled="disabled">已解约</option>
										<option value="2" disabled="disabled">暂停</option>
									</select>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="input-group-sm  col-sm-4">
									...
									check-time-empty="true">
									<input type="hidden" name="ENTR_NAME" id="ENTR_NAME">
								</div>
							</div>
							<!-- <div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									子业务编号 </label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="SUB_BUSI_NO" class="" name="SUB_BUSI_NO"  data-max-height="300" checkbtn="true">
										<option value="">请选择</option>
									</select>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="BANK_CUST_NO" name="BANK_CUST_NO" check-empty="" maxlength="64">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
								...
								<div class="col-sm-4">
									...
									check-time-empty="true" check-startTime-one=""
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									银行签约标志 </label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="BANK_SIGN_FLG" class="" name="BANK_SIGN_FLG"  data-max-height="300" checkbtn="">
										<option value="0">已签约</option>
										<option value="2">无需签约</option>
										<option value="1" disabled="disabled">已解约</option>
									</select>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
									第三方签约标志 </label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="OTH_SIGN_FLG" class="" name="OTH_SIGN_FLG"  data-max-height="300" checkbtn="">
										<option value="0">已签约</option>
										<option value="2">无需签约</option>
										<option value="1" disabled="disabled">已解约</option>
									</select>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="OPP_ACCT" name="OPP_ACCT" check-empty="" maxlength="64">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="OPP_ACCT_NAME" name="OPP_ACCT_NAME" check-empty="" maxlength="180">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="OPP_BANK" name="OPP_BANK" check-empty="" maxlength="64">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="OPP_BANK_NAME" name="OPP_BANK_NAME" check-empty="" maxlength="180">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 column" id="isChkS">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="SGL_LIM" name="SGL_LIM" check-empty="true" check-money="true" decimal-num="16,2">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="DAY_NUM" name="DAY_NUM" check-empty="true" check-integer-pos-neg="true" maxlength="8">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="DAY_LIM" name="DAY_LIM" check-empty="true" check-money="true" decimal-num="16,2">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="MONTH_NUM" name="MONTH_NUM" check-empty="true" check-integer-pos-neg="true" maxlength="8">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="MONTH_LIM" name="MONTH_LIM" check-empty="true" check-money="true" decimal-num="16,2">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="SIGN_PROT_NO" name="SIGN_PROT_NO" check-empty="" maxlength="60">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="OTH_SIGN_PROT_NO" name="OTH_SIGN_PROT_NO" check-empty="" maxlength="60">
								</div>
							</div>
								<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="OTH_CUST_NO" name="OTH_CUST_NO" check-empty="true" maxlength="64">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" 
									id="OTH_ENTR_NO" name="OTH_ENTR_NO" check-empty="" maxlength="14">
								</div>
							</div>
						</div>
					</div>
							
					<div ravo="rainbow_fx_layout" class="row clearfix" id="ctrlMsg">
