...
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/tec/paraEntrQry.js" charset="utf-8"></script>
		...
		<div ravo="rainbow_fx_layout" class="row clearfix">
			<div class="col-md-12 column">
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							<div class="col-md-12 column">
								...
								<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_460824" style="margin-top: 10px">
								 <div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-6 column">
										...
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-5 control-label">开通状态
											</label>
											<div class="col-sm-4">
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="input-group-sm  col-sm-4">
												...
												id="ENTR_NO" name="ENTR_NO" search_url="/comp/sign/pub/entrData">
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
											<label class=" control-label col-sm-3 control-label">
											...
											<div class="input-group-sm  col-sm-4">
												...
												id="CERT_NO" name="CERT_NO" check-empty="CERT_NO">
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
						...
						<table id="table" data-toggle="table" data-first-load="false"
							data-url="${ctx}/comp/sign/tec/signParaEntr/qry"
					...
					<div class="tab-pane" id="panel2"></div>
				</div>
			</div>
		</div>
	</div>
