...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/test/signFuncCustList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					...
					<li class="active">
						<a href="#panel1" data-toggle="tab" class="" aria-expanded="false" id="tab1"
						name="tab1">
							统一签约
						</a>
					</li>
					<li class="">
						<a href="#panel2" data-toggle="tab" aria-expanded="true" class="" id="tab2"
						name="tab2">
							客户签约新增
						</a>
					</li>
				...
				<div class="tab-content">
					<div class="tab-pane in active" id="panel1">
						...
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_350660">
							<div id="top1" ravo="rainbow_fx_layout" class="row clearfix" style="margin: 20px;">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											...
											name="ACCT" check-empty="true">
										</div>
									</div>
								</div> 
								<div class="col-md-1 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button" class="btn btn-info pull-left"
										contenteditable="false" id="qryBtn" name="qryBtn">
											查询
										</button>
									</shiro:haspermission>
								</div>
								<div class="col-md-3 column">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button" class="btn btn-default pull-left"
										contenteditable="false" id="addBtn" name="addBtn">
											新增
										</button>
									</shiro:haspermission>
								</div>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-sm-12">
									<table id="table" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/sign/test/signFuncCust/qry"
									data-click-to-select="false" data-show-export="false" data-show-refresh="false"
									...
									ravo="rainbow_fx_bj" class="table table-hover" data-checkbox-header="false"
									data-sortable="false" data-side-pagination="server" data-striped="true">
										<thead style="">
											<tr>
												<th data-field="SIGN_PROT_TP_ID">
													签约协议类型
												</th>
												<th data-field="SIGN_PROT_NO">
													签约协议号
												</th>
												<th data-field="OTH_CUST_NO">
													第三方客户号
												</th>
												<th data-field="ACCT_NAME">
													账户名称
												</th>
												<th data-field="ACCT">
													账/卡号
												</th>
												<th data-field="PHONE_NO">
													联系电话
												</th>
