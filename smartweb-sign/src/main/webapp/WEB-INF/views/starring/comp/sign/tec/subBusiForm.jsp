...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/tec/subBusiForm.js" charset="utf-8"></script>
						...
						<div class="col-md-12 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-2">
									<input input_type="treesearch"
										search_url="/comp/prod/oper/entrManage/busiData" id="BUSI_NO"
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										...
										check-empty="true" maxlength="14" check-NAL="true">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="SUB_BUSI_NAME" name="SUB_BUSI_NAME"
										check-empty="true" maxlength="40">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									管理机构 </label>
								<div class="col-sm-2">
									<sys:treeselect id="MNG_BRCH" name="MNG_BRCH"
										value="" label_name="MNG_BRCH.name"
										label_value="" title="管理机构"
										url="/sys/office/treeData?type=2" css_class="form-control" />
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									业务机构 </label>
								<div class="col-sm-2">
									<sys:treeselect id="BUSI_BRCH" name="BUSI_BRCH"
										value="" label_name="BUSI_BRCH.name"
										label_value="" title="业务机构"
										url="/sys/office/treeData?type=2" css_class="form-control" />
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									清算机构 </label>
								<div class="col-sm-2">
									<sys:treeselect id="CLR_BRCH" name="CLR_BRCH"
										value="" label_name="CLR_BRCH.name"
										label_value="" title="清算机构"
										url="/sys/office/treeData?type=2" css_class="form-control" />
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									是否可被签约 </label>
								<div class="col-sm-3">
									<select data-role="multiselect" id="SIGN_FLG" name="SIGN_FLG"
										class="" checkbtn="SIGN_FLG">
