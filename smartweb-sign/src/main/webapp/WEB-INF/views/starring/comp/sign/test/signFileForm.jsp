...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/sign/test/signFileForm.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						<li class="active"><a href="#panel1" data-toggle="tab"
							id="tab1" name="tab1"> 批量签解约提交</a></li>
					</ul>
											...
											<div class="col-md-6 column">
												...
												<div ravo="rainbow_fx" class="form-group">
													<label for="inputEmail3"
														...
														style="visibility: visible">操作类型 </label>
													<div class="col-sm-3">
														<select data-role="multiselect" id="OPER_TP" class=""
															name="SIGN_STAT" data-max-height="300" checkbtn="OPER_TP">
															<option value="01">客户签约</option>
															<option value="02">客户解约</option>
														</select>
													</div>
												</div>
												<div ravo="rainbow_fx" class="form-group">
												...
												<div ravo="rainbow_fx_layout" class="row clearfix">
													<div class="col-md-6 column">
														...
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-5">
																<input type="text" class="form-control" placeholder=""
																	id="BAT_NO" name="BAT_NO" readonly="readonly">
															</div>
														</div>
