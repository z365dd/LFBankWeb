...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/test/signFuncPreForm.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab1">
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="signFuncPreForm"
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4  btn-group">
											...
											data-bv-="true" data-max-height="300">
											</select>
										</div>
									</div>
								</div>
									...
									<div ravo="rainbow_fx_layout" class="row clearfix">
										<div class="col-md-6 column">
											...
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-4">
													...
													data-url="${ctx}/sys/dict/selectData?type=SIGN_CERT_TP" blank-item="true"
													data-max-height="300">
													</select>
												</div>
											</div>
										...
										<div class="col-md-6 column">
											...
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" placeholder="" check-NAL="true" id="CERT_NO" name="CERT_NO" maxlength="60">
												</div>
											</div>
										</div>
									</div>
									<div ravo="rainbow_fx_layout" class="row clearfix">
										<div class="col-md-6 column">
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" placeholder="" id="PHONE_NO" name="PHONE_NO" check-telephone="true">
												</div>
											</div>
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-5 control-label control-label">
										...
										<div class="col-md-6 column">
											...
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="input-group-sm  col-sm-4">
													...
													<input type="text" readonly="readonly" class="form-control input-mini Wdate"
													check-starttime-own="true" value="" datetime-skin="twoer" datetime-date-fmt="yyyy-MM-dd"
													datetime-min-date="" datetime-max-date="" datetime-is-show-clear="true"
													datetime-is-show-week="true" datetime-is-show-today="true" datetime-default-value=""
													datetime-value-fmt="yyyy-MM-dd" data-link-field="val_PROT_END_DATE" id="PROT_END_DATE"
													onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('PROT_END_DATE');}});"
									...
									<div ravo="rainbow_fx_layout" class="row clearfix">
										<div class="col-md-6 column">
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-4  btn-group">
													<select data-role="multiselect" id="CHNL_NO2" class="" name="CHNL_NO2"
													blank-item="true" data-async="true" data-max-height="300" data-url="${ctx}/comp/sign/test/signFuncCust/getChnlNo">
													</select>
												</div>
											</div>
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" placeholder="" id="LIM_NUM" name="LIM_NUM" maxlength="19"  check-integer="true">
												</div>
											</div>
										</div>
										<div class="col-md-6 column">
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-4  btn-group">
													<select data-role="multiselect" id="LIM_FLG" class="" name="LIM_FLG" data-max-height="300">
														<option value="">
															请选择
														</option>
														<option value="00">
											...
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" placeholder="" id="LIM_AMT" name="LIM_AMT" checkNumLen="16,2">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-12 column">
											<div ravo="rainbow_fx_layout" class="row clearfix">
												...
												<div class="col-sm-7">
													...
													data-undefined-text="**" data-height="300" data-content-type="application/x-www-form-urlencoded"
