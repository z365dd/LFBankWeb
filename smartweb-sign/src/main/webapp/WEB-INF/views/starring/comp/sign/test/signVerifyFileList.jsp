...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/sign/test/signVerifyFileList.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						<li class="active"><a href="#panel1" data-toggle="tab"
							id="tab1" name="tab1"> 批量校验结果查询 </a></li>
					</ul>
														...
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-5">
																<input type="text" class="form-control" placeholder=""
																	id="ORIG_REQ_SEQ" name="ORIG_REQ_SEQ" check-empty="true">
															</div>
														</div>
													</div>
													<div class="col-md-6 column">
												...
												<div ravo="rainbow_fx_layout" class="row clearfix">
													<div class="col-md-6 column">
														<div ravo="rainbow_fx" class="form-group">
															<label for="inputEmail3"
																...
																style="visibility: visible">批次处理状态 </label>
															<div class="col-sm-3">
																<select data-role="multiselect" id="BAT_STAT" class="" name="BAT_STAT" data-async="true"
																data-url="${ctx}/sys/dict/selectData?type=FSIGN_BAT_STAT" blank-item="true" data-max-height="300">
																</select>
															</div>
														</div>
														<div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-5">
																<input type="text" class="form-control" placeholder=""
																	id="FILE_SET_SEQ" name="FILE_SET_SEQ" readonly="readonly">
															</div>
															<div class='col-sm-2'>
																<a href="#" id="downLoadBtnFile" target="_self" download>
																	<shiro:haspermission name="anno">
																		<button ravo="rainbow_fx" type="button"
																			class="btn btn-default" contenteditable="false"
																			id="loadBtn" name="loadBtn" style="float: right">下载</button>
																	</shiro:haspermission>
																</a>
															</div>
														</div>
													...
													<div class="col-md-6 column">
														<!-- <div ravo="rainbow_fx" class="form-group">
															...
															<div class="col-sm-4">
																<input type="text" class="form-control" placeholder=""
																	id="RET_MSG" name="RET_MSG" readonly="readonly">
															</div>
														</div> -->
													</div>
												</div>
