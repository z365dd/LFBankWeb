...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/tseq/oper/tTseqSeqCrtList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												...
												data-max-height="300" blank-item="true" blank-text="--请选择--">
												</select>
											</div>
										</div>
									</div>
					...
					data-toggle="table" data-url="${ctx}/comp/tseq/oper/tTseqSeqCrt/list" ravo="rainbow_fx_bj"
					...
					data-single-select="true" data-query-params="queryParams" data-first-load="true">
						<thead>
							<tr>
								...
								<th data-field="outSysStr" data-title="外部系统号">
									外部系统号
								</th>
