...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/tseq/oper/tTseqSeqResetForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tTseqSeqResetForm" style="margin-top:10px;">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								...
								name="seqCrtName" readonly="readonly" maxlength="30">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								...
								data-max-height="300" data-async="true" blank-item="true" blank-text="--请选择--"
								readonly="readonly">
								</select>
							</div>
						</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="respSeqLen" name="respSeqLen" class="form-control  digits" readonly="readonly"
								maxlength="18" check-empty="true">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="seqLen" name="seqLen" class="form-control  digits" maxlength="18"
								check-empty="true" readonly="readonly">
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="maxVal" name="maxVal" class="form-control " maxlength="256"
								check-empty="true" readonly="readonly">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="minVal" name="minVal" class="form-control " maxlength="256"
								check-empty="true" readonly="readonly">
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="efftFlg" name="efftFlg" data-role="multiselect">
									<option value="">
										--请选择--
									</option>
									<option value="Y">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="starExpr" name="starExpr" class="form-control " maxlength="512"
								data-toggle="popover" data-container="body" data-placement="right" data-content="支持样式：YYYY-当前年份  YY-当前年份后2位  MM-当前月份  DD-当前日期  hh-当前小时（24小时制） mm-当前分钟  ss-当前秒数  SSS-当前毫秒  SEQ-流水号"
								title="表达式" data-trigger="focus" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="resetCyc" name="resetCyc" class="form-control " maxlength="19" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<div class="radio radio-inline">
									<label style="visibility: visible">
										<input id="digitFlg0" type="radio" value="Y" name="digitFlg" class="" disabled>
										是
									</label>
								</div>
								<div class="radio radio-inline">
									<label style="visibility: visible">
										<input id="digitFlg1" type="radio" value="N" name="digitFlg" class="" disabled>
										否
									</label>
								</div>
							</div>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label control-label">
								当前流水号最大值 <font color="red">*</font>
							</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" readonly="readonly" id="maxSeqNum" 
								name="maxSeqNum" check-integer="true" >
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-5 control-label control-label">
								手工重置值 <font color="red">*</font>
							</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" check-empty="true" id="resetVal" name="resetVal" check-integer="true"
									maxlength="19">
							</div>
						</div>
					</div>
