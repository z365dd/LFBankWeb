...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/tseq/oper/tTseqSeqResetManage.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						...
						title="流水号生成器列表" aria-expanded="true" url="${ctx}/comp/tseq/oper/tTseqSeqReset/tTseqSeqResetList">
							手工重置流水号查询
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/tseq/oper/tTseqSeqReset/tTseqSeqResetForm">
							手工重置流水号
						</a>
					</li>
				</ul>
