...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/tseq/oper/tTseqSeqCrtManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tTseqSeqCrtList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="流水号生成器查询" aria-expanded="true" url="${ctx}/comp/tseq/oper/tTseqSeqCrt/tTseqSeqCrtList">
							流水号生成器查询
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/tseq/oper/tTseqSeqCrt/tTseqSeqCrtAdd">
							流水号生成器新增
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/tseq/oper/tTseqSeqCrt/tTseqSeqCrtUpdate">
							流水号生成器修改
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/tseq/oper/tTseqSeqCrt/tTseqSeqCrtDetail">
							流水号生成器详细
						</a>
					</li>
				</ul>
				<div class="tab-content">
					...
					<div id="tab_add" class="tab-pane">
						<iframe id="iframe_add" name="iframe_add" src="" style="width: 100%; height: 800px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_update" class="tab-pane">
						<iframe id="iframe_update" name="iframe_update" src="" style="width: 100%; height: 800px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_detail" class="tab-pane">
						<iframe id="iframe_detail" name="iframe_detail" src="" style="width: 100%; height: 800px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
				</div>
			</div>
		</div>
