...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/tseq/oper/tTseqSeqCrtDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tTseqSeqCrtForm" style="margin-top:10px;">
				<input type="hidden" value="" name="seqCrtId" id="HID_seqCrtId"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="outSys" name="outSys" data-role="multiselect" data-url="${ctx}/comp/tseq/oper/tTseqSeqCrt/getRelatSys"
										data-async="true" data-max-height="300" blank-item="true" blank-text="--请选择--" readonly="readonly">
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="outSubSys" name="outSubSys" class="form-control " maxlength="10" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="seqNoLen" name="seqNoLen" class="form-control  number" maxlength="19"
								check-integer="true" check-empty="true" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="efftFlg" name="efftFlg" data-role="multiselect"  readonly="readonly">
									<option value="">
										--请选择--
									</option>
									<option value="Y">
