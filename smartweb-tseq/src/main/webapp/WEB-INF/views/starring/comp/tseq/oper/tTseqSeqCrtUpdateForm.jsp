...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/tseq/oper/tTseqSeqCrtUpdateForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tTseqSeqCrtForm" style="margin-top:10px;">
				<input type="hidden" value="" name="outSys" id="HID_outSys"/>
				<div ravo="rainbow_fx_layout" class="row clearfix">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="outSys" name="outSys" data-role="multiselect" data-url="${ctx}/comp/tseq/oper/tTseqSeqCrt/getRelatSys" data-max-height="300"
								data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly">
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								...
								check-alphanumericSymbols="true" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="seqLen" name="seqLen" class="form-control  digits" maxlength="19"
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								...
								data-toggle="popover" data-container="body" data-placement="right" data-content="YYYY-当前年份  YY-当前年份后2位  MM-当前月份  DD-当前日期  hh-当前小时（24小时制） mm-当前分钟  ss-当前秒数  SSS-当前毫秒  SEQ-流水号"
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="resetCyc" name="resetCyc" class="form-control number" maxlength="19" check-empty="true"
								 data-toggle="popover" data-container="body" data-placement="right" data-content="以天为单位,值为0时，不重置"
