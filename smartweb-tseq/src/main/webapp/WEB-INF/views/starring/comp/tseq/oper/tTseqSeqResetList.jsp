...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/tseq/oper/tTseqSeqResetList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<select data-role="multiselect" id="seqCrtId" class=""
															name="seqCrtId" data-url="${ctx}/comp/tseq/oper/tTseqSeqCrt/getSeqCrtId"
															data-max-height="300">
														</select>
											</div>
										</div>
					...
					<table class="table table-hover" id="tTseqSeqCrtTable" data-side-pagination="server"
					data-toggle="table" data-url="${ctx}/comp/tseq/oper/tTseqSeqReset/resetList" ravo="rainbow_fx_bj"
					...
					data-single-select="true" data-query-params="queryParams" data-first-load="true">
						<thead>
							...
							<th data-field="id" data-title="唯一主键ID" data-visible="false" data-switchable="false">
								...
								<th data-field="seqCrtId" data-title="流水号生成器ID">
									流水号生成器ID
								</th>
								<th data-field="seqCrtName" data-title="流水号生成器名称">
									流水号生成器名称
								</th>
								<th data-field="outSys" data-title="外部系统号" data-visible="false" data-switchable="false">
									外部系统号的值
								</th>
								<th data-field="outSys" data-title="外部系统号">
									外部系统号
								</th>
								<th data-field="outSubSys" data-title="外部子系统号">
									外部子系统号 
								</th>
									<th data-field="respSeqLen" data-title="流水号总长度">
									流水号总长度
								</th>
								<th data-field="minVal" data-title="流水最小值">
									流水最小值
								</th>
								<th data-field="maxVal" data-title="流水最大值">
									流水最大值
								</th>
								<th data-field="seqLen" data-title="步长">
									步长
								</th>
								<th data-field="maxSeqNum" data-title="最大流水号">
									最大流水号
								</th>
