...
public class AppHeadResDTO {
	/*服务处理返回流水号*/
	@JSONField(name="RES_SEQ_NO")
	private String RES_SEQ_NO;
	/*本次返回查询结果记录总数*/
	@JSONField(name="RES_REC_NUM")
	...
	/*本次返回查询结果记录总数*/
	@JSONField(name="RESP_REC_NUM")
	private long RESP_REC_NUM;
	/*符合查询条件的记录总数*/
	/*private long TOT_NUM;*/
	/*是否结束(记录状态)*/
	@JSONField(name="END_FLG")
	 ...
	 * @param eND_STAT
	 */
	public AppHeadResDTO(String rES_SEQ_NO, String rES_REC_NUM, String tOT_NUM, String eND_STAT) {
		super();
