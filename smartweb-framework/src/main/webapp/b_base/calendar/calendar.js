(function () {
    ...
    DateTable.prototype.leftHead = function () {
        ...
        this.html += "<div id=\"YL\" class=\"btnCalendar\"><</div>";
        this.html += "<select id=\"SY\">"
        for (var i = 1900; i < 2101; i++) this.html += "<option value=\"" + i + "\">" + i + "</option>";
        this.html += "</select>";
        this.html += "<div id=\"YR\" class=\"btnCalendar\">></div><div class=\"text\">年</div>";
        this.html += "<div id=\"ML\" class=\"btnCalendar\"><</div>";
        this.html += "<select id=\"SM\">"
        for (var i = 1; i < 13; i++) this.html += "<option value=\"" + i + "\">" + i + "</option>";
        this.html += "</select>"
        this.html += "<div id=\"MR\" class=\"btnCalendar\">></div><div class=\"text\">月</div>";
    ...
    function getPushClick(Y, M) {
        ...
        $(".saveChange").click(function () {
			...
			if(undefined!=saveConfig){
				saveConfig(Y, M, configDayM);                
            }
        });
    }
    ...
    function btnClick(options, e, count) {
        ...
        if (isclick) {
            $(".days").contextmenu(function (e) {
                ...
                html += "<div class=\"menu-item\" id=\"menu-vacation\"><div class=\"menu-ico\"><div class=\"icoText\" style=\"background-color: #e15e5e\">班</div></div><div class=\"menu-text\">上班</div></div>";
    ...
    function setLayer(options, count) {
        ...
        /*20191024 mod by chenyl for 左右区域宽度调整*/
        ...
        $(".leftArea").css("width", parseInt(width * rate) + "px").css("height", height - 10 + "px");
        $(".rightArea").css("width", parseInt(width * (1 - rate) - 4) + "px").css("height", height - 4 + "px");
        $(".head").css("width", parseInt(width * rate) + "px").css("height", parseInt((height - 16) / 7 * 0.6 - 8 + count / 2) + "px")
            .css("line-height", parseInt((height - 16) / (count + 1) * 0.6 - 8) + "px");
//        $(".week").css("width", parseInt((width * rate - 16) / 7) + "px").css("height", parseInt((height - 16) / (count + 1) * 0.4) + "px");
        $(".week").css("width", parseInt((width * rate - 16) / 7 - 2) + "px").css("height", parseInt((height - 16) / (count + 1) * 0.4) + "px");
