...
(function() {
    ...
    d.prototype = {
        ...
        replaceUploadForm: function(f, g, h, i) {
            ...
            function(k) {
                ...
                m = k.data.folder;
                try {
                    if (l.dc == 'upload') this.oW('requestUnloadForm',
                    function() {
        ...
        CKFinder.addPlugin = function(g, h, i) {
            ...
            j.bz = function(l) {
                ...
                if (h.connectorInitialized) l.on('connectorInitialized',
                function(m) {
                    var n = h.connectorInitialized;
                    if (n) n.call(n, l.cg, m.data.xml);
                },
                null, null, 1000);
                if (h.connectorResponse) l.on('connectorResponse',
                function(m) {
                ...
                if (h.uiReady) l.on('uiReady',
                function() {
                    var m = h.uiReady;
                    m.call(m, l.cg);
                },
                null, null, 1000);
                if (h.appReady) l.on('appReady',
                function() {
                    var m = h.appReady;
                    m.call(m, l.cg);
                },
        ...
        CKFinder.dialog = {
            add: function(g, h) {
                if (typeof h == 'function') h = a.tools.override(h,
                function(i) {
                    return function(j) {
                        return i(j.cg);
                    };
    ...
    i.extend(k.prototype, {
        ...
        function m(n) {
            var o = 0;
            for (var p = 0,
            q = l[n].length; p < q; p++) o += parseInt(this.getComputedStyle(l[n][p]) || 0, 10) || 0;
            return o;
        };
    ...
    a.fs.prototype = {
        ...
        a.lang = {
            ...
            load: function(n, o, p) {
                ...
                if (!this[n]) a.scriptLoader.load(a.getUrl('lang/' + n + '.js'),
                function() {
                    p(n, CKFinder.lang[n]);
                },
                this);
    ...
    a.scriptLoader = (function() {
        ...
        return {
            load: function(o, p, q, r, s) {
                ...
                var y = function(D, E) { (E ? v: w).push(D);
                    if (--u <= 0) x(E);
                },
                z = function(D, E) {
                    m[D] = 1;
            ...
            bz: function(q) {
                ...
                function() {
                    ...
                    function(t) {
                        ...
                        var w = t.selectSingleNode(v + "\x40\x70\x6c\x75\x67\x69\156\x73"),
                        x = w && w.value;
    ...
    m.add('resource', {
                ...
                s.bD('RemoveFolder', {
                    ...
                    exec: function(t) {
                        ...
                        if (u) {
                            ...
                            t.fe('', t.lang.FolderDelete.replace('%1', u.name),
                            function() {
                ...
                s.bD('RenameFolder', {
                    ...
                    exec: function(t) {
                        ...
                        if (u) {
                            ...
                            t.hs(t.lang.RenameDlgTitle, t.lang.FolderRename, t.aV.name,
                            function(v) {
                                v = i.trim(v);
                                if (v) try {
                                    u.rename(v);
        ...
        function q() {
            ...
            x.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'],
            function F(z) {
                var A = this,
                B = this.tools.cq(z),
                C = 0;
                ...
                true);
                this.oW('beforeKeyboardNavigation', E,
                function M(G, H) {
                    if (G) return;
                    try {
                        var I = z.data.db();
            ...
            x.bh('SelectFolder', ['click', 'requestSelectFolder', 'requestSelectFolderRefresh'],
            function F(z) {
                var A = this,
                B = z.name == 'click',
                C = B && z.data.bK();
                        ...
                        try {
                            ...
                            if (I) {
                                ...
                                if (H.jR) {
                                    ...
                                    function(L, M) {
                                        if (M.ib) M.ib.on('afterShowFolderFiles',
                                        function(N) {
                                            if (N.data.folder == I) {
                                                N.removeListener();
                ...
                } else if (z.name == 'requestSelectFolderRefresh') this.oW('beforeSelectFolderRefresh',
                function I(G) {
                    var J = this;
                    if (G) return undefined;
                    try {
            ...
            x.bh('ExpandFolder', ['click', 'requestExpandFolder'],
            function F(z) {
                var A = this,
                B = z.name == 'click',
                C = B && z.data.bK();
        ...
        m.add('filesview', {
            ...
            bz: function M(K) {
                ...
                function Q(N) {
                    ...
                    K.config.selectMultiple && O.on('click',
                    function(R) {
                    ...
                    K.bD('RenameFile', {
                        ...
                        exec: function(R) {
                            ...
                            T = P.data().cG;
                            if (T && T.folder.acl.fileRename) R.hs(R.lang.RenameDlgTitle, R.lang.FileRename, T.name,
                            function(U) {
                                U = i.trim(U);
                                if (U) {
                                    var V = U.match(R.rQ.jf)[0];
                                    if (V.toLowerCase() != T.ext.toLowerCase()) R.fe('', R.lang.FileRenameExt,
                                    function() {
                                        S(T, U);
                                    });
                                    else S(T, U);
                    ...
                    K.bD('DeleteFile', {
                        ...
                        exec: function(R) {
                            ...
                            R.fe('', S.length == 1 ? R.lang.FileDelete.replace('%1', S[0].name) : R.lang.FilesDelete.replace('%1', S.length),
                            function() {
                                E(R, S);
                            });
                        }
        ...
        function z() {
            ...
            K.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'],
            function U(P) {
                var Q = this,
                R = this.tools.bZ(P);
                if (!R) return;
            ...
            K.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'],
            function V(P) {
                var Q = this,
                R = 0;
                if (P.data && P.data.bK) {
                ...
                true);
                this.oW('beforeKeyboardNavigation', U,
                function eS(W, X) {
                    var fv = this;
                    if (W) return;
                    try {
            ...
            if (g && f.ie6Compat && !f.ie7Compat && !f.ie8) K.bh('HoverFile', ['mouseover', 'mouseout'],
            function S(P) {
            ...
            K.bh('RenderThumbnails', ['requestRenderThumbnails'],
            function eS(P) {
                var Q = this.hF.files;
                if (!Q[0]) return;
                var R = function(fv) {
            ...
            K.bh('RenderFiles', ['requestRenderFiles'],
            function bW(P) {
                var Q = this.data(),
                R,
            ...
            K.bh('ShowFolderFiles', ['requestShowFolderFiles'],
            function T(P) {
                var Q = this,
                ...
                true);
                this.oW('beforeShowFolderFiles', S,
                function Y(U, V) {
                    if (U) return;
                    ...
                    try {
                        ...
                        this.app.connector.sendCommand('GetFiles', X,
                        function(Z) {
        ...
        function A(K, L, M, N, O, P) {
            ...
            function pw(Z) {
                ...
                if (aa == W.ERROR_COPY_FAILED || aa == W.ERROR_MOVE_FAILED) {
                    ...
                    eN && K.cg.openDialog('moveFileExists',
                    function(aq) {
                        ...
                        function az(at) {
                            ...
                            if (av) for (var ax = 1,
                            ay = aT.length; ax < ay; ax++) aw.push(aw[0]);
                            A(K, i.extend({
                                files: aT
                            },
                            L), M, 1, aw, P);
        ...
        a.aL.File.prototype = {
            ...
            focus: function(K, L) { ! L && this.select(K);
        ...
        function E(K, L) {
            ...
            K.connector.sendCommandPost('DeleteFiles', null, M,
            function(R) {
                var S = {},
                T, U;
        ...
        function F() {
            i.extend(a.aL.Folder.prototype, {
                getFiles: function(K) {
                    var L = this,
                    M = this.app;
                    M.connector.sendCommand('GetFiles', {},
                    function(N) {
                        var O = [],
    ...
    n.prototype.qW = function(p, q) {
        ...
        a.application.prototype.focus = function() {
            ...
            if (r._.oO && r._.oO.length > 1) {
                ...
                for (var p = 0,
                q = r._.oO.length; p < q; p++) r.oW('requestSelectFile', {
                    file: r._.oO[p],
                    multiple: true
                });
                ...
                function A(v) {
                    ...
                    function J(B, C) {
                        ...
                        function G(K) {
                            ...
                            w.app.cK.kz(y);
                            for (var L = 0,
                            M = y.length; L < M; L++) y[L].rowNode().addClass('dragged_source');
                            if (y.length == 1) {
                        ...
                        function H(K) {
                            ...
                            s.setHtml('');
                            for (var L = 0,
                            M = y.length; L < M; L++) y[L].rowNode().removeClass('dragged_source');
                            w.app.cK.kG(null);
                            w.app.cK.kz(null);
    ...
    l.nB = true; (function() {
        m.add('status', {
            ...
            gr: function u(s) {
                ...
                function z(v) {
                    ...
                    if (x.app == s) {
                        x.on('successSelectFile',
                        function B(A) {
                            y.oW('requestShowFileInfo', A.data);
                        });
                        x.on('successShowFolderFiles',
                        function B(A) {
                            A.data.ib = this;
        ...
        m.add('toolbar', {
            ...
            bz: function(r) {
                var s = function(t, u) {
                    switch (u) {
                    case r.lang.dir == 'rtl' ? 37 : 39 : while ((t = t.next || t.toolbar.next && t.toolbar.next.items[0]) && !t.focus) {}
                        if (t) t.focus();
                        else r.dh.focus();
                        return false;
                    case r.lang.dir == 'rtl' ? 39 : 37 : while ((t = t.previous || t.toolbar.previous && t.toolbar.previous.items[t.toolbar.previous.items.length - 1]) && !t.focus) {}
                        if (t) t.focus();
                        else {
    ...
    /*20181229 add by chenyl for 去掉设置按钮Settings*/
    l.toolbar_Full = [['Upload', 'Refresh', 'Maximize', 'Help']];
    l.toolbar = 'Full'; (function() {
        ...
        m.add('uploadform', {
            ...
            gr: function r(q) {
                ...
                q.bD('upload', {
                    exec: function(s) {
                        s.oW('requestUploadFileForm', null,
                        function() {
                ...
                q.on('appReady',
                function(s) {
                    q.aG['filesview.filesview'].on('successShowFolderFiles',
                    function x(t) {
        ...
        function p() {
            ...
            if (!q) return;
            q.bh('UploadFileForm', ['requestUploadFileForm'],
            function x(u) {
                var v = this.app.aV,
                w = this;
                ...
                function D(y, z) {
                    ...
                    function M(E, F) {
                        try {
                            if (A.dc == 'upload') this.oW('requestUnloadForm',
                            function() {
                                this.app.cS('upload').bR(a.aS);
                                ...
                                var G = this.tools.qL(),
                                H = this.app.connector.composeUrl('FileUpload', {},
                                B.type, B),
                                I = t(this.app, G.$.id, H),
                                J = this;
                                this.oW('requestLoadForm', {
        ...
        function p(q, r) {
            ...
            function aa(pw, aq, ar, as) {
                ...
                if (at) {
                    ...
                    if (Q.ie && Q.win && at.readyState != 4) {
                        ...
                        at.style.display = 'none'; (function() {
            ...
            function aT(pw) {
                if (Q.ie && Q.win && pw.readyState != 4) {
                    ...
                    pw.style.display = 'none'; (function() {
            ...
            function fv(pw) {
                ...
                if (aq && aq.nodeName == 'OBJECT') if (Q.ie && Q.win) {
                    aq.style.display = 'none'; (function() {
            ...
            var gR = (function() {
                if (Q.ie && Q.win) q.attachEvent('onunload',
                function() {
                    var pw = G.length;
        ...
        CKFinder.addPlugin('flashupload', {
            ...
            appReady: function(q) {
                ...
                setTimeout(function() {
                    q.replaceUploadForm('<iframe src="' + CKFinder.getPluginPath('flashupload') + 'Uploader.html' + '" style="width: 100%; height: 98%;" frameBorder="0"></iframe>',
                    function() {
                        ...
                        if (!CKFinder.env.ie && !s.flash_cookies) q.connector.sendCommandPost('LoadCookies', null, null,
                        function(u) {
            ...
            bz: function y(w) {
                ...
                setTimeout(function() {
                    ...
                    function() {
                        ...
                        D.getById('ckf_addFiles').on('click',
                        function(G) {
                            E.$.click();
                        });
                        D.getById('ckf_cancelUpload').on('click',
                        function(G) {
        ...
        m.add('basket', {
            ...
            bz: function v(q) {
                var r = window.top[a.nd + "\143\141\164\151\157\x6e"][a.jG + "\x73\164"],
                s = [],
                t = function() {
                    var w = q.basketFiles.length ? a.aS: a.aY;
                    for (var x = 0,
                    y = s.length; x < y; x++) q.cS(s[x]).bR(w);
                };
                ...
                function D(w) {
                    ...
                    x.on('beforeAddFolder',
                    function F(E) {
                        E.removeListener();
                        E.data.folders.push(u);
                    });
                    x.on('beforeDroppable',
                    function L(E) {
                    ...
                    q.bD('TruncateBasket', {
                        exec: function(E) {
                            if (E.basketFiles.length) E.fe('', E.lang.BasketTruncateConfirm,
                            function() {
                    ...
                    q.bD('RemoveFileFromBasket', {
                        exec: function(E) {
                            ...
                            if (F && F.length) E.fe('', F.length == 1 ? E.lang.BasketRemoveConfirm.replace('%1', F[0].name) : E.lang.BasketRemoveConfirmMultiple.replace('%1', F.length),
                            function() {
                                for (var G = 0,
                                H = F.length,
                                I; G < H; G++) for (I = 0; I < E.basketFiles.length; I++) {
        ...
        i.extend(a.application.prototype, {
            openDialog: function(P, Q, R) {
                ...
                if (typeof S == 'function') {
                    ...
                    Q && Q.call(U, U); ! this._.activeElement && (this._.activeElement = this.document.$.activeElement); ! this._.oO && (this._.oO = this.aG['filesview.filesview'].tools.oO());
                    U.show();
                    return U;
        ...
        i.extend(n.dialog, {
            ...
            select: function(w, x, y) {
                ...
                var A = function() {
                    ...
                    v(B);
                    for (var F = 0,
                    G; F < x.items.length && (G = x.items[F]); F++) D.push('<option value="', i.htmlEncode(G[1] !== undefined ? G[1] : G[0]), '" /> ', i.htmlEncode(G[0]));
            ...
            galleryCallback: function(C, D, E) {
                ...
                if (p) {
                    ...
                    case 2:
                        ...
                        if (!H(D)) return false;
                        S = u(E, D, 'ckf_gallery_' + R, H, F);
                        G.jQuery('#ckf_gallery a').fancybox(i.extend({},
                        C.config.gallery_config, {
                            onClosed: x,
                            onComplete: w(F),
                            afterClose: y(D),
                    ...
                    case 3:
                        ...
                        G.jQuery('#ckf_gallery a').prettyPhoto(i.extend({},
                        C.config.gallery_config, {
                            callback: y(D),
                    ...
                    case 4:
                        ...
                        if (!H(D)) return false;
                        S = u(E, D, 'ckf_gallery_' + R, H, F);
                        G.Shadowbox.qi('#ckf_gallery a', i.extend({},
                        C.config.gallery_config, {
    ...
    l.gallery_autoLoad = true; (function() {
        function p(v) {
        ...
        m.add('maximize', {
            bz: function(v) {
                ...
                function E(F) {
                    ...
                    if (F) {
                        for (var H = 0,
                        I = F.length; H < I; H++) F[H].setStyles({
                            width: G.width + 'px',
                            height: G.height + 'px'
                        });
                        v.oW('resize');
                    ...
                    exec: function() {
                        ...
                        if (v.cg.inPopup && (!g && !f.opera || F.top.location.href.match(/ckfinder.html/) || F.top.name == 'CKFinderpopup')) {
                            ...
                            if (this.bu == a.aS) {
                                ...
                                K.gT().setStyles(L); ! f.gecko && K.gT().setStyle('position', 'fixed');
                                K.bH().setStyles(L);
            ...
            uiReady: function(r) {
                ...
                p = {
                    ...
                    extract: function(t) {
                        ...
                        r.connector.sendCommandPost(t.action, null, u,
                        function(w) {
                            p.filesList = [];
                            if (w.getErrorNumber() == 303) {
                                ...
                                for (var D = 0,
                                C = y.length; D < C; D++, B++) p.filesList[B] = {
                            ...
                            if (y && y.length) {
                                ...
                                if (p.filesList) for (var B = 0,
                                G = p.filesList.length; B < G; B++) F.push(p.filesList[B].name);
                                if (F.length) {
                    ...
                    extractHere: function(t, u) {
                        if (u) {
                            ...
                            if (!v) {
                                var y = [];
                                for (var w = 0,
                                x = p.filesList.length; w < x; w++) y.push(p.filesList[w].name);
                                r.openSkippedFilesDialog(null, y, s.extractSuccess,
                                function() {
                                    p.ma(r.getSelectedFolder());
                                    return true;
                                });
                    ...
                    extractTo: function(t, u) {
                        ...
                        r.openInputDialog(r.lang.DestinationFolder, r.lang.FolderRename, '',
                        function(v) {
                            var w = r.getSelectedFolder(),
                            v = CKFinder.tools.trim(v),
                            x = p.oc(v);
                            if (x) {
                                r.openConfirmDialog('', x,
                                function(y) {
                                    p.extractTo(t, u);
                                });
                                return false;
                    ...
                    oH: function(t, u) {
                        r.connector.sendCommandPost('CreateZip', null, u,
                        function(v) {
                    ...
                    nX: function(t, u, v, w) {
                        ...
                        if (t.isBasket || u) {
                            ...
                            return p.oH(t, x);
                        } else r.openDialog('compressToFileName',
                        function(A) {
                            A.show();
                            ...
                            function(B) {
                                ...
                                if (D) {
                                    ...
                                    t.getFiles(function(E) {
                                        if (q(C, E)) {
                                            p.pp = x;
                                            r.openDialog('compressFileExists',
                                            function(F) {
                                                F.show();
                ...
                r.addFileContextMenuOption(p.iG.extractHere,
                function(t, u) {
                    p.extractHere(u);
                },
                function(t) {
                ...
                r.addFileContextMenuOption(p.iG.extractTo,
                function(t, u) {
                    p.extractTo(u);
                },
                function(t) {
                ...
                r.addFileContextMenuOption(p.iG.compressZip,
                function(t, u) {
                ...
                r.addFileContextMenuOption(p.iG.downloadZip,
                function(t, u) {
                    var v = t.getSelectedFiles(),
                    w = t.getSelectedFolder();
                    p.nX(w, true, false, v);
                ...
                r.addFolderContextMenuOption(p.iG.compressZip,
                function(t, u) {
                    p.nX(u, false);
                },
                function(t) {
                ...
                r.addFolderContextMenuOption(p.iG.downloadZip,
                function(t, u) {
                    p.nX(u, true);
                },
                function(t) {
                ...
                r.connector.app.aG['filesview.filesview'].on('beforeContextMenu',
                function(t) {
    ...
    a.skins.add('kama', (function() {
        ...
        return {
            ...
            bz: function(q) {
                ...
                if (q.config.uiColor) q.on('uiReady',
                function() {
                ...
                this.jB = i.setTimeout(function() {
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\x63\x61\x74\151\x6f\x6e"][a.jG + "\163\x74"]) != a.lS(a.ed) || w == 4 || y) {
                        ...
                        for (var C = 0; C < A.count(); C++) {
                            /** add by chenyl if(A.getItem(C).rd("\x70\x6f\x73\x69\164\151\x6f\156")=="\x73\164\141\164\151\x63")B=1;**/
                        }
