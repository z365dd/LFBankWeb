...
<div>
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			 <address ravo="rainbow_fx_bj"> <strong>Twitter, Inc.</strong><br /> 795 Folsom Ave, Suite 600<br /> San Francisco, CA 94107<br /> <abbr title="Phone">P:</abbr> (123) 456-7890</address>
		</div>
	</div>
</div>
