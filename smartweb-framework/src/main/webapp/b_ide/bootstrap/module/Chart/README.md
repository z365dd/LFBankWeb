...
- Zip: [Download](/nnnick/Chart.js/archive/master.zip)

[Examples](/nnnick/Chart.js/tree/master/samples) | [Documentation](http://www.chartjs.org/docs/)

## v2.0 Beta

- Release: [2.0.0-beta](/nnnick/Chart.js/releases/tag/2.0.0-beta)
- Zip: [Download](/nnnick/Chart.js/archive/2.0.0-beta.zip)

Documentation for v2.0 is currently located [here](/nnnick/Chart.js/tree/v2.0-dev/docs).

## v2.0 Bleeding-Edge

- Branch: [v2.0-dev](/nnnick/Chart.js/tree/v2.0-dev)
- Zip: [Download](/nnnick/Chart.js/archive/v2.0-dev.zip)
...
Before submitting an issue or a pull request to the project, please take a moment to look over the [contributing guidelines](/nnnick/Chart.js/blob/master/CONTRIBUTING.md) first.
