...
Use Plugin: [bootstrap-table-filter-control](/wenzhixin/bootstrap-table/tree/master/src/extensions/filter-control) </br>
Dependence if you use the datepicker option: [bootstrap-datepicker](/eternicode/bootstrap-datepicker) v1.4.0
