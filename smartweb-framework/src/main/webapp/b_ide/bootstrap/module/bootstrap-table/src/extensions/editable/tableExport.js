 ...
 *
 * Copyright (c) 2015,2016 hhurz, /hhurz/tableExport.jquery.plugin
 * Original work Copyright (c) 2014 Giri Raj, /kayalshri/
 *
      ...
      function downloadFile(filename, header, data) {
        ...
        if (filename !== false && (ua.indexOf("MSIE ") > 0 || !!ua.match(/Trident.*rv\:11\./))) {
          if (window.navigator.msSaveOrOpenBlob)
            ...
            // Internet Explorer (<= 9) workaround by Darryl (/dawiong/tableExport.jquery.plugin)
