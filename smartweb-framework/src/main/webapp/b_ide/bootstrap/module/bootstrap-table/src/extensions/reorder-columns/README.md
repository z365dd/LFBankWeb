...
Use Plugin: [bootstrap-table-reorder-columns](/wenzhixin/bootstrap-table/tree/master/src/extensions/reorder-columns) </br>
Dependence: [dragTable](/akottr/dragtable/) v2.0.14 (must include the css file), </br>
