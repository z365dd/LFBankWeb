...
The [issue tracker](/wenzhixin/bootstrap-table/issues) is
...
* Please **do not** open issues or pull requests regarding the code in [`bootstrap-table-examples`](/wenzhixin/bootstrap-table-examples) and [`extensions plugin dependence`](/wenzhixin/bootstrap-table/tree/develop/src/extensions) (open them in their respective repositories), the dependence list:
    * Table Editable: [x-editable](/vitalets/x-editable)
    * Table Export: [tableExport.jquery.plugin](/hhurz/tableExport.jquery.plugin)
    * Table Filter: [bootstrap-table-filter](/lukaskral/bootstrap-table-filter)
    * Table flat-json: [bootstrap-table-flat-json](/djhvscf/bootstrap-table-flatJSON)
    * Table Reorder: [jquery-ui](https://code.jquery.com/ui/) and [dragTable](/akottr/dragtable/)
    * Table Resizable: [colResizable](/alvaro-prieto/colResizable)
...
For a complete look at our labels, see the [project labels page](/wenzhixin/bootstrap-table/labels).
...
0. **Validate and lint your code** &mdash; [validate your HTML](http://html5.validator.nu)
   and [lint your HTML](/twbs/bootlint) to ensure your
...
source files in [`/src/`](/wenzhixin/bootstrap-table/tree/develop/src) instead.

Similarly, when contributing to Bootstrap's documentation, you should edit the
documentation source files in
[the `/docs/` directory of the `develop` branch](/wenzhixin/bootstrap-table/tree/develop/docs).
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone /<your-username>/bootstrap-table.git
   # Navigate to the newly cloned directory
   cd bootstrap-table
   # Assign the original repo to a remote called "upstream"
   git remote add upstream /wenzhixin/bootstrap-table.git
   ```
