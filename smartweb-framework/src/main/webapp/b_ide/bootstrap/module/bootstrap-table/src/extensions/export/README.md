...
Use Plugin: [tableExport.jquery.plugin](/hhurz/tableExport.jquery.plugin)
...
* type: Object
* description: export [options](/hhurz/tableExport.jquery.plugin#options) of `tableExport.jquery.plugin`
* default: `{}`
