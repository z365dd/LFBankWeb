...
Use Plugin: [bootstrap-table-resizable](/wenzhixin/bootstrap-table/tree/master/src/extensions/resizable) </br>
Dependence: [colResizable](/alvaro-prieto/colResizable) v1.5
