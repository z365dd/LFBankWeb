...
<script type="text/javascript">try{top.$.jBox.closeTip();}catch(e){}</script>
<c:if test="${not empty content}">
	...
	<script type="text/javascript">try{if(!top.$.jBox.tip.mess){top.$.jBox.tip.mess=1;top.$.jBox.tip("${content}","${ctype}",{persistent:true,opacity:0});$("#messageBox").show();}}catch(e){}</script>
</c:if>