...
<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sys:office:edit"><li class="active"><a href="${ctx}/sys/office/seePermissionToOffice?id=${permissionOwn.id}">查看权限组</a></li></shiro:hasPermission>
		</c:if>
</ul>
