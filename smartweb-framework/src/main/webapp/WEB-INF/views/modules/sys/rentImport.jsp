...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/rent/">租户列表</a></li>
		<c:if test="${fns:getUser().manager}">
		<shiro:hasPermission name="sys:rent:edit"><li class="active"><a href="${ctx}/sys/rent/importForm">批量导入</a></li></shiro:hasPermission>
		</c:if>
	</ul>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
					<form id="importForm" action="${ctx}/sys/rent/import" method="post" enctype="multipart/form-data"
						...
						<div ravo="rainbow_fx" class="form-group">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-1">
									<a href="#" onclick="top.download('${ctx}/sys/rent/template','','')">下载服务数据模板</a>
								</div>
								<div class="col-sm-6">
...
$("#submit").click(function(){
	var options  = {
            url:ctx+"/sys/rent/import",   // 同action
            type:'post',
            dataType: "json",
