...
<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sys:office:edit"><li class="active"><a href="${ctx}/sys/office/assignPermissionToOffice?id=${permissionDTO.id}&authTp=${permissionDTO.authTp}">权限组授权</a></li></shiro:hasPermission>
		</c:if>
</ul>
<form:form id="inputForm" modelAttribute="permissionDTO" action="${ctx}/sys/office/savePermissionToOffice" method="post" class="form-horizontal">
	<form:hidden path="id"/>
	...
	<div class="form-actions">
		<c:if test="${permissionDTO.parentMenuList.size() < 1}">
			<shiro:hasPermission name="sys:office:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存" disabled="disabled"/>&nbsp;</shiro:hasPermission>
		</c:if>
