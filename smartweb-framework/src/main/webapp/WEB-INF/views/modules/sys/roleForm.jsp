...
<head>
	...
	<script type="text/javascript" charset="utf-8">
        $(document).ready(function(){
			...
			if (${isUpdate}) {
				$('#roleTp').multiselect("disable");
				/*$("#roleTp").attr("disabled", true);*/
			}
        });
	</script>
</head>
...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="${ctx}/sys/role/form">角色<shiro:hasPermission name="sys:role:edit">${not empty role.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit">查看</shiro:lacksPermission></a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div style="margin-left: 20px; display:inline-block;">
			<input id="oldEngName" name="oldEngName" type="hidden" value="${role.engName}">
