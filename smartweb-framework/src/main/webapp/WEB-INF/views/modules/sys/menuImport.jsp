...
<body>
	<ul class="nav nav-tabs">
		...
		<c:if test="${fns:getUser().manager}">
			<li class="active"><a href="${ctx}/sys/menu/importForm">批量导入</a></li>
		</c:if>
	</ul>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
					<form id="importForm" action="${ctx}/sys/menu/import" method="post" enctype="multipart/form-data"
						...
						<div ravo="rainbow_fx" class="form-group">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-2">
									<input id="" name="file" type="file" style="width:330px"/>
								</div>
								<div class="col-sm-1">
									<button type="button" class="btn btn-primary" id="submit">导入</button>
								</div>
								<div class="col-sm-1">
									<a href="#" onclick="top.download('${ctx}/sys/menu/template','','')">下载服务数据模板</a>
								</div>
								<div class="col-sm-6">
...
$("#submit").click(function(){
	var options  = {
            url:ctx+"/sys/menu/import",   // 同action
            type:'post',
            dataType: "json",
