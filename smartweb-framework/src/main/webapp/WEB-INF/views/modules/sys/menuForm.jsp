	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group" id="up_menu">
			...
			<div style="margin-left: 20px; display:inline-block;">
                <sys:treeselect id="menu" name="parent.id" value="${menu.parent.id}" label_name="parent.name" label_value="${menu.parent.name}"
			...
			<div style="margin-left: 20px; display:inline-block;">
				<div class="radio-inline">
					<label style="visibility:visible">
						<input id="dpyFlg_0" type="radio" value="0" name="dpyFlg">
						隐藏
						<div></div>
					</label>
				</div>
				<div class="radio-inline">
					<label style="visibility:visible">
						<input id="dpyFlg_1" type="radio" value="1" name="dpyFlg" checked>
						显示
						<div></div>
					</label>
				</div>
