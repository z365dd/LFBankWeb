...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				async:{enable:(type==3||type==4),url:"${ctx}/sys/user/treeData?type="+type,autoParam:["id=brchId"]},
...
<body>
	...
	<div id="search" class="form-search hide" style="padding:10px 0 0 13px;">
		...
		<input type="text" class="empty" id="key" name="key" style="width:110px;">
		<button class="jbox-button-search" id="btn" onclick="searchNode()">搜索</button>
	</div>
