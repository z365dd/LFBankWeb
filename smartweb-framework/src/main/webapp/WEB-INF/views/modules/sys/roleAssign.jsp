...
<body>
	...
	<div class="container-fluid breadcrumb">
		<div class="row-fluid span12">
			...
			<span class="span4">英文名称: <b>${role.engName}</b></span>
			<span class="span4"><p style='float:left'>角色类型: </p>
				<form:form id="roleForm" modelAttribute="role" style="margin-top:-5px">
...
<%--			<c:set var="dictvalue" value="${role.dataScp}" scope="page" />--%>
<%--			<span class="span4">数据范围: ${fns:getDictLabel(dictvalue, 'DATA_SCP', '')}</span>--%>
		</div>
	</div>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>归属部门</th><th>归属租户</th><th>登录名</th><th>姓名</th><th>电话</th><th>手机</th><shiro:hasPermission name="sys:role:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
