...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/flowApplyForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="detailForm" style="margin-top:10px;">
				<input type="hidden" value="" name="id" id="id">
				<input type="hidden" value="" name="applyUrl" id="applyUrl">
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label">
						流程标题
					</label>
					<div class="col-sm-4">
						<input id="infoTitle" name="infoTitle" class="form-control" type="text" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						data-async="false" data-url="${ctx}/sys/flow/template/selectData" data-enable-filtering="true"
						blank-item="true" blank-text="--请选择流程类型--">
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						<input id="sndUserName" name="sndUserName" class="form-control" maxlength=""
						check-empty="true" type="text" check-character="true" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class=" col-sm-3 control-label">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						data-bv-="true" data-enable-filtering="false" data-enable-full-value-filtering="true"
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="       col-sm-4">
						...
						allow_clear="true" css_class="form-control input-small" disabled="disabled"
						treesearch_required="false">
						</sys:treeselect>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="input-group-sm    col-sm-2">
						...
						value="" datetime-skin="twoer" datetime-date-fmt="yyyy年MM月dd日 HH:mm:ss"
						...
						id="strTime" onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy年MM月dd日 HH:mm:ss',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('strTime');}});"
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="input-group-sm   col-sm-2">
						...
						id="endTime" onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy年MM月dd日 HH:mm:ss',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('endTime');}});"
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" placeholder="" id="statStr" name="statStr"
						readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" placeholder="" id="processing"
						name="processing" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class=" col-sm-3 control-label" style="visibility:visible">
					...
					<div class="  col-sm-4">
						<textarea class="form-control" rows="3" id="flowDesc" name="flowDesc"
						readonly="readonly">
						</textarea>
					</div>
				</div>
			</form>
			<div ravo="rainbow_fx_layout_panel" class="panel panel-info">
				...
				<div class="panel-body" contenteditable="false">
					<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="applyForm">
						<input type="hidden" value="" name="id" id="flowId">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label control-label">
								当前步骤标题
							</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="stepTitle"
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" placeholder="" id="flowStepSer"
								name="stepSer" readonly="readonly">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">
							...
							<div class="col-sm-7 btn-group col-sm-4">
								...
								data-url="${ctx}/sys/dict/selectData?type=FLOW_APPR_FLG">
								</select>
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" placeholder="" id="succNumRate"
								name="succNumRate" readonly="readonly">
							</div>
						</div>
							...
							<div class=" col-sm-4">
								<div class="radio-inline">
									<label style="visibility:visible">
										<input id="stat_02" type="radio" value="02" name="flowStat" class=""
										checkbtn="flowStat" data-bv-="true">
										通过
										<div></div>
									</label>
								</div>
								<div class="radio-inline">
									<label style="visibility:visible">
										<input id="stat_03" type="radio" value="03" name="flowStat" class=""
										checkbtn="flowStat" data-bv-="true" data-original-title=""
										title="">
										拒绝
										<div></div>
									</label>
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="   col-sm-4">
								<textarea class="form-control" rows="3" id="appMsg" name="appMsg"
								maxlength="80">
								</textarea>
							</div>
						</div>
