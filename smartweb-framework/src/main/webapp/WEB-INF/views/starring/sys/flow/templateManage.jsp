...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/templateManage.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					...
					<li class="active">
						...
						title="流程模板列表" aria-expanded="true" url="${ctx}/sys/flow/template/templateList"
						class="">
							流程模板列表
						</a>
					</li>
					<li class="">
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/flow/template/templateAdd"
						class="">
							流程模板添加
						</a>
					</li>
					<li class="">
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/flow/template/templateUpdate"
						class="">
							流程模板更新
						</a>
					</li>
					<li class="">
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/flow/template/templateDetail"
						class="">
							流程模板详情
						</a>
					</li>
