...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/sysNoticeList.js" charset="utf-8"></script>
...
<link href="${ctxStatic}/mainframe/css_${not empty cookie.theme.value ? cookie.theme.value : 'tech'}/style.css" type="text/css" rel="stylesheet" />
<link href="${ctxStatic}/mainframe/css_${not empty cookie.theme.value ? cookie.theme.value : 'tech'}/zujian.css" type="text/css" rel="stylesheet" />
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="noteTitle" name="noteTitle" class="form-control "  maxlength="100" >
											</input>
										</div>
									</div>
								</div>
					...
					<table id="sysNoticeTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/sys/modules/sysNotice/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="noteTitle" data-title="公告标题">noteTitle</th>
								<th data-field="uptrName" data-title="发布者">uptr</th>
								<th data-field="uptTime" data-title="发布日期">upt_time</th>
