...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/logMappingAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="logStat" name="logStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=LOG_STAT" blank-item="true" blank-text="--请选择--" checkbtn="logStat" >
								</select>
							</div>
						</div>
					</div>
