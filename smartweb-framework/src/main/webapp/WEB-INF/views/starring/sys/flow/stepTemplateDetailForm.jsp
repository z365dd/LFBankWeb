...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/stepTemplateDetailForm.js" charset="utf-8"></script>
			...
			id="addForm" style="margin-top:10px;">
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-4">
						...
						type="text" check-chinesedigitalsymbols="true" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						data-url="${ctx}/sys/flow/stepTemplate/selectData?flowTmplId=${flowTmplId}" data-async="false" blank-item="true"
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						...
						name="succNum" value="" maxlength="3" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label control-label"
					...
					<div class="col-sm-2">
						...
						data-original-title="" title="" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class=" col-sm-3 control-label">
