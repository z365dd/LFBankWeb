...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/templateUpdateForm.js" charset="utf-8"></script>
			...
			id="updateForm" style="margin-top:10px;">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-4">
						...
						type="text" check-character="true" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						...
						value="" check-empty="true" maxlength="10" check-edition="true" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label control-label"
					...
					<div class="col-sm-2">
						...
						check-empty="true" maxlength="10" value="" nexttype="checkbox" data-bv-="true">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class=" col-sm-3 control-label">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						checkbtn="" data-enable-filtering="true" data-enable-full-value-filtering="true"
						data-url="${ctx}/sys/dict/selectData?type=TIME_OUT_FLOW_USER_TP" blank-item="true"
						data-async="false" data-bv-="true" blank-text="--请选择超时处理用户类型--">
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						checkbtn="" data-async="false" blank-item="true" data-url="${ctx}/sys/dict/selectData?type=SND_FLOW_USER_TP"
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="     col-sm-4">
						...
						css_class="form-control input-small" treesearch_required="false">
						</sys:treeselect>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						data-async="false" data-bv-="true" blank-item="true" blank-text="--请选择流程结束处理类--">
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
