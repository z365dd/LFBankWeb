...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/sysReqIpMsgList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-3 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="termIp" name="termIp" class="form-control "  maxlength="64" >
											</input>
										</div>
									</div>
								</div>
								<div class="col-md-3 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="usrTp" name="usrTp" class="form-control "  maxlength="64" >
											</input>
										</div>
									</div>
								</div>
								<div class="col-md-3 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="usrName" name="usrName" class="form-control "  maxlength="64" >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="sysReqIpMsgTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/sys/modules/sysReqIpMsg/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="termIp" data-title="请求IP">请求IP</th>
								<th data-field="countryName" data-title="国家名称">国家名称</th>
								<th data-field="countryCode" data-title="国家编码">国家编码</th>
								<th data-field="regionCode" data-title="省份编码">省份编码</th>
								<th data-field="regionName" data-title="省份名称">省份名称</th>
								<th data-field="city" data-title="城市名称">城市名称</th>
								<th data-field="zipCode" data-title="邮政编码">邮政编码</th>
								<th data-field="usrTp" data-title="拥有者类型">拥有者类型</th>
								<th data-field="usrName" data-title="拥有者">拥有者</th>
								<th data-field="statusStr" data-title="状态">状态</th>
