...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/flowDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="detailForm" style="margin-top:10px;">
				...
				<input type="hidden" value="" name="curUserId" id="curUserId">
				<input type="hidden" value="" name="curUserName" id="curUserName">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div id="stepDiv" class="col-md-12 column">
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
	...
	<div class="modal" id="appendModal" style="display: none;margin-left:5%;width:auto">
	<div class="modal-dialog">
		<div class="modal-content" style="width:80%">
			<div class="modal-header">
				...
				<h4 class="modal-title" contenteditable="false">
					追加备注
				</h4>
			</div>
			<div class="modal-body" style="">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal breadcrumb" pourl=""
					id="appendForm" style="margin-top:10px;">
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-12 column">
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-12 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="  col-sm-7">
											<textarea class="form-control" rows="3" id="appendRmrk" name="appendRmrk"
												check-empty="true" >
											</textarea>
										</div>
									</div>
			...
			<div class="modal-footer">
				<button type="button" id="appendSubBtn" class="btn btn-default">保存</button>
