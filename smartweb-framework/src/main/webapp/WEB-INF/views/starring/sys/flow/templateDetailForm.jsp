...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/templateDetailForm.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			...
			id="detailForm" style="margin-top:10px;">
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-4">
						<input id="name" name="name" class="form-control" maxlength="" type="text"
						check-chinesedigitalsymbols="true" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label">
					...
					<div class="col-sm-4">
						<input id="engName" name="engName" class="form-control" maxlength="" type="text"
						check-character="true" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						<select data-role="multiselect" id="flowTp" class="" name="flowTp"
						checkbtn="" data-async="false" data-url="${ctx}/sys/dict/selectData?type=FLOW_TP">
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" placeholder="" id="verNo" name="verNo"
						value="" maxlength="" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label control-label"
					...
					<div class="col-sm-2">
						...
						maxlength="" value="" nexttype="checkbox" data-bv-="true" readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class=" col-sm-3 control-label">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						blank-item="false" data-enable-filtering="false">
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						data-url="${ctx}/sys/dict/selectData?type=TIME_OUT_FLOW_USER_TP" blank-item="true" blank-text="--请选择超时处理用户类型--"
						data-async="false">
						</select>
					</div>
				</div>
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						<select data-role="multiselect" id="sndFlowUserTp" class="" name="sndFlowUserTp"
						checkbtn="sndFlowUserTp" data-async="false" blank-item="true" data-url="${ctx}/sys/dict/selectData?type=SND_FLOW_USER_TP"
						data-bv-="true" blank-text="--请选择发起用户类型--" >
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="     col-sm-4">
						<sys:treeselect id="sndUserId" name="sndUserId" value="sndUserIdValue" label_name="sndUserIdName"
						label_value="" title="用户" url="/sys/office/treeData?type=3" allow_clear="true"
						css_class="form-control input-small" disabled="disabled" treesearch_required="true">
						</sys:treeselect>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						checkbtn="" data-url="${ctx}/sys/dict/selectData?type=FLOW_PROC_CLSS_TP"
						data-async="false" blank-item="true" blank-text="--请选择流程结束处理类--">
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" placeholder="" maxlength="50" id="applyUrl" name="applyUrl"
						readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
