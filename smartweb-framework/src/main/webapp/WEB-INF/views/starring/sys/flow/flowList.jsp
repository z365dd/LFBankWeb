...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/flowList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-8  btn-group col-sm-6">
										<div class="col-sm-7">
                                            ...
                                            data-enable-filtering="true" data-url="${ctx}/sys/flow/template/selectData"
                                            data-async="true" blank-item="true" blank-text="--请选择流程模板--">
                                            </select>
										</div>
									</div>
								</div>
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" placeholder="请输入流程标题或描述信息" id="infoTitle"
										name="infoTitle" maxlength="64">
									</div>
								</div>
							</div>
							<div class="col-md-4 column">
					...
					<table class="table table-hover" id="flowTable" data-side-pagination="server"
					data-toggle="table" data-url="${ctx}/sys/flow/flow/list" ravo="rainbow_fx_bj"
					...
					data-single-select="true" data-query-params="queryParams" data-first-load="true">
						<thead>
							<tr>
								...
								<th data-field="infoTitle" class="">
									标题
								</th>
								<th data-field="flowTemplateStr" class="" data-cell-style="">
									归属模板
								</th>
								<th data-field="flowDesc" class="">
									描述信息
								</th>
								<th data-field="stepStr" class="">
									当前步骤
								</th>
								<th data-field="sndUserName" class="">
									发起用户
								</th>
								<th data-field="statStr" class="" data-title="状态" data-title-tooltip="状态">
									状态
								</th>
								<th data-field="strTime" class="" data-title="开始时间" data-title-tooltip="开始时间">
									开始时间
								</th>
								<th data-field="endTime" class="" data-title="结束时间" data-title-tooltip="结束时间">
									结束时间
								</th>
