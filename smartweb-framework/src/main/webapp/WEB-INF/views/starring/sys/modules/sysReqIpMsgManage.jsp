...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/sysReqIpMsgManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="sysReqIpMsgList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="请求IP信息表列表" aria-expanded="true" url="${ctx}/sys/modules/sysReqIpMsg/sysReqIpMsgList">
							请求IP信息表列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/sysReqIpMsg/sysReqIpMsgAdd">
							请求IP信息表添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/sysReqIpMsg/sysReqIpMsgUpdate">
							请求IP信息表更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/sysReqIpMsg/sysReqIpMsgDetail">
							请求IP信息表详情
						</a>
					</li>
				</ul>
