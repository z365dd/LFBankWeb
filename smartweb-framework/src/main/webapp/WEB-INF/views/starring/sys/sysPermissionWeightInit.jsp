...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/sysPermissionWeightInit.js" charset="utf-8"></script>
				...
				<div class="panel-body" contenteditable="false">
					...
					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-2 column">
							<label for="partBtn" class="col-sm-4 control-label">
							</label>
							<div class="col-sm-8">
								<shiro:haspermission name="anno">
									<button id="partBtn" ravo="rainbow_fx" type="button" class="btn btn-info" data-original-title="" title="">
										增量初始化
									</button>
								</shiro:haspermission>
							</div>
						...
						<div class="col-md-8 column">
							<h5>说明：初始化迁移菜单的权限，并保留分配出去的权限</h5>
						</div>
					</div>

					<div ravo="rainbow_fx_layout" class="row clearfix">
						<div class="col-md-2 column">
							<label for="allBtn" class="col-sm-4 control-label">
							</label>
							<div class="col-sm-8">
								<shiro:haspermission name="anno">
									<button id="allBtn" ravo="rainbow_fx" type="button" class="btn btn-info" data-original-title="" title="">
										完全初始化
									</button>
								</shiro:haspermission>
							</div>
						...
						<div class="col-md-8 column">
							<h5>说明：初始化所有菜单的权限，并清空分配出去的权限</h5>
						</div>
					</div>
