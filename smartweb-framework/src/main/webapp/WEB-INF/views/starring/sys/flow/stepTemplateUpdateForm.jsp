...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/stepTemplateUpdateForm.js" charset="utf-8"></script>
			...
			id="updateForm" style="margin-top:10px;">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						...
						name="succNum" value="" maxlength="3" min="1" max="100">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label control-label"
