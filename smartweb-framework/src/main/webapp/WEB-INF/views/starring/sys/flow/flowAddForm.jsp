...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/flowAddForm.js" charset="utf-8"></script>
			...
			id="addForm" style="margin-top:10px;">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						checkbtn="flowTmplId" data-async="false" data-url="${ctx}/sys/flow/flow/selectData?stat=1"
