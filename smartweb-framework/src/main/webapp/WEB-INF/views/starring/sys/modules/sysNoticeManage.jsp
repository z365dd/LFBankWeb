...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/sysNoticeManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="sysNoticeList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="公告消息列表" aria-expanded="true" url="${ctx}/sys/modules/sysNotice/sysNoticeList">
							公告消息列表
						</a>
					</li>
<c:if test="${fns:getUser().manager}">
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/sysNotice/sysNoticeAdd">
							公告消息添加
						</a>
					</li>
</c:if>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/sysNotice/sysNoticeUpdate">
							公告消息更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/sysNotice/sysNoticeDetail">
							公告消息详情
						</a>
					</li>
				</ul>
