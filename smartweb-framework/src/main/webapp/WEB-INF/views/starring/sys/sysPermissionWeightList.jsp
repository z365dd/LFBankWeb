...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/sysPermissionWeightList.js" charset="utf-8"></script>
...
<%--						</div>--%>
<%--					</form>--%>
					<table class="table table-hover" id="sysPermissionWeightTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/sys/sysPermissionWeight/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="wghtName" data-title="权限维度">权限维度</th>
								<th data-field="switchFlg" data-title="是否加入权限计算" data-visible="false" data-switchable="false">是否加入权限计算的值</th>
								<th data-field="switchFlgStr" data-title="是否加入权限计算">是否加入权限计算</th>
								<th data-field="authLvlSwitchFlg" data-title="权限分配是否可跨越下级" data-visible="false" data-switchable="false">权限分配是否可跨越下级的值</th>
								<th data-field="authLvlSwitchFlgStr" data-title="权限分配是否可跨越下级">权限分配是否可跨越下级</th>
