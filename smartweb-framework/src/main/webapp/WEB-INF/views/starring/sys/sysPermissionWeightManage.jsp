...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/sysPermissionWeightManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="sysPermissionWeightList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="权限维度列表" aria-expanded="true" url="${ctx}/sys/sysPermissionWeight/sysPermissionWeightList">
							权限维度列表
						</a>
					</li>
					<li>
						<a href="#tab_init" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/sysPermissionWeight/init">
							权限初始化
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/sysPermissionWeight/sysPermissionWeightAdd">
							权限维度添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/sysPermissionWeight/sysPermissionWeightUpdate">
							权限维度更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/sysPermissionWeight/sysPermissionWeightDetail">
							权限维度详情
						</a>
					</li>
				</ul>
				<div class="tab-content">
					...
					<div id="tab_init" class="tab-pane">
						<iframe id="iframe_init" name="iframe_init" src="" style="width: 100%; height: 1300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
