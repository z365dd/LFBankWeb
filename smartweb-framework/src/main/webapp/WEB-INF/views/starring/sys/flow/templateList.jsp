...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/templateList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
					...
					<form id="listForm" ravo="rainbow_fx_layout_bd" class="breadcrumb form-horizontal">
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class=" col-sm-3 control-label">
									</label>
									<div class="col-sm-8  btn-group col-sm-6">
										<div class="col-sm-7">
											<select data-role="multiselect" id="flowTp" class="" name="flowTp"
											data-enable-filtering="true" data-url="${ctx}/sys/dict/selectData?type=FLOW_TP"
											data-async="true" blank-item="true" blank-text="请选择流程类型">
											</select>
										</div>
									</div>
								</div>
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-7 btn-group col-sm-6">
										<select data-role="multiselect" id="flowTmplStat" class="" name="flowTmplStat" data-enable-filtering="true"
										data-url="${ctx}/sys/dict/selectData?type=FLOW_TMPL_STAT" data-async="true"
										blank-item="true" blank-text="请选择流程模板状态">
										</select>
									</div>
								</div>
							</div>
						...
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" placeholder="请输入流程模板中英文名称" id="name"
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" placeholder="请输入流程模板版本" id="verNo"
										name="verNo" check-edition="true" maxlength="10">
									</div>
								</div>
							</div>
							<div class="col-md-4 column">
								<shiro:haspermission name="anno">
									<button id="listBtn" ravo="rainbow_fx" type="button" class="btn btn-info"
					...
					<table class="table table-hover" id="templateTable" data-side-pagination="server"
					data-toggle="table" data-url="${ctx}/sys/flow/template/list" ravo="rainbow_fx_bj"
					data-height="500" data-undefined-text="" data-pagination="true" data-striped="true"
					data-single-select="true" data-query-params="queryParams" data-first-load="true">
						<thead>
							<tr>
								<th data-field="id" class="" data-visible="false" data-switchable="false">
									编号
								</th>
								<th data-field="name" class="">
									中文名称
								</th>
								<th data-field="engName" class="" data-cell-style="">
									英文名称
								</th>
								<th data-field="flowTpStr" class="">
									类型
								</th>
								<th data-field="verNo" class="">
									版本
								</th>
								<th data-field="statStr" class="" data-title="状态" data-title-tooltip="状态">
									状态
								</th>
								<th data-field="action" class="">
									操作
								</th>
							</tr>
						</thead>
