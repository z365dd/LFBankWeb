...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/templateAddForm.js" charset="utf-8"></script>
			...
			id="addForm" style="margin-top:10px;">
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						...
						value="1.0" check-empty="true" maxlength="10" check-edition="true">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label control-label"
