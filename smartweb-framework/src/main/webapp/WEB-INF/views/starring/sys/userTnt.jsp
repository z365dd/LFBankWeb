...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/sys/userTnt.js"
	charset="utf-8"></script>
...
<body>
	...
	<div class="">
		<ul class="nav nav-tabs">
			<li><a id="listPage" href="${ctx}/sys/user/list">用户列表 </a></li>
			<li class="active"><a href="${ctx}/sys/user/userTnt?id=${userId}">租户授权</a></li>
		</ul>
				...
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal breadcrumb"
					...
					<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
						<div class="panel-heading">
							<div ravo="rainbow_fx_bj">
								<h4 contenteditable="false">授权信息</h4>
							</div>
						</div>
					</div>
					...
					<div ravo="rainbow_fx" class="form-group">
						<label for="inputEmail3" class="col-sm-3 control-label">
							租户 </label>
						<div class="col-sm-5">
							<select multiple="multiple" data-role="multiselect" id="tntId"
								class="" name="tntId" data-enable-filtering="true"
								blank-item="true" checkbtn="tntId"
								data-enable-full-value-filtering="true"
								data-non-selected-text="--请选择--" data-select-all-text="全选"
								data-n-selected-text="已选中" data-all-selected-text="全部选中 "
								data-filter-placeholder="搜索"
								data-url="${ctx}/sys/rent/allSelectRent" data-max-height="300"
								data-filter-behavior="both"
