...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/logMappingManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="logMappingList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="日志记录映射列表" aria-expanded="true" url="${ctx}/sys/modules/logMapping/logMappingList">
							日志记录映射列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/logMapping/logMappingAdd">
							日志记录映射添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/logMapping/logMappingUpdate">
							日志记录映射更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/modules/logMapping/logMappingDetail">
							日志记录映射详情
						</a>
					</li>
				</ul>
