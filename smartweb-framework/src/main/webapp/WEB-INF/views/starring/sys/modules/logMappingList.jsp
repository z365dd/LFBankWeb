...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/logMappingList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="requestUri" name="requestUri" class="form-control "  maxlength="1024" >
											</input>
										</div>
									</div>
								</div>
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="uriCname" name="uriCname" class="form-control "  maxlength="1024" >
											</input>
										</div>
									</div>
								</div>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<select id="logStat" name="logStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=LOG_STAT" blank-item="true" blank-text="--请选择--">
											</select>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="logMappingTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/sys/modules/logMapping/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="requestUri" data-title="请求URI">请求URI</th>
								<th data-field="uriCname" data-title="请求URI中文名称">请求URI中文名称</th>
								<th data-field="logStat" data-title="记录日志状态的值" data-visible="false" data-switchable="false">记录日志状态的值</th>
								<th data-field="logStatStr" data-title="记录日志状态">记录日志状态</th>
								<th data-field="rmrk" data-title="备注">备注</th>
