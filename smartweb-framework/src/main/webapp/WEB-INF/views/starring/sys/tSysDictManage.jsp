...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/tSysDictManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tSysDictList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="页面参数列表" aria-expanded="true" url="${ctx}/sys/tSysDict/tSysDictList">
							页面参数列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/tSysDict/tSysDictAdd">
							页面参数添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/tSysDict/tSysDictUpdate">
							页面参数更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/tSysDict/tSysDictDetail">
							页面参数详情
						</a>
					</li>
					<li>
						<a href="#tab_valadd" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/tSysDict/tSysDictAdd">
							页面参数标签添加
						</a>
					</li>
					<li>
						<a href="#tab_valupdate" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/tSysDict/tSysDictUpdate">
							页面参数标签更新
						</a>
					</li>
					<li>
						<a href="#tab_valdetail" data-toggle="tab" aria-expanded="false" url="${ctx}/sys/tSysDict/tSysDictDetail">
							页面参数标签详情
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="tab_list">
						<iframe id="iframe_list" name="iframe_list" src="" style="width: 100%; height: 1000px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div id="tab_add" class="tab-pane">
						<iframe id="iframe_add" name="iframe_add" src="" style="width: 100%; height: 1300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_update" class="tab-pane">
						<iframe id="iframe_update" name="iframe_update" src="" style="width: 100%; height: 1300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_detail" class="tab-pane">
						<iframe id="iframe_detail" name="iframe_detail" src="" style="width: 100%; height: 1300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_valadd" class="tab-pane">
						<iframe id="iframe_valadd" name="iframe_valadd" src="" style="width: 100%; height: 1300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_valupdate" class="tab-pane">
						<iframe id="iframe_valupdate" name="iframe_valupdate" src="" style="width: 100%; height: 1300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
					<div id="tab_valdetail" class="tab-pane">
						<iframe id="iframe_valdetail" name="iframe_valdetail" src="" style="width: 100%; height: 1300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
				</div>
			</div>
		</div>
