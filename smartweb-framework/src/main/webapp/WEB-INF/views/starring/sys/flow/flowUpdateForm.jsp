...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/flow/flowUpdateForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="updateForm" style="margin-top:10px;">
				...
				<input type="hidden" id="sndUserId" name="sndUserId" value="${fns:getUser().id}">
				<div ravo="rainbow_fx" class="form-group">
					<label for="inputEmail3" class="col-sm-3 control-label">
						流程标题
					</label>
					<div class="col-sm-4">
						<input id="infoTitle" name="infoTitle" class="form-control" maxlength="40" check-empty="true"
						type="text">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-7 btn-group col-sm-4">
						...
						checkbtn="flowTmplId" data-async="false" data-url="${ctx}/sys/flow/template/selectData"
						data-enable-filtering="true" blank-item="true" blank-text="--请选择流程类型--">
						</select>
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						<input id="sndUserNameOld" name="sndUserNameOld"
						class="form-control" maxlength="" check-empty="true" type="text" check-character="true"
						readonly="readonly">
					</div>
				</div>
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="col-sm-2">
						<input id="sndUserName" name="sndUserName" value="${fns:getUser().name}"
						class="form-control" maxlength="" check-empty="true" type="text" check-character="true"
						readonly="readonly">
					</div>
				</div>
				...
				<div ravo="rainbow_fx" class="form-group">
					...
					<div class="  col-sm-4">
						...
						maxlength="64" check-time-empty="true">
						</textarea>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
