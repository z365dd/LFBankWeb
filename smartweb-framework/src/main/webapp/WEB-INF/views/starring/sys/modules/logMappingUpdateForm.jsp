...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/logMappingUpdateForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="requestUri" name="requestUri" class="form-control "  maxlength="1024" check-empty="true"  >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="uriCname" name="uriCname" class="form-control "  maxlength="1024" check-empty="true"  >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="logStat" name="logStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=LOG_STAT" data-async="true" blank-item="true" blank-text="--请选择--" checkbtn="logStat"  >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<textarea id="rmrk" name="rmrk" rows="3" class="form-control "  maxlength="256"   >
								</textarea>
							</div>
						</div>
					</div>
