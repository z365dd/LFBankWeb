...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/sys/modules/sysNoticeDetailForm.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
					<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="detailForm">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label">
								公告标题
							</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="标题" readonly="readonly" id="noteTitle" name="noteTitle">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class=" col-sm-4 control-label">
							...
							<div class="col-sm-4">
								<textarea class="form-control" rows="10" id="noteCntt" name="noteCntt" readonly="readonly">
								</textarea>
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-8">
								<select data-role="multiselect" id="popFlg" class="" name="popFlg" disabled="disabled">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<a href="" id="LINK_URL" style="margin-top: 5px;">跳转链接描述</a>
							</div>
						</div>
						<input hidden="hidden" id="sysNoticeId" name="sysNoticeId">
					</form>
				</div>
			</div>
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
