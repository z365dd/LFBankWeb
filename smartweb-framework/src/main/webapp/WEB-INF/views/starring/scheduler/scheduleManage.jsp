...
<script type="text/javascript" src="<%=basePath%>/b_base/jquery-migrate-3.4.0.min.js" charset="utf-8"></script><script type="text/javascript" src="<%=basePath%>/b_base/jqueryForm.js" charset="utf-8"></script>
    ...
    <!-- Self reference JS-->
    <script type="text/javascript" src="<%=basePath%>/b_base/views/starring/scheduler/scheduleManage.js"
            charset="utf-8"></script>
        ...
        <div class="" style="padding: 0px 10px">
            <div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
                ...
                <ul class="nav nav-tabs" data-toggle="tabs">
                    <li class="active">
                        <a href="#tab_list" data-toggle="tab" url="${ctx }/sys/schedule/listPage">
                            调度任务列表
                        </a>
                    </li>
                    <li>
                        <a href="#tab_add" data-toggle="tab" url="${ctx }/sys/schedule/addPage">
                            调度任务新增
                        </a>
                    </li>
                    <li>
                        <a href="#tab_update" data-toggle="tab" url="${ctx }/sys/schedule/updatePage">
                            调度任务修改
                        </a>
                    </li>
                    <li>
                        <a href="#tab_log" data-toggle="tab" url="${ctx }/sys/schedule/logPage">
                            调度任务日志
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane in active" id="tab_list">
                        <iframe id="iframe_list" name="iframe_list" isLoaded="false" src=""
                                style="width: 100%; height: 560px; border: 0px;"
                                scrolling="no" frameborder="no">
                        </iframe>
                    </div>
                    <div class="tab-pane" id="tab_add">
                        <iframe id="iframe_add" name="iframe_add" src=""
                                style="width: 100%; height: 1300px; border: 0px;"
                                scrolling="no" frameborder="no">
                        </iframe>
                    </div>
                    ...
                    <div id="tab_log" class="tab-pane">
                        <iframe id="iframe_log" name="iframe_log" src=""
