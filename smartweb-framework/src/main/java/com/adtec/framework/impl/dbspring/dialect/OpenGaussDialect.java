...
/**
 * The Class Kingbase8Dialect.
 */
public class OpenGaussDialect implements IDialect {
	private final static Logger log = LoggerFactory.getLogger(OpenGaussDialect.class);
	/**
	 * OpenGauss的关键字和保留字
	 */
	...
	public String getAutoIncreaseKeySql(String tableName) {
		return "select nextval('" + DialectUtil.getSeqName(tableName) + "')";
	}
	...
	public String getCurrentDate() {
		return "select  to_char(current_timestamp,'YYYY-MM-DD HH24:MI:SS')";
	}
	...
	public String getDialectName() {
		return DialectUtil.DB_TYPE_OPENGAUSS;
	}
	...
	public String buildSqlFuction(String sql) throws SQLException{
		try{
			return DialectUtil.buildSqlFuction(sql, DialectUtil.DB_TYPE_KINGBASE8);
		}catch(Exception e){
