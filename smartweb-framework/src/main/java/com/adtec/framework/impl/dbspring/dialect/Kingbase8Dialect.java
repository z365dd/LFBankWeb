 ...
 */
public class Kingbase8Dialect implements IDialect {
	private final static Logger log = LoggerFactory.getLogger(Kingbase8Dialect.class);
	/**
	 * Kingbase8的关键字和保留字
	 */
	...
	public String getDialectName() {
		return DialectUtil.DB_TYPE_KINGBASE8;
	}
