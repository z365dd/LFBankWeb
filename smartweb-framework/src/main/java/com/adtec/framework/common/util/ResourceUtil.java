/*
 * 系统名称: 
 * 模块名称: 资源工具类，用于获取指定URL的相关文件
 * 类 名 称: ResourceUtil.java
 * 软件版权: 
 * 相关文档:
 * 修改记录:
 * 修改日期      修改人员                     修改说明<BR>
 ...
 * method can resolve any location to a {@link com.adtec.framework.common.util.LeaveUtil.core.io.Resource}
 ...
 * @since 1.1.5
 * @see com.adtec.framework.common.util.LeaveUtil.core.io.Resource
