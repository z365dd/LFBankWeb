...
public class ValidateCodeServlet extends HttpServlet {
	...
	private final static Logger logger = LoggerFactory.getLogger(ValidateCodeServlet.class);
	...
	private void createImage(HttpServletRequest request,
		...
		/*20211029 mod by chenyl for 修改验证码加密保存*/
		request.getSession().setAttribute(VALIDATE_CODE, Digests.aesEncrypt(s));
