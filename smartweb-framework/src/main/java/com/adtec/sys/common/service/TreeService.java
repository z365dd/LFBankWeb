...
import com.adtec.sys.common.persistence.TreeDao;
import com.adtec.sys.common.persistence.TreeEntity;
...
public abstract class TreeService<D extends TreeDao<T>, T extends TreeEntity<T>> extends CrudService<D, T> {
	...
	public void save(T entity) {
		...
		Class<T> entityClass = ClassUtil.getClassGenricType(getClass(), 1);
		...
		if (entity.getParent() == null){
			...
			try {
				...
				throw new BaseException(SysErr.E_DEFAULT, e, "创建父节点");
			}
		...
		try {
			...
			throw new BaseException(SysErr.E_DEFAULT, e, "创建节点");
		}
