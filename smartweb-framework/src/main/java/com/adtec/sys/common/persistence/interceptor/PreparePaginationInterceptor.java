...
public class PreparePaginationInterceptor extends BaseInterceptor {
    ...
    public Object intercept(Invocation ivk) throws Throwable {
        if (ivk.getTarget().getClass().isAssignableFrom(RoutingStatementHandler.class)) {
            ...
            final BaseStatementHandler delegate = (BaseStatementHandler) ClassUtil.getFieldValue(statementHandler, DELEGATE);
            final MappedStatement mappedStatement = (MappedStatement) ClassUtil.getFieldValue(delegate, MAPPED_STATEMENT);
//            //拦截需要分页的SQL
...
//            if (StringUtils.indexOfIgnoreCase(mappedStatement.getId(), _SQL_PATTERN) != -1) {
                ...
                if (parameterObject == null) {
                    ...
                    try {
                        ...
                        //将分页sql语句反射回BoundSql.
                        ClassUtil.setFieldValue(boundSql, "sql", pagingSql);
