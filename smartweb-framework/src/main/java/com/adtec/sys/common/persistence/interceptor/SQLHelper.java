...
public class SQLHelper {
    ...
    public static void setParameters(PreparedStatement ps, MappedStatement mappedStatement, BoundSql boundSql, Object parameterObject) throws SQLException {
        ...
        if (parameterMappings != null) {
            ...
            MetaObject metaObject = parameterObject == null ? null :
                    (configuration != null ? configuration.newMetaObject(parameterObject) : null);
            for (int i = 0; i < parameterMappings.size(); i++) {
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT) {
                    ...
                    if (parameterObject == null) {
                        ...
                        value = metaObject == null ? null : (metaObject != null ? metaObject.getValue(propertyName) : null);
                    }
    ...
    public static int getCount(final String sql, final Connection connection,
    							...
    							final BoundSql boundSql,final Log log) throws SQLException {
...
//        final String countSql = "select count(1) " + removeSelect(removeOrders(sql));
        ...
        try {
			...
			if (ClassUtil.getFieldValue(boundSql, "metaParameters") != null) {
				MetaObject mo = (MetaObject) ClassUtil.getFieldValue(boundSql, "metaParameters");
				ClassUtil.setFieldValue(countBS, "metaParameters", mo);
			}
