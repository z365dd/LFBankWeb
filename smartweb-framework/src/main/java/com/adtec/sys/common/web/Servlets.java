...
public class Servlets {
	...
	// 静态文件后缀
	private final static String[] staticFiles = StringUtil.split(ParamUtil.getStaticFile(), ",");
	
	// 动态映射URL后缀
	private final static String urlSuffix = ParamUtil.getUrlSuffix();
...
//		}
    ...
    public static String getWebContextPath(){
    	if(DataUtil.isNullStr(webContextPath)){
