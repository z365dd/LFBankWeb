package com.adtec.sys.common.security.shiro.session;
 ...
 * @version 2014-7-24
 */
public class RedisCacheSessionDAO extends RedisSessionDAO implements SessionDAO {

	private final static Logger logger = LoggerFactory.getLogger(RedisCacheSessionDAO.class);
	...
	public void update(Session session) throws UnknownSessionException {
		...
		if (request != null){
			...
			// 如果是视图文件，则不更新SESSION
			if (StringUtil.startsWith(uri, ParamUtil.getString("web.view.prefix"))
					&& StringUtil.endsWith(uri, ParamUtil.getString("web.view.suffix"))){
				return;
			}
			// 手动控制不更新SESSION
			String updateSession = request.getParameter("updateSession");
			if (ParamUtil.FALSE.equals(updateSession) || ParamUtil.NO.equals(updateSession)){
				return;
			}
		}
