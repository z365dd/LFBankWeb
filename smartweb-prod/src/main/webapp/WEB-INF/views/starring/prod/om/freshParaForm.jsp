...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/om/freshParaForm.js"
	charset="utf-8"></script>
<script type="text/javascript"
...
<body>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">刷新单位业务参数</a>
						</li>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<form ravo="rainbow_fx_layout_bd" class="form-horizontal"
								pourl="" id="addForm" style="margin-top: 20px">
								<div ravo="rainbow_fx_layout" class="row clearfix">
										...
										<div class="col-md-6 column">
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="col-sm-7 btn-group">
													<!-- <select data-role="multiselect" id="busiNo" class="" name="busiNo" check-empty="true" data-max-height="300" data-button-width="300"
																data-enable-filtering="true" data-enable-full-value-filtering="false"  data-enable-case-insensitive-filtering="true"
																data-filter-placeholder="搜索" checkBtn="busiNo">
														<option value="">
															请选择
														</option>
													</select> -->
													<input type="hidden" id="busiNo" name="busiNo"/>
													<input type="text" class="form-control" id="busiName" name="busiName" readonly />
												</div>
												<div class="col-sm-2">
												...
												<div class="col-sm-4">
													<shiro:haspermission name="anno">
														<button ravo="rainbow_fx" type="button"
															...
															id="addBtn" name="addBtn">刷新</button>
													</shiro:haspermission>
												</div>
											</div>
										</div>
	...
	<jsp:include flush="true" page="/WEB-INF/views/starring/prod/oper/modalBusiList.jsp"></jsp:include>	
	<!--customer_code_beg-->
