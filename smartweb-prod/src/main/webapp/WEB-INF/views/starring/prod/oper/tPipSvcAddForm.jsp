...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipSvcAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="compNo" name="compNo" data-role="multiselect" data-url="${ctx}/prod/enums/selectCompData?type=" blank-item="true" blank-text="--请选择--" checkbtn="compNo" data-max-height="300"
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="svcCode" name="svcCode" class="form-control "  check-empty="true" >
								</input>
							</div>
						</div>
					</div>
