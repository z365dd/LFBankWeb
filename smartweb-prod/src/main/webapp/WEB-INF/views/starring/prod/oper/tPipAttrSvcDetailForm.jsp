...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipAttrSvcDetailForm.js" charset="utf-8"></script>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="chkFlg" name="chkFlg" class="form-control "  readonly="readonly" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="shortRmrk" name="shortRmrk" class="form-control "  readonly="readonly" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="midRmrk" name="midRmrk" class="form-control "  readonly="readonly" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="longRmrk" name="longRmrk" class="form-control "  readonly="readonly" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="dac" name="dac" class="form-control "  readonly="readonly" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
