...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipAttrSvcManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipAttrSvcList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="服务属性列表" aria-expanded="true" url="${ctx}/prod/oper/tPipAttrSvc/tPipAttrSvcList">
							服务属性列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/tPipAttrSvc/tPipAttrSvcAdd">
							服务属性添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/tPipAttrSvc/tPipAttrSvcUpdate">
							服务属性更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/tPipAttrSvc/tPipAttrSvcDetail">
							服务属性详情
						</a>
					</li>
				</ul>
