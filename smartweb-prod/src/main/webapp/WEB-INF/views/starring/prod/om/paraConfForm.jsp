...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/om/paraConfForm.js"
	charset="utf-8"></script>
					...
					<div id="model_0">
						<div class="panel panel-default" >
							<div class="panel-heading">
								...
								href="#collapse" contenteditable="false">
									隐藏域
								</a>
							</div>
											...
											<div ravo="rainbow_fx_layout" class="row clearfix" >
												...
												<div class="col-md-4 column">
													<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-top:50px">
														...
														<div class="col-md-3 column">
															<button ravo="rainbow_fx" type="button" class="btn btn-default" contenteditable="false" id="resetBtn">
																重置
															</button>
														</div>
														<div class="col-md-1 column"></div>
