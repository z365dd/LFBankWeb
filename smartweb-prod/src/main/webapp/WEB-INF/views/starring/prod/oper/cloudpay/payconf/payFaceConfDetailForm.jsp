...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/payconf/payFaceConfDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="payFaceConfForm" style="margin-top:10px;">
				<div ravo="rainbow_fx_layout" class="row clearfix">
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4 btn-group">
										<select data-role="multiselect" id="qrySvcCode" class="" name="qrySvcCode" data-max-height="300" checkBtn="qrySvcCode"
