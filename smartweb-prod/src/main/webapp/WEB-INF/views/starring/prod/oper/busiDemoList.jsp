...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/busiDemoList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">业务查询 </a>
						</li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2">业务新增 </a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-5 control-label">
													单位名称 </label>
												<div class="col-sm-4">
													<!-- <select data-role="multiselect" id="entrNo" class=""
														name="entrNo" data-max-height="300">
														<option value="">请选择</option>
													</select> -->
													<input type="text" class="form-control" id="entrName" name="entrName" autocomplete="off">
												</div>
											</div>
										</div>
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="saleProdCode" class=" col-sm-3 control-label">
													可售产品 </label>
												<div class="col-sm-4">
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-5 control-label">
													业务名称 </label>
												<div class="col-sm-4">
													<input type="text" class="form-control" id="busiName" name="busiName" autocomplete="off">
												</div>
											</div>
										</div>
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-3 control-label">
													状态 </label>
												<div class="col-sm-4">
													<select data-role="multiselect" id="openStat" name="openStat" data-url="${ctx}/sys/dict/selectData?type=OPEN_STAT" data-max-height="300" blank-item="true"
															data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索" checkbtn="openStat">
													</select>
												</div>
											</div>
										</div>										
							...
							<table id="table" data-toggle="table" data-first-load="false"
								data-url="${ctx}/prod/oper/busiDemo/qry"
								...
								<thead style="">
									<tr>
										...
										<th data-field="entrNo">单位编号</th>
										<th data-field="entrName">单位名称</th>
										<th data-field="openStat">状态</th>
