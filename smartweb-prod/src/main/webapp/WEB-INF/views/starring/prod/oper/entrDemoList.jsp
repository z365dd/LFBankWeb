...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/entrDemoList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true"> 单位查询 </a>
						</li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2"> 单位新增 </a></li>
					</ul>
									...
									<div class="col-md-5 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class=" col-sm-5 control-label">
												状态 </label>
											<div class="col-sm-4">
<%--												<select data-role="multiselect" id="OPEN_STAT" class=""--%>
<%--													name="OPEN_STAT" data-max-height="300">--%>
<%--													<option value="">请选择</option>--%>
<%--													<option value="01">开通</option>--%>
<%--													<option value="02">关闭</option>--%>
<%--												</select>--%>
												<select data-role="multiselect" id="OPEN_STAT" name="OPEN_STAT" data-url="${ctx}/sys/dict/selectData?type=OPEN_STAT" data-max-height="300" blank-item="true"
														data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索" checkbtn="OPEN_STAT">
												</select>
											</div>
										</div>
									</div>
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/prod/oper/entrDemo/qry"
