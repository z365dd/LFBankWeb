...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/prodAttrList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">组件查询
						</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-5 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-5 control-label control-label">组件名称</label>
											<div class="col-sm-4">
												<select data-role="multiselect" id="COMP_NO" class="" data-async="true"
													name="COMP_NO" data-max-height="300" data-url="${ctx}/prod/oper/prodAttr/getComp">
									...
									<div class="col-md-5 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<select data-role="multiselect" id="PROD_COMP_TP" name="PROD_COMP_TP" data-url="${ctx}/sys/dict/selectData?type=PROD_COMP_TP" data-max-height="300" blank-item="true"
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/prod/oper/prodAttr/qry"
								...
								<thead style="">
									<tr>
										...
										<th data-field="PROD_COMP_TP" data-visible="false" data-switchable="false">类型</th>
										<th data-field="FLG_STR" >类型</th>
										<th data-field="OPEN_STAT" data-visible="false" data-switchable="false">状态</th>
										<th data-field="STAT_STR" >状态</th>
