...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/atom/tPipAtomProdManage.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						...
						title="原子产品列表" aria-expanded="true" url="${ctx}/prod/oper/definition/atom/tPipAtomProd/tPipAtomProdList">
							原子产品列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/atom/tPipAtomProd/tPipAtomProdAdd">
							原子产品添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/atom/tPipAtomProd/tPipAtomProdUpdate">
							原子产品更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/atom/tPipAtomProd/tPipAtomProdDetail">
							原子产品详情
						</a>
					</li>
				</ul>
