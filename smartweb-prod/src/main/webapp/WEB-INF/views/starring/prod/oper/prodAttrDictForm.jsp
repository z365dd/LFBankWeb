...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/prodAttrDictForm.js"
	charset="utf-8"></script>
		...
		<div ravo="rainbow_fx_layout" class="row clearfix">
			<div class="col-md-12 column">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl=""
					id="formId_65948">
					<div ravo="rainbow_fx_layout" class="row clearfix" id="commonDiv">
...
<%--										<option value="01">产品KV属性</option>--%>
<%--										<option value="02">技术KV属性</option>--%>
<%--										<option value="04">界面属性</option>--%>
<%--									</select>--%>
									<select data-role="multiselect" id="KEY_TP" name="KEY_TP" data-url="${ctx}/prod/oper/prodAttr/selectData2?type=KEY_TP" data-max-height="300" blank-item="true" data-async="true"
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									   class="col-sm-5 control-label control-label">属性名称</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										   id="KEY_NAME" name="KEY_NAME" check-empty="true">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="VAL_TP" class=" col-sm-5 control-label">
									数据类型</label>
								<div class="col-sm-4">
<%--									<select data-role="multiselect" id="VAL_TP" class=""--%>
<%--											name="VAL_TP" data-max-height="300" checkbtn="VAL_TP">--%>
<%--										<option value="">--请选择--</option>--%>
<%--										<option value="01">String</option>--%>
<%--										<option value="02">Double</option>--%>
<%--										<option value="03">Float</option>--%>
<%--										<option value="04">Long</option>--%>
<%--										<option value="05">Int</option>--%>
<%--									</select>--%>
									<select data-role="multiselect" id="VAL_TP" name="VAL_TP" data-url="${ctx}/sys/dict/selectData?type=VAL_TP" data-max-height="300" blank-item="true"data-async="true"
											data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索" checkbtn="VAL_TP">
									</select>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="ENTER_TP" class=" col-sm-5 control-label">
									控件类型</label>
								<div class="col-sm-4">
<%--									<select data-role="multiselect" id="ENTER_TP" class=""--%>
<%--											name="ENTER_TP" data-max-height="300" checkbtn="ENTER_TP">--%>
<%--										<option value="">--请选择--</option>--%>
<%--										<option value="01">输入框（text）</option>--%>
<%--										<option value="02">下拉框（select）</option>--%>
<%--										<option value="03">多选框（checkbox）</option>--%>
<%--									</select>--%>
									<select data-role="multiselect" id="ENTER_TP" name="ENTER_TP" data-url="${ctx}/sys/dict/selectData?type=ENTER_TP" data-max-height="300" blank-item="true"data-async="true"
											data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索" checkbtn="ENTER_TP">
									</select>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="QUOTE" class=" col-sm-5 control-label">
									引入组件或服务</label>
								<div class="col-sm-7">
<%--									<input type="text" class="form-control" placeholder=""--%>
<%--										id="QUOTE" name="QUOTE" readonly="readonly">--%>
									<textarea class='form-control' style='resize:none;' rows='3' name='QUOTE' id='QUOTE' maxlength='360' readonly="readonly"></textarea>
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									   class="col-sm-3 control-label control-label">属性</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										   id="KEY_NO" name="KEY_NO" check-empty="true">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-3 control-label control-label">最大长度 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="VAL_LEN" name="VAL_LEN" check-empty="true">
								</div>
							</div>
						</div>
					</div>
					<div id="keyTpDiv">
						<div ravo="rainbow_fx_layout_panel" class="panel panel-default"
							...
							<div class="panel-heading">
								<div ravo="rainbow_fx_bj">
									<h5 contenteditable="false">选择配置</h5>
								</div>
							</div>
							<div class="panel-body" contenteditable="false">
								<div ravo="rainbow_fx_layout" class="row clearfix"
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-5 control-label control-label">显示值</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" placeholder=""
													id="key" name="key" check-empty="key">
											</div>
										</div>
									</div>
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-3 control-label control-label">实际值</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" placeholder=""
													id="value" name="value" check-empty="value">
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
						...
						<div ravo="rainbow_fx_layout_panel" class="panel panel-default"
							...
							<div class="panel-heading">
								<div ravo="rainbow_fx_bj">
									<h5 contenteditable="false">日期输入配置</h5>
								</div>
							</div>
							<div class="panel-body" contenteditable="false">
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class=" col-sm-5 control-label">
												显示格式</label>
											<div class="col-sm-4">
												<select data-role="multiselect" id="datetime_datafmt"
													class="" name="datetime_datafmt" data-max-height="300"
													checkbtn="datetime_datafmt">
													<option value=''>请选择</option>
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<select data-role="multiselect" id="datetime_datafmt"
													class="" name="datetime_valuefmt" data-max-height="300"
													checkbtn="datetime_valuefmt">
													<option value=''>请选择</option>
