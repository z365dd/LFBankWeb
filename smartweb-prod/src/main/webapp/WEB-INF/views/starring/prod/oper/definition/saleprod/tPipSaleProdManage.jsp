...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/saleprod/tPipSaleProdManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipSaleProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="可售产品列表" aria-expanded="true" url="${ctx}/prod/oper/definition/saleprod/tPipSaleProd/tPipSaleProdList">
							可售产品列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/saleprod/tPipSaleProd/tPipSaleProdAdd">
							可售产品添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/saleprod/tPipSaleProd/tPipSaleProdUpdate">
							可售产品更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/saleprod/tPipSaleProd/tPipSaleProdDetail">
							可售产品详情
						</a>
					</li>
				</ul>
