...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipSvcUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tPipSvcForm" style="margin-top:10px;">
				...
				<input type="hidden" value="" name="openStat" id="openStat"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="compNo" name="compNo" data-role="multiselect" data-url="${ctx}/prod/enums/selectCompData?type=" data-async="true" blank-item="true" blank-text="--请选择--" checkbtn="compNo" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="svcCode" name="svcCode" class="form-control "  readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="svcName" name="svcName" class="form-control "  check-empty="true" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="svcDesc" name="svcDesc" class="form-control "  check-empty="true" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="othSvcCodeFlg" name="othSvcCodeFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=OTH_SVC_CODE_FLG" blank-item="true" blank-text="--请选择--" checkbtn="othSvcCodeFlg" >
								</select>
							</div>
						</div>
					</div>
