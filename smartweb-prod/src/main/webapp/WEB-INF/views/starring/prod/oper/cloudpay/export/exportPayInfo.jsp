...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/export/exportPayInfo.js"
	charset="utf-8"></script>
								...
								<div ravo="rainbow_fx_layout" class="row clearfix"
									...
									<div class="col-md-6 column">
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<select data-role="multiselect" id="BUSI_NO" class="" name="BUSI_NO" data-max-height="300" checkBtn="BUSI_NO"
													data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" 
													data-filter-placeholder="搜索">
													<option value="">
														请选择
											...
											<div class="col-md-3 column">
												<div ravo="rainbow_fx" class="form-group">
													<div class="col-sm-1 column">
														<button type="button" class="btn btn-primary" id="submitBtn">导出</button>
													</div>
												</div>
											</div>
											<div class="col-md-3 column">
