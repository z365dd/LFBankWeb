...
<script type="text/javascript" src="<%=basePath%>/b_base/jqueryForm.js" charset="utf-8"></script>
<!-- /JQUERY -->
...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/importOrExportEntrPara.js"
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/modalBusiList.js"
	charset="utf-8"></script>
...
<body>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<form id="ex_importForm" ravo="rainbow_fx_layout_bd"
								class="form-horizontal" pourl="">
								<div ravo="rainbow_fx_layout" class="row clearfix"
									style="margin: 20px;">
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class="col-sm-3 control-label">
												业务编号 </label>
											<div class="col-sm-3">
												<!-- <select data-role="multiselect" id="BUSI_NO" class=""
													name="BUSI_NO" data-max-height="300" checkbtn="BUSI_NO">
													<option value="">请选择</option>
												</select> -->
												<input type="hidden" id="BUSI_NO" name="BUSI_NO"/>
												<input type="text" class="form-control" id="BUSI_NAME" name="BUSI_NAME" readonly />
											</div>
											<div class="col-sm-2">
												<button ravo="rainbow_fx" type="button"
													class="btn btn-primary " contenteditable="false" id="busiSelectBtn">选择</button>
											</div>
										</div>
										<!-- 导入 -->
										<div class="form-group">
											...
											<input type="file" name="file" accept=".txt, .sql" id='i-file'
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<div class="col-sm-1 column">
												<button type="button" class="btn btn-primary" id="expBtn">导出</button>
											</div>
										</div>

										<div ravo="rainbow_fx" class="form-group">
											<div class="col-sm-1 column">
												<button type="button" class="btn btn-primary" id="submitBtn">导入</button>
											</div>
										</div>
									</div>
								</div>
	...
	<jsp:include flush="true" page="modalBusiList.jsp"></jsp:include>
	<!--customer_code_beg-->
