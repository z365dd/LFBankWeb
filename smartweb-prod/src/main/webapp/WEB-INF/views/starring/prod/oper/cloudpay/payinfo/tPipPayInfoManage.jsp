...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/payinfo/tPipPayInfoManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipPayInfoList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="缴费信息列表" aria-expanded="true" url="${ctx}/prod/oper/cloudpay/payinfo/tPipPayInfoList">
							缴费信息列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/payinfo/tPipPayInfoAdd">
							缴费信息添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/payinfo/tPipPayInfoUpdate">
							缴费信息更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/payinfo/tPipPayInfoDetail">
							缴费信息详情
						</a>
					</li>
				</ul>
