...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/atom/tPipAtomProdList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									...
									<div class="col-md-4 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<input id="atomProdDesc" name="atomProdDesc" class="form-control "  >
												</input>
											</div>
										</div>
									</div>
					...
					<table class="table table-hover" id="tPipAtomProdTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/prod/oper/definition/atom/tPipAtomProd/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="compNo" data-title="组件">组件</th>
								<th data-field="compName" data-title="组件名称">组件名称</th>
								<th data-field="atomProdCode" >原子产品编号</th>
