...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/adapter/tPipSaleProdAdapterManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipSaleProdAdapterList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="可售产品包装列表" aria-expanded="true" url="${ctx}/prod/oper/definition/adapter/tPipSaleProdAdapter/tPipSaleProdAdapterList">
							可售产品包装列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/adapter/tPipSaleProdAdapter/tPipSaleProdAdapterAdd">
							可售产品包装添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/adapter/tPipSaleProdAdapter/tPipSaleProdAdapterUpdate">
							可售产品包装更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/definition/adapter/tPipSaleProdAdapter/tPipSaleProdAdapterDetail">
							可售产品包装详情
						</a>
					</li>
				</ul>
