...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/om/paraConfManage.js"
	charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="list" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="技术参数生效" aria-expanded="true" url="${ctx}/prod/om/freshPara/paraConfForm">
							技术参数生效
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="">
							关联属性
						</a>
					</li>
				</ul>
