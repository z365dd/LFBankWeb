...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/line/tPipLineProdList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									...
									<div class="col-md-4 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<input id="prodLineCode" name="prodLineCode" class="form-control "  >
												</input>
											</div>
										</div>
									</div>
									...
									<div class="col-md-4 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<input id="prodLineName" name="prodLineName" class="form-control "  >
												</input>
											</div>
										</div>
									</div>
					...
					<table class="table table-hover" id="tPipLineProdTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/prod/oper/line/tPipLineProd/list" ravo="rainbow_fx_bj"
