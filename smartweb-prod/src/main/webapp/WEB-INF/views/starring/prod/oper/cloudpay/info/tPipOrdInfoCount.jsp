...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/info/tPipOrdInfoCount.js"
	charset="utf-8"></script>
			...
			<div class="col-md-12 column">
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
					<div class="panel-body" contenteditable="false">
						...
						<form id="countListForm" ravo="rainbow_fx_layout_bd"
							class="form-horizontal breadcrumb">
							<input type="hidden" value="" name="saleProdDesc" id="saleProdDesc"/>
							<input type="hidden" value="" name="countTypeStr" id="countTypeStr"/>
							<div ravo="rainbow_fx_layout" class="row clearfix"
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-3 control-label">
													统计类型 </label>
												<div class="col-sm-6">
													<select data-role="multiselect" id="countType" class=""
														name="countType" data-max-height="300"
														data-enable-filtering="true"
														data-enable-full-value-filtering="false"
														data-enable-case-insensitive-filtering="true"
														data-filter-placeholder="搜索">
						...
						<table class="table table-hover" id="tPipOrdInfoCountTable"
							data-side-pagination="server" data-toggle="table"
							data-url="${ctx}/prod/oper/cloudpay/info/countList"
							...
							<thead>
								<tr>
									...
									<th data-field="countType">统计类型</th>
									<th data-field="saleProdCode" >缴费产品</th>
									<th data-field="ordCountAmt">统计金额</th>
									<th data-field="countNum">统计数量</th>
