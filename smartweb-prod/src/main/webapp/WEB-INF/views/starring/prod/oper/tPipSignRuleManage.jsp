...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipSignRuleManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipSignRuleList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="签约规则参数列表" aria-expanded="true" url="${ctx}/prod/oper/tPipSignRule/tPipSignRuleList">
							签约规则参数列表
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/tPipSignRule/tPipSignRuleUpdate">
							签约规则参数更新
						</a>
					</li>
				</ul>
