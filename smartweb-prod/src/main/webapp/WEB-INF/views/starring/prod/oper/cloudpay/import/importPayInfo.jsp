...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/import/importPayInfo.js"
	charset="utf-8"></script>
								...
								<div ravo="rainbow_fx_layout" class="row clearfix"
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group" style="display: none">
											<div class="col-sm-1 column">
											 <button type="button" class="btn btn-primary" style="display: none"  id="expBtn">导出</button>   
											</div>
										</div>
										<!-- 
										<div ravo="rainbow_fx" class="form-group">
