...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipAttrSvcAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="compNo" class="" name="compNo" data-max-height="300" checkbtn="compNo"
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="svcCode" class="" name="svcCode" data-max-height="300" checkbtn="svcCode"
										data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索">
									<option value="">
										请选择
									</option>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chkFlg" name="chkFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CHK_FLG" blank-item="true" blank-text="--请选择--" checkbtn="chkFlg" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="signFlg" name="signFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=SIGN_FLG" blank-item="true" blank-text="--请选择--" checkbtn="signFlg" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="othConnFlg" name="othConnFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=OTH_CONN_FLG" blank-item="true" blank-text="--请选择--" checkbtn="othConnFlg" >
								</select>
							</div>
						</div>
					</div>
