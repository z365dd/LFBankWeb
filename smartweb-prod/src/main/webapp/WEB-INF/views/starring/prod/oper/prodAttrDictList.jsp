...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/prodAttrDictList.js" charset="utf-8"></script>
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/attrCommon.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					...
					<li class="active">
						<a href="#panel1" data-toggle="tab" class="" aria-expanded="false"
						id="tab1" name="tab1">
							属性查询
						</a>
					</li>
					<li class="">
						<a href="#panel2" data-toggle="tab" aria-expanded="true" class=""
						id="tab2" name="tab2">
							属性新增
						</a>
					</li>
					<!-- <li class="">
						<a href="#panel3" data-toggle="tab" aria-expanded="true" class=""
						id="tab3" name="tab3">
							属性字典导入
						</a>
					</li> -->
				...
				<div class="tab-content" style="margin-top: 20px">
					<div class="tab-pane in active" id="panel1">
						...
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_734602">
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="KEY_TP" class="col-sm-5 control-label control-label">
											属性类型
										</label>
										<div class="col-sm-4">
											<select data-role="multiselect" id="KEY_TP" name="KEY_TP"
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="KEY_NO" class="col-sm-5 control-label control-label">
											属性
										</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" placeholder="" id="KEY_NO"
												   name="KEY_NO">
										</div>
									</div>
								</div>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="KEY_NAME" class="col-sm-5 control-label control-label">
											属性名称
										</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" placeholder="" id="KEY_NAME"
												   name="KEY_NAME">
										</div>
									</div>
								</div>
                        ...
                        <table id="table" data-toggle="table" data-first-load="true" data-url="${ctx}/prod/oper/prodAttrDict/qry"
                            ...
                            ravo="rainbow_fx_bj" class="table table-hover" data-show-pagination-switch="false"
                            data-card-view="false" data-side-pagination="server">
                            <thead style="">
								<tr>
									<th data-field="KEY_TP" data-visible="false" data-switchable="false">属性类型</th>
									<th data-field="KEY_TP_STR" >属性类型</th>
									<th data-field="KEY_NO" class="">
										属性
									</th>
									<th data-field="KEY_NAME" class="">
										属性名称
									</th>
									<th data-field="ENTER_TP" data-visible="false" data-switchable="false">控件类型</th>
					...
					<div class="tab-pane in" id="panel2">
					</div>
					<div class="tab-pane in" id="panel3">
					</div>
				</div>
			</div>
		</div>
