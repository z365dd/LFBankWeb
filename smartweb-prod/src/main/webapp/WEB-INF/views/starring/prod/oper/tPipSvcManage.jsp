...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipSvcManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipSvcList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="服务列表" aria-expanded="true" url="${ctx}/prod/oper/tPipSvc/tPipSvcList">
							服务列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/tPipSvc/tPipSvcAdd">
							服务添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/tPipSvc/tPipSvcUpdate">
							服务更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/tPipSvc/tPipSvcDetail">
							服务详情
						</a>
					</li>
				</ul>
