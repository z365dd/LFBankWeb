...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/cloudpayment/cloudpaymentList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">缴费项查询
						</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/prod/oper/cloudpay/payment/qry"
								...
								<thead style="">
									<tr>
										<th data-field="SALE_PROD_DESC">可售产品</th>
										<th data-field="ENTR_NAME">缴费单位</th>
										<th data-field="MOD_TLR_NO">维护用户</th>
