...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/saleprod/tPipSaleProdDetailForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="addForm" style="margin-top:10px;">
				<input id="saleProdCode" name="saleProdCode" class="form-control " type="hidden" ></input>
				<input id="atomProdJson" name="atomProdJson" class="form-control " type="hidden" ></input>
				<input id="prodLineName" name="prodLineName" class="form-control " type="hidden" ></input>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-8 column">
						<div id="descDiv">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<input id="saleProdDesc" name="saleProdDesc" class="form-control "  readonly>
									</input>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<input id="longRmrk" name="longRmrk" class="form-control "  readonly>
									</input>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<sys:treeselect id="brchId" name="brchId" value="brchIdValue"
													...
													allow_clear="true" css_class="form-control input-small" treesearch_required="true" disabled="disabled">
									</sys:treeselect>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<select data-role="multiselect" id="prodLineCode" class="" name="prodLineCode" data-max-height="300"
													data-enable-filtering="true" data-enable-full-value-filtering="true" data-filter-placeholder="搜索" checkBtn="prodLineCode">
										<option value="">
											请选择
										</option>
									</select>
						...
						<div id="colDiv" style="display:none">
							<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4 btn-group">
											<select data-role="multiselect" id="compNo" class="" name="compNo" check-empty="true" data-max-height="300" 
														data-enable-filtering="true" data-enable-full-value-filtering="true" data-filter-placeholder="搜索" checkBtn="compNo">
											<option value="">
												请选择
											</option>
										</select>
								...
								<div class="col-md-4 column" >
									<div ravo="rainbow_fx" class="form-group">
										<label for="inputEmail3" class="col-sm-3 control-label" style="padding-left:1%;">
												原子产品 </label>
										<div class="col-sm-4 btn-group">
											<select data-role="multiselect" id="atomProdCode" class="" name="atomProdCode" data-max-height="300" 
														data-enable-filtering="true" data-enable-full-value-filtering="true" data-filter-placeholder="搜索" checkBtn="atomProdCode">
											<option value="">
												请选择
											</option>
										</select>
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									...
									<div class="col-sm-7">
										<table id="table" data-toggle="table" data-first-load="false"
											...
											<thead style="">
												<tr>
													<th data-field="compNo" data-visible="false">组件号</th>
													<th data-field="compName">组件</th>
													<th data-field="atomProdCode" data-visible="false">原子产品号</th>
													<th data-field="atomProdDesc">原子产品名</th>
													<th data-field="action" data-visible="false">操作</th>
												</tr>
											</thead>
										</table>
									</div>
						...
						<div id="imgDiv">
							<div ravo="rainbow_fx" class="form-group" id="">
								<div class="col-md-4 column">
									<label class="control-label col-sm-6 control-label">
										可售产品图片 </label>
