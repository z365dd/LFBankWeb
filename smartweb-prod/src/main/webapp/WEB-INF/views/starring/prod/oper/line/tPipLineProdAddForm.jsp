...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/line/tPipLineProdAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group" style="display:none">
							...
							<div class="col-sm-3">
								<input id="prodLineCode" name="prodLineCode" class="form-control " readonly="readonly">
								</input>
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-3">
								<input id="prodLineName" name="prodLineName" class="form-control "  check-empty="true" check-minlength="1"
									maxlength="40">
								</input>
							</div>
						</div>
