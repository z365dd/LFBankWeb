...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipSvcList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<select id="compNo" name="compNo" data-role="multiselect" data-url="${ctx}/prod/enums/selectCompData?type=" blank-item="true" blank-text="--请选择--" data-max-height="300"
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="svcCode" name="svcCode" class="form-control "  >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="tPipSvcTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/prod/oper/tPipSvc/list" ravo="rainbow_fx_bj"
...
<%--								<th data-field="compNo" data-title="组件号的值" data-visible="false" data-switchable="false">组件号的值</th>--%>
								<th data-field="compNo" data-title="组件号">组件号</th>
								<th data-field="compNoStr" data-title="组件名称">组件名称</th>
								<th data-field="svcCode" data-title="服务码">服务码</th>
								<th data-field="svcName" data-title="服务名称">服务名称</th>
								<th data-field="openStat" data-title="状态">状态</th>
