...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/info/tPipOrdInfoList.js"
	charset="utf-8"></script>
			...
			<div class="col-md-12 column">
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
					<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix"
								...
								<div class="col-md-12 column">
										...
										<div class="col-md-5 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-3 control-label">
													缴费产品 </label>
												<div class="col-sm-5">
													<select data-role="multiselect" id="saleProdCode" class=""
														name="saleProdCode" data-max-height="300"
										...
										<div class="col-md-5 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-3 control-label">
													缴费号 </label>
												<div class="col-sm-5">
													<input id="payNo" name="payNo" class="form-control "
														maxlength="30"> </input>
												</div>
											</div>
										</div>
									...
									<div ravo="rainbow_fx_layout" class="row clearfix">
										<div class="col-md-5 column">
											<div ravo="rainbow_fx" class="form-group">
												<label id="lab_str_time" for="inputEmail3"
													class=" control-label col-sm-3 control-label"> 开始时间
												</label>
												<div class="input-group-sm col-sm-5">
													<input type="text" readonly="readonly" maxlength="20"
														...
														data-link-field="val_str_time" id="str_time"
														onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd HH:mm:ss',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: false,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('str_time');}});"
														onchange="writeDateValue('str_time');"> <input
														type="hidden" id="val_str_time" name="str_time" value="">
												</div>
											</div>
										</div>
										<div class="col-md-5 column">
											<div ravo="rainbow_fx" class="form-group">
												<label id="lab_end_time" for="inputEmail3"
													class=" control-label col-sm-3 control-label"> 结束时间
												</label>
												<div class="input-group-sm col-sm-5">
													<input type="text" readonly="readonly" maxlength="20"
														class="form-control input-mini Wdate" value=""
														...
														datetime-is-show-today="false" datetime-default-value=""
														datetime-value-fmt="yyyyMMddHHmmss"
														data-link-field="val_end_time" id="end_time"
														onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd HH:mm:ss',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: false,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('end_time');}});"
										...
										<div class="col-md-2 column">
											...
											<div class="col-md-6 column">
											<shiro:haspermission name="anno">
												<button id="expBtn" ravo="rainbow_fx" type="button"
													class="btn btn-info" data-original-title="" title="">
													导出</button>
											</shiro:haspermission>
											</div>
						...
						<table class="table table-hover" id="tPipOrdInfoTable"
							data-side-pagination="server" data-toggle="table"
							data-url="${ctx}/prod/oper/cloudpay/info/list"
							...
							data-first-load="false">
							<thead>
								<tr>
									<th data-field="ordNo" data-title="订单号">订单号</th>
									<th data-field="custName" data-title="客户名称"
										data-visible="false">客户名称</th>
									<th data-field="payNo" data-title="缴费号">缴费号</th>
									<th data-field="saleProdDesc" data-title="可售产品名称">可售产品名称</th>
									<th data-field="ordAmt" data-title="订单金额">订单金额</th>
									<!-- <th data-field="tranStat" data-title="交易状态">交易状态</th> -->
									<th data-field="tranStatStr" data-title="交易状态">交易状态</th>
									<th data-field="tranTime" data-title="交易时间">交易时间</th>
