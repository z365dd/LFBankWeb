...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/payinfo/tPipPayInfoList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="payNo" name="payNo" class="form-control "  maxlength="30" >
											</input>
										</div>
									</div>
								</div>
											...
											<div ravo="rainbow_fx" class="form-group">
												...
												<div class="input-group-sm col-sm-4">
													<input type="text" readonly="readonly" maxlength="20"
														...
														datetime-skin="twoer" datetime-date-fmt="yyyy-MM-dd HH:mm:ss"
														...
														datetime-value-fmt="yyyyMMddHHmmss" data-link-field="val_str_time"
														id="str_time"
					...
					<table class="table table-hover" id="tPipPayInfoTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/prod/oper/cloudpay/payinfo/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="custName" data-title="客户名称">客户名称</th>
								<th data-field="ordAmt" data-title="缴费金额">缴费金额</th>
