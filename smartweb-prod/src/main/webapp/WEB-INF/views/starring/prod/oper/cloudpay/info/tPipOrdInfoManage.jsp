...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/info/tPipOrdInfoManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipOrdInfoList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="订单信息列表" aria-expanded="true" url="${ctx}/prod/oper/cloudpay/info/tPipOrdInfoList">
							订单信息列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/info/tPipOrdInfoAdd">
							订单信息添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/info/tPipOrdInfoUpdate">
							订单信息更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/info/tPipOrdInfoDetail">
							订单信息详情
						</a>
					</li>
				</ul>
