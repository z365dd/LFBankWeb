...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/atom/tPipAtomProdDetailForm.js" charset="utf-8"></script>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="atomProdDesc" name="atomProdDesc" readonly>
								</div>
							</div>
						</div>
						...
						<div class="col-md-7 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7 btn-group">
									<select data-role="multiselect" id="compNo" class="" name="compNo" check-empty="true" data-max-height="300" data-button-width="300"
