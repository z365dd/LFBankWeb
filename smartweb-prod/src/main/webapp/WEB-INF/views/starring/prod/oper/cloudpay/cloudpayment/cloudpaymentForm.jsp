...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/cloudpayment/cloudpaymentForm.js"
	charset="utf-8"></script>
...
<link
	href="/smartweb/b_base/jquery-ztree/3.5.12/css/zTreeStyle/zTreeStyle.min.css"
	rel="stylesheet" type="text/css" />
<script
	src="/smartweb/b_base/jquery-ztree/3.5.12/js/jquery.ztree.all-3.5.min.js"
	type="text/javascript"></script>
			...
			<div class="col-md-12 column">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl=""
					...
					<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
						<div class="panel-heading">
							<div ravo="rainbow_fx_bj">
								<h4 contenteditable="false">公共参数</h4>
							</div>
						</div>
						<div class="panel-body" contenteditable="false">
							<div ravo="rainbow_fx_layout" class="row clearfix" id="needDiv">
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<select data-role="multiselect" id="BUSI_NO" class="" name="BUSI_NO" data-max-height="300"
												data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" 
												data-filter-placeholder="搜索">
												<option value="">
													请选择
					...
					<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
						<div class="panel-heading">
							<div ravo="rainbow_fx_bj">
								<h4 contenteditable="false">层级参数</h4>
							</div>
						</div>
						<div class="panel-body" contenteditable="false">
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										<label for="inputEmail3"
											class="col-sm-5 control-label control-label">节点树 </label>
										<div class="col-sm-7">
								...
								<div class="col-md-6 column">
									<div id="ztreeDataDiv">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="btn-group col-sm-5">
												<input type="text" class="form-control" placeholder=""
													id="PROJ_NAME" name="PROJ_NAME" check-empty="true">
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class="  col-sm-3 control-label">
											...
											<div class="btn-group col-sm-5">
												<input type="text" class="form-control" placeholder=""
													id="PROJ_NO" name="PROJ_NO" check-empty="true">
											</div>
										</div>
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class="  col-sm-3 control-label">
												是否输入金额</label>
											<div class="btn-group col-sm-5">
												<select data-role="multiselect" id="IF_AMT" class=""
													name="IF_AMT" data-max-height="300">
													<option value="N" checked>否</option>
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="btn-group col-sm-5">
												<input type="text" class="form-control" placeholder=""
													id="AMT" name="AMT" check-empty="true">
											</div>
										</div>
									</div>
									<div ravo="rainbow_fx" class="form-group" id="btnDiv">
										<label for="inputEmail3" class="  col-sm-3 control-label"></label>
										<div class="btn-group col-sm-3">
											<shiro:haspermission name="anno">
												<button ravo="rainbow_fx" type="button"
													class="btn btn-default" contenteditable="false"
													id="addNodeBtn">增加</button>
											</shiro:haspermission>
										</div>
										<div class="btn-group col-sm-3">
											<shiro:haspermission name="anno">
					...
					<div id="reviceMsgDiv">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-6 column">
								<div ravo="rainbow_fx" class="form-group">
									<label class="col-sm-5 control-label">上次维护用户</label>
									<div class="input-group-sm  col-sm-4">
										<input type="text" class="form-control" placeholder=""
											id="MOD_TLR_NO" name="MOD_TLR_NO" readonly>
									</div>
								</div>
							</div>
							<div class="col-md-6 column">
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" placeholder=""
											id="MOD_DT" name="MOD_DT" readonly>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<shiro:haspermission name="anno">
										<button ravo="rainbow_fx" type="button"
											class="btn btn-primary " contenteditable="false" id="addBtn">确认</button>
									</shiro:haspermission>
								</div>
							</div>
						</div>
