...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/prodAttrForm.js"
	charset="utf-8"></script>
<script type="text/javascript"
		...
		<div ravo="rainbow_fx_layout" class="row clearfix">
			<div class="col-md-12 column">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl=""
					...
					<input type="hidden" class="form-control" placeholder="" id="OPEN_STAT" name="OPEN_STAT">
					<div>
						<div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-6 column">
								<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" placeholder=""
													id="COMP_NO" name="COMP_NO" check-empty="true" maxlength="6"oninput = "value=value.replace(/[^\d]/g,'')"
													check-fixedLength="6">
											</div>
										</div>
								...
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3"
										class="col-sm-5 control-label control-label"> 组件类型</label>
									<div class="col-sm-4">
										<select data-role="multiselect" id="PROD_COMP_TP" name="PROD_COMP_TP" data-url="${ctx}/sys/dict/selectData?type=PROD_COMP_TP" data-max-height="300" blank-item="true" data-async="true"
												data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索" checkbtn="PROD_COMP_TP">
										</select>
									</div>
								</div>
								<div ravo="rainbow_fx" class="form-group">
...
<%--											name="KEY_TP" data-max-height="300" >--%>
<%--											<option value="">请选择</option>--%>
<%--											<option value="02">技术KV属性</option>--%>
<%--											<option value="03">技术关联属性</option>--%>
<%--										</select>--%>
										<select data-role="multiselect" id="KEY_TP" name="KEY_TP" data-url="${ctx}/prod/oper/prodAttr/selectData?type=KEY_TP" data-max-height="300" blank-item="true" data-async="true"
						...
						<div ravo="rainbow_fx_layout_panel" class="panel panel-default"
							...
							<div class="panel-heading">
								<div ravo="rainbow_fx_bj">
									<h4 contenteditable="false">技术KV属性</h4>
								</div>
							</div>
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-12 column" style="margin-left: 4.3%">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<h5>此url必须为具体交易的新增、修改、详情页面的url</h5>
											</div>
										</div>
									</div>
								</div>
