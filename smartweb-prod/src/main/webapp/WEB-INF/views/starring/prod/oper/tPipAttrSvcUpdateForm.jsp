...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/tPipAttrSvcUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tPipAttrSvcForm" style="margin-top:10px;">
				<input id="rowPara" name="rowPara" class="form-control " type="hidden" ></input>
				<input id="rowScen" name="rowScen" class="form-control " type="hidden" ></input>
				<input id="temp1" name="temp1" class="form-control " type="hidden" ></input>
				<input id="temp2" name="temp2" class="form-control " type="hidden" ></input>
				<input id="svcDesc" name="svcDesc" class="form-control " type="hidden" ></input>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="compNo" class="" name="compNo" data-max-height="300"
										data-enable-filtering="true" data-enable-full-value-filtering="true" data-filter-placeholder="搜索">
									<option value="">
										请选择
									</option>
								</select>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="svcCode" class="" name="svcCode" data-max-height="300"
										data-enable-filtering="true" data-enable-full-value-filtering="true" data-filter-placeholder="搜索">
									<option value="">
										请选择
									</option>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="svcName" name="svcName" class="form-control "  check-empty="true" readonly="readonly">
								</input>
							</div>
						</div>
					</div>
					...
					<%--							</label>--%>
					<%--							<div class="col-sm-4">--%>
					<%--								<input id="svcDesc" name="svcDesc" class="form-control "  check-empty="true" readonly="readonly">--%>
					<%--								</input>--%>
					<%--							</div>--%>
					<%--						</div>--%>
					<%--					</div>--%>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
                                <select id="signFlg" name="signFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=SWITCH_FLG" blank-item="true" blank-text="--请选择--" checkbtn="signFlg" >
                                </select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
                                <select id="othConnFlg" name="othConnFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=SWITCH_FLG" blank-item="true" blank-text="--请选择--" checkbtn="othConnFlg" >
                                </select>
							</div>
						</div>
					</div>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="chkFlg" name="chkFlg" class="form-control "  check-empty="true" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="shortRmrk" name="shortRmrk" class="form-control "  check-empty="true" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="midRmrk" name="midRmrk" class="form-control "  check-empty="true" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="longRmrk" name="longRmrk" class="form-control "  check-empty="true" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
...
<%--							</label>--%>
<%--							<div class="col-sm-4">--%>
<%--								<input id="dac" name="dac" class="form-control "  check-empty="true" >--%>
<%--								</input>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
<%--				</div>--%>
				...
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default"
					...
					<div class="panel-heading">
						<div ravo="rainbow_fx_bj">
							<h5 contenteditable="false">选择属性</h5>
						</div>
					</div>
					<div class="panel-body" contenteditable="false">
						<div ravo="rainbow_fx_layout" class="row clearfix">
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">产品KV属性</label>
									<div class="col-sm-4 btn-group">
										<select data-role="multiselect" id="KEY_NO" class="" name="KEY_NO" data-max-height="300"
												data-enable-filtering="true" data-enable-full-value-filtering="true" data-filter-placeholder="搜索">
											<option value="">
												请选择
											</option>
						...
						<div ravo="rainbow_fx_layout" class="row clearfix"
							...
							<div class="col-md-12 column">
								<div ravo="rainbow_fx_layout" class="row clearfix">
									...
									<div class="col-sm-7">
										<table id="attrTable" data-toggle="table" data-first-load="false"
				...
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default"
					...
					<div class="panel-heading">
						<div ravo="rainbow_fx_bj">
							<h5 contenteditable="false">配置场景</h5>
						</div>
					</div>
					<div class="panel-body" contenteditable="false">
						<div ravo="rainbow_fx_layout" class="row clearfix">
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">场景编号</label>
									<div class="col-sm-4 btn-group">
										<input id="sceneNo" name="sceneNo" class="form-control "  >
										</input>
									</div>
								</div>
							</div>
							<div class="col-md-4 column" >
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label" style="padding-left:1%;">场景名称</label>
									<div class="col-sm-4 btn-group">
										<input id="sceneName" name="sceneName" class="form-control "  >
										</input>
									</div>
								</div>
							</div>
						...
						<div ravo="rainbow_fx_layout" class="row clearfix">
							...
							<div class="col-md-4 column">
								<div ravo="rainbow_fx" class="form-group">
									<label for="inputEmail3" class="col-sm-3 control-label">场景描述</label>
									<div class="col-sm-4 btn-group">
										<input id="sceneDesc" name="sceneDesc" class="form-control "  >
										</input>
									</div>
								</div>
							</div>
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									...
									<div class="col-sm-7">
										<table id="table" data-toggle="table" data-first-load="false"
											...
											<thead style="">
											<tr>
												<th data-field="sceneNo">场景编号</th>
												<th data-field="sceneName">场景名称</th>
												<th data-field="sceneDesc">场景描述</th>
												<th data-field="action">操作</th>
											</tr>
											</thead>
										</table>
