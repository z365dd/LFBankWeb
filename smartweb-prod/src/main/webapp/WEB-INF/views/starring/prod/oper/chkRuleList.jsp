...
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/chkRuleList.js"
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">对账规则查询 </a></li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2"> 对账规则修改</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-5 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<%-- <select data-role="multiselect" id="busiNo" class=""
													data-async="true" name="busiNo" data-max-height="300"
													checkbtn="busiNo"
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/prod/oper/ruleRelat/list"
								...
								<thead style="">
									<tr>
										...
										<th data-field="ruleId">对账规则编号</th>
