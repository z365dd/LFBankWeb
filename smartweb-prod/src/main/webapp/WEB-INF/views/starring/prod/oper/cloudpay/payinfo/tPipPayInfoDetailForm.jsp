...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/payinfo/tPipPayInfoDetailForm.js" charset="utf-8"></script>
			...
			id="tPipPayInfoForm" style="margin-top:10px;">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="custName" name="custName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
						<!-- <div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="ser" name="ser" class="form-control  digits"  maxlength="18" readonly="readonly" >
								</input>
							</div>
						</div> -->
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="projNo" name="projNo" class="form-control "  maxlength="30" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="infoData" name="infoData" class="form-control "  maxlength="5" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
