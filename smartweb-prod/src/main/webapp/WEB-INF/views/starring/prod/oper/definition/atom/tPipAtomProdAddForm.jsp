...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/atom/tPipAtomProdAddForm.js" charset="utf-8"></script>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7 btn-group">
									<select data-role="multiselect" id="compNo" class="" name="compNo" check-empty="true" data-max-height="300" data-button-width="300"
									 ...
									 data-filter-placeholder="搜索" checkBtn="compNo">
									<option value="">
										请选择
									</option>
								</select>
