...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/adapter/tPipSaleProdAdapterAddForm.js" charset="utf-8"></script>
			...
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal breadcrumb" pourl=""
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-9 column">
							...
							<div class="col-md-9 column">
								...
								<div class="col-sm-3">
									<select data-role="multiselect" id="valTp" name="valTp"
											...
											data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索" 
											data-max-height="300"
						...
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-top:20px" id="vslFlgValue" name="vslFlgValue">
							<div class="col-md-2 column"></div>
							<div class="col-md-9 column">
								<label for="inputEmail3" class="col-sm-2 control-label">
									是否隐藏
