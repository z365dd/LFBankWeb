...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/payconf/payFaceConfManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="payFaceConfList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="缴费界面配置列表" aria-expanded="true" url="${ctx}/prod/oper/cloudpay/payconf/payFaceConf/payFaceConfList">
							缴费界面配置列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/payconf/payFaceConf/payFaceConfAdd">
							缴费界面配置添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/payconf/payFaceConf/payFaceConfUpdate">
							缴费界面配置更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/payconf/payFaceConf/payFaceConfDetail">
							缴费界面配置详情
						</a>
					</li>
				</ul>
