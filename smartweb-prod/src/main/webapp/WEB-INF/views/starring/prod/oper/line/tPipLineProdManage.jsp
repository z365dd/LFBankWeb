...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/line/tPipLineProdManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tPipLineProdList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="产品线列表" aria-expanded="true" url="${ctx}/prod/oper/line/tPipLineProd/tPipLineProdList">
							产品线列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/line/tPipLineProd/tPipLineProdAdd">
							产品线添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/line/tPipLineProd/tPipLineProdUpdate">
							产品线更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/line/tPipLineProd/tPipLineProdDetail">
							产品线详情
						</a>
					</li>
				</ul>
