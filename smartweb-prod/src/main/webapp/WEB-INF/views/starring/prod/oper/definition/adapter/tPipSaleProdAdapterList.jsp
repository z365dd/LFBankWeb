...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/adapter/tPipSaleProdAdapterList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
					...
					<table class="table table-hover" id="tPipSaleProdAdapterTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/prod/oper/definition/adapter/tPipSaleProdAdapter/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								<th data-field="prodLineName">产品线</th>
								<th data-field="saleProdCode">可售产品编号</th>
								<th data-field="saleProdDesc">可售产品名称</th>
