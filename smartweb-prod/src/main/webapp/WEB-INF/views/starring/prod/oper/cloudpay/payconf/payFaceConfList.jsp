...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/payconf/payFaceConfList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
					...
					<table class="table table-hover" id="payFaceConfTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/prod/oper/cloudpay/payconf/payFaceConf/list" ravo="rainbow_fx_bj"
						data-height="" data-undefined-text="" data-pagination="true" data-striped="true"
						data-single-select="true" data-query-params="queryParams" data-first-load="true" data-method="post"
						data-content-type="application/x-www-form-urlencoded" data-height="600"
						>
						<thead>
							<tr>
								<th data-field="saleProdCode" data-title="可售产品编号">
									可售产品编号
								</th>
								<th data-field="saleProdDesc" data-title="可售产品名称">
									可售产品名称
								</th>
								<th data-field="qrySvcName" data-title="查询服务">
									查询服务
								</th>
								<th data-field="paySvcName" data-title="缴费服务">
									缴费服务
								</th>
