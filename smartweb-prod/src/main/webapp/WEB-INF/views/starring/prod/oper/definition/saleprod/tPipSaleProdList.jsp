...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/saleprod/tPipSaleProdList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input id="saleProdDesc" name="saleProdDesc" class="form-control "  >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="tPipSaleProdTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/prod/oper/definition/saleprod/tPipSaleProd/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="saleProdCode" data-title="可售产品代码">可售产品代码</th>
								<th data-field="saleProdDesc" data-title="可售产品描述">可售产品名称</th>
								<th data-field="prodLineCode" data-title="产品线编号">产品线编号</th>
								<th data-field="prodLineName" data-title="产品线名称">产品线名称</th>
