...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/saleprod/tPipSaleProdUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tPipSaleProdForm" style="margin-top:10px;">
					...
					<div class="col-md-8 column">
						<div id="descDiv">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<input id="saleProdDesc" name="saleProdDesc" class="form-control "  check-empty="true" check-minlength="1"
									maxlength="120">
									</input>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<input id="longRmrk" name="longRmrk" class="form-control "  check-empty="true" check-minlength="1"
										   maxlength="80">
									</input>
								</div>
							</div>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-5">
									<input id="prodLineCode" name="prodLineCode" type="hidden">
									</input>
									<select data-role="multiselect" id="prodLine" class="" name="prodLine" data-max-height="300"
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4 btn-group">
											<select data-role="multiselect" id="atomProdCode" class="" name="atomProdCode" data-max-height="300" 
													data-enable-filtering="true" data-enable-full-value-filtering="false" data-enable-case-insensitive-filtering="true" data-filter-placeholder="搜索" checkBtn="atomProdCode">
											<option value="">
												请选择
											</option>
										</select>
