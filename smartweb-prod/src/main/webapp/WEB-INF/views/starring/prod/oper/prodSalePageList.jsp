...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/prod/oper/prodSalePageList.js"
	charset="utf-8"></script>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/prod/oper/prodSalePage/qry"
								...
								<thead style="">
									<tr>
										<th data-field="PROD_LINE_NAME">产品线</th>
										<th data-field="SALE_PROD_CODE">可售产品编号</th>
										<th data-field="SALE_PROD_DESC">可售产品名称</th>
