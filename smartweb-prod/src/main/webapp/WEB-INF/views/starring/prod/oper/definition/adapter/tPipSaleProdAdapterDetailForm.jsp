...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/adapter/tPipSaleProdAdapterDetailForm.js" charset="utf-8"></script>
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-5">
								<select data-role="multiselect" id="prodLineCode" class="" name="prodLineCode" data-max-height="300"
												data-enable-filtering="true" data-enable-full-value-filtering="false" data-filter-placeholder="搜索" checkBtn="prodLineCode">
									<option value="">
										请选择
									</option>
								</select>
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-5">
								<select data-role="multiselect" id="saleProdCode" class="" name="saleProdCode" data-max-height="300"
												data-enable-filtering="true" data-enable-full-value-filtering="false" data-filter-placeholder="搜索" checkBtn="saleProdCode">
									<option value="">
										请选择
									</option>
								</select>
