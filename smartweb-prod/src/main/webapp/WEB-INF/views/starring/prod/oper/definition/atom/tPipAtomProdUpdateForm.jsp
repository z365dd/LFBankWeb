...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/definition/atom/tPipAtomProdUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tPipAtomProdForm" style="margin-top:10px;">
				<div id="commonDiv">
					<input type="hidden" class="form-control" placeholder="" id="data" name="data">
					<input type="hidden" class="form-control" placeholder="" id="id" name="atomProdCode">
						...
						<div class="col-md-7 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									...
									style="visibility: visible"> 原子产品名 </label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="atomProdDesc" name="atomProdDesc" check-empty="true" check-minlength="1"
									maxlength="120">
								</div>
							</div>
						</div>
						...
						<div class="col-md-7 column">
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7 btn-group">
									<select data-role="multiselect" id="compNoSelect" class="" name="compNoSelect" check-empty="true" data-max-height="300" data-button-width="300"
						...
						<div class="col-md-7 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									场景服务 </label>
								<div class="col-sm-7 btn-group ">
									<select data-role="multiselect" id="svcCode" class="" name="svcCode" check-empty="true" data-max-height="300"  data-button-width="300"
