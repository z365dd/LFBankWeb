...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/prod/oper/cloudpay/pay/payManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="payIndex" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="产品线列表" aria-expanded="true" url="${ctx}/prod/oper/cloudpay/pay/payIndex">
							缴费信息
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/prod/oper/cloudpay/pay/payConfirm">
							确认缴费
						</a>
					</li>
					<li>
