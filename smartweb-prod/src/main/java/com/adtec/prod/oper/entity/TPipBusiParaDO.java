 ...
 * @version 20200114
 */
public class TPipBusiParaDO extends BaseDO {
	...
	public TPipBusiParaDO() {
		super();
	}

	public TPipBusiParaDO(String id){
		super(id);
	}
