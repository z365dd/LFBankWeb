 ...
 * @version 20200114
 */
public class TPipClrMertFeeRuleDO extends BaseDO {
	...
	public TPipClrMertFeeRuleDO() {
		super();
	}

	public TPipClrMertFeeRuleDO(String id) {
		super(id);
	}
	...
	public String toString() {
		return "ClrMertFeeRuleDO [ruleId=" + ruleId + ",ruleName=" + ruleName + ",clrMeth=" + clrMeth + ",clrDimTp="
