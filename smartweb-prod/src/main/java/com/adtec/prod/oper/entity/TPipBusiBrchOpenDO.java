 ...
 * @version 20200310
 */
public class TPipBusiBrchOpenDO extends BaseDO {
	...
	public TPipBusiBrchOpenDO() {
		super();
	}

	public TPipBusiBrchOpenDO(String id){
		super(id);
	}
