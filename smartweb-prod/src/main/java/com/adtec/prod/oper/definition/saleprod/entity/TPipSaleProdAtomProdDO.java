/**
* 系统名称: SmartWeb平台
* 模块名称: comp-prod/oper/saleprod/的实体类模块
* 功能描述: 可售产品-原子产品关联数据定义
* 类 名 称  : TPipSaleProdAtomProdDO.java
* 软件版权: 北京先进数通信息技术股份公司
* 开发人员: chenyl <br>
* 开发时间: 20200106<br>
* 系统版本: V1.0.0<br>
 ...
 * @version 20200106
 */
public class TPipSaleProdAtomProdDO extends BaseDO {
	...
	public TPipSaleProdAtomProdDO() {
		super();
	}

	public TPipSaleProdAtomProdDO(String id){
		super(id);
	}
	...
	public String toString() {
		...
		sb.append("TPipSaleProdAtomProdDO [ ");
