...
/*查询明细*/
function getDetail(chnlNo){
	console.info('get ctrlTParaChnl info......');
	$.post(ctx + "/comp/ctrl/oper/ctrlTParaChnl/get", {chnlNo:chnlNo}, function(data){
