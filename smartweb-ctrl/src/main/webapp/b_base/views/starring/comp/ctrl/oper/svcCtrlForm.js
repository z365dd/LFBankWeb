...
$(function(){
	/*加载模型下拉框的数据*/
	//setSelect1("COMP_NO","/comp/ctrl/oper/svccode/getModlNo","COMP_NO","COMP_NAME",null,IF_ASYNC);
	setCompNoS("COMP_NO",IF_ASYNC,true);
	
	//服务码
	setSvcCodeS("COMP_NO","SVC_CODE",IF_ASYNC);
	//svcCodeS("COMP_NO","SVC_CODE",IF_ASYNC);
...
//设置值
function setData(compNo,svcCode,stat){
	setS('COMP_NO',compNo);
	$("#COMP_NO").change();
