...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiBrchOpenUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTPipBusiBrchOpenForm" style="margin-top:10px;">
				<input type="hidden" value="" name="busiNo" id="HID_busiNo"/>
				<input type="hidden" value="" name="ORI_brch" id="HID_brch"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="busiNo"  data-role="multiselect" data-max-height="300" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getBusiNo" data-async="true" blank-item="true" blank-text="--请选择--" checkbtn="busiNo" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="brch"  name="brch" data-role="multiselect" data-max-height="300" data-url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/getBrchNo" data-async="true" blank-item="true" blank-text="--请选择--" checkbtn="brch" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
