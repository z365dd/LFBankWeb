...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/pubpara/fCtrlMngPubPara.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						...
						title="公用参数维护" aria-expanded="true" url="${ctx }/comp/ctrl/oper/pubpara/toMod">
							公用参数维护
						</a>
					</li>
					<li>
						<a id="tab2" href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/oper/pubpara/toMod">
							公用参数维护
						</a>
					</li>
				</ul>
