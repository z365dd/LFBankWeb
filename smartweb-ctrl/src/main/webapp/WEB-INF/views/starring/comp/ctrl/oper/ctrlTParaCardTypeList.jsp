...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaCardTypeList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<select id="cardTp" name="cardTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CARD_TP" blank-item="true" blank-text="--请选择--">
											</select>
										</div>
									</div>
								</div>
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input id="cardTpName" name="cardTpName" class="form-control " >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="ctrlTParaCardTypeTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/comp/ctrl/oper/ctrlTParaCardType/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="cardBinNo" data-title="卡BIN号">卡BIN号</th>
								<th data-field="cardTp" data-title="卡类型" data-visible="false" data-switchable="false">卡类型的值</th>
								<th data-field="cardTpStr" data-title="卡类型">卡类型</th>
								<th data-field="acctCardFlg" data-title="账号卡号标志">账号卡号标志</th>
								<th data-field="intOutBankFlg" data-title="内外部行号标志">内外部行号标志</th>
								<th data-field="legaNo" data-title="法人号" data-visible="false" data-switchable="false">法人号的值</th>
								<th data-field="legaNoStr" data-title="法人号">法人号</th>
								<th data-field="cardTpName" data-title="卡类型名称">卡类型名称</th>
