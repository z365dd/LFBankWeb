...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/compParaList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">组件参数查询
						</a></li>
					...
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/comp/ctrl/oper/compPara/action"
								...
								<thead style="">
									<tr>
										...
										<th data-field="KEY_NUM">KEY个数</th>
										<!-- <th data-field="KV">KEY</th>
										<th data-field="KEY_NO">KEY值</th> -->
