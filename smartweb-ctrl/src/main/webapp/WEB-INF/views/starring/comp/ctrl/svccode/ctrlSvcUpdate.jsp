...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/svccode/ctrlSvcUpdate.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="服务名" id="svcCode"
								name="svcCode"  disabled="disabled">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="服务名" id="svcName"
								name="svcName" check-empty="true">
							</div>
						</div>
					</div>
				</div>
...
/* var COMP_NO = getI("dis_compNo");
var COMP_NAME = getI("dis_compName");
