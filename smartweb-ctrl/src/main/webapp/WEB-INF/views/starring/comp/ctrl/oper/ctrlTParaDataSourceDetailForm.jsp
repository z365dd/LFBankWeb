...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaDataSourceDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaDataSourceForm" style="margin-top:10px;">
				<input type="hidden" value="" name="dataSrc" id="HID_dataSrc" style="">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-6 control-label control-label">
								数据源
							</label>
							<div class="col-sm-4">
								<input id="dataSrc" name="dataSrc" class="form-control" maxlength="20"
								readonly="readonly">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="dataSrcName" name="dataSrcName" class="form-control " maxlength="256"
								readonly="readonly">
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="dbTp" name="dbTp" data-role="multiselect" checkbtn="dbTp" class="">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-5">
								<input id="dataSrcAddr" name="dataSrcAddr" class="form-control" maxlength="240"
								readonly="readonly">
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="dbUserName" name="dbUserName" class="form-control" maxlength="256"
								readonly="readonly">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="dbPwd" name="dbPwd" class="form-control " maxlength="80" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
