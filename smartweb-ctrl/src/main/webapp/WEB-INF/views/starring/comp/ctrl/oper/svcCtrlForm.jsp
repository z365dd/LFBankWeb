...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/svcCtrlForm.js"
	charset="utf-8"></script>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<select data-role="multiselect" id="STAT" class="" name="STAT"
										data-max-height="300" checkbtn="STAT">
										<option value="">请选择</option>
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<select data-role="multiselect" id="SVC_CODE" name="SVC_CODE"
										class="form-control" data-max-height="300" checkbtn="SVC_CODE">
										<option value="">请选择</option>
									</select>
								</div>
							</div>
