...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/switches/switchesRuleList.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-751707">
		...
		<div class="tab-content">
			<div class="tab-pane active in" id="panel1">
				...
				<table id="table" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/oper/switches/qry"
