...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/tParaTlrList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<select data-role="multiselect" id="brch" name="brch" class="" 
												 data-async="true" data-url="${ctx}/comp/ctrl/oper/tParaTlr/getBrch"
								...
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input id="tlrName" name="tlrName" class="form-control " >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="tParaTlrTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/comp/ctrl/oper/tParaTlr/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="brch" data-title="机构" data-visible="false" data-switchable="false">机构的值</th>
								<th data-field="brchStr" data-title="机构">机构</th>
								<th data-field="tlrNo" data-title="柜员号">柜员号</th>
								<th data-field="tlrName" data-title="柜员名称">柜员名称</th>
								<th data-field="flg" data-title="标志" data-visible="false" data-switchable="false">标志的值</th>
