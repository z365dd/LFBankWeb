...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaLoadDataAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="paraName" name="paraName" class="form-control " maxlength="120"
								check-empty="true">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="tabName" name="tabName" class="form-control " maxlength="120"
								check-empty="true">
							</div>
						</div>
					</div>
