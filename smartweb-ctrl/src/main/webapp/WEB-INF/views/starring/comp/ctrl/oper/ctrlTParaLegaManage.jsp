...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaLegaManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaLegaList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="法人列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaLega/ctrlTParaLegaList">
							法人列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaLega/ctrlTParaLegaAdd">
							法人添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaLega/ctrlTParaLegaUpdate">
							法人更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaLega/ctrlTParaLegaDetail">
							法人详情
						</a>
					</li>
				</ul>
