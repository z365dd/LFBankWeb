...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/channel/tParaChnlList.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="column col-md-4">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-6">
								<select data-role="multiselect" id="CHNL_NO" name="CHNL_NO" class="form-control" data-max-height="300">
								</select>
							</div>
						</div>
					</div>
		...
		<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/oper/channel/TParaChnlQry"
		...
		data-show-header="true" data-striped="true">
			<thead style="">
				<tr>
					...
					<th data-field="CHNL_NAME">
						渠道描述
					</th>
					<th data-field="CHNL_TP">
						渠道类型
					</th>
					<th data-field="SEQ_CRT_ID">
						流水号生成器ID
					</th>
