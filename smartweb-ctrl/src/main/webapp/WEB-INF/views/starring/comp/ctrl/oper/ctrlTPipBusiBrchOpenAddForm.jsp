...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiBrchOpenAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="busiNo" name="busiNo" data-role="multiselect" data-max-height="300" data-async="true"
								data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getBusiNo" blank-item="true" blank-text="--请选择--" checkbtn="busiNo" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="brch" name="brch" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/getMulBrchNo"
								blank-item="true" blank-text="--请选择--" blank-value="" checkbtn="brch" class="" data-async="true"
								multiple="multiple" data-max-height="300">
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="flg" class="" name="flg" checkbtn="sameDbFlg">
									<option value="">
										--请选择--
									</option>
									<option value="Y">
