...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaChnlDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaChnlForm" style="margin-top:10px;">
				<input type="hidden" value="" name="chnlNo" id="HID_chnlNo"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="chnlNo" name="chnlNo" class="form-control "  maxlength="6" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="chnlName" name="chnlName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chnlStat" name="chnlStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CHNL_STAT" blank-item="true" blank-text="--请选择--" readonly="readonly">
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="chnlDesc" name="chnlDesc" class="form-control "  maxlength="360" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="brch" name="brch" data-role="multiselect" data-async="true" data-url="${ctx}/comp/ctrl/oper/tParaTlr/getBrch" blank-item="true" blank-text="--请选择--" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chnlTp" name="chnlTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CHNL_TP" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chnlFlg" name="chnlFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CHNL_FLG" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="tlrNo" name="tlrNo" data-role="multiselect" data-async="true" data-url="${ctx}/comp/ctrl/oper/tParaTlr/getTlr" blank-item="true" blank-text="--请选择--" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="relatSys" name="relatSys" data-role="multiselect" data-async="true" data-url="${ctx}/comp/ctrl/oper/ctrlTParaRelatSys/getRelatSys" blank-item="true" blank-text="--请选择--" >
								</select>
							</div>
						</div>
					</div>
