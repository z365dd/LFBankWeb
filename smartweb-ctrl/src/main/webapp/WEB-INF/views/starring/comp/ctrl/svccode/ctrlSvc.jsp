...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/svccode/ctrlSvc.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						...
						title="服务码查询" aria-expanded="true" url="${ctx }/comp/ctrl/oper/svccode/CtrlSvcList">
							服务码查询
						</a>
					</li>
					<li>
						<a id="tab2" href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/oper/svccode/toAdd">
							服务码新增
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/oper/toUpdate">
							服务码修改
						</a>
					</li>
				</ul>
