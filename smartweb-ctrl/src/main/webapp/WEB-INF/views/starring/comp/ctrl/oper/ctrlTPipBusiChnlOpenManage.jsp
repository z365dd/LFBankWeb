...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiChnlOpenManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTPipBusiChnlOpenList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="业务渠道开通列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/ctrlTPipBusiChnlOpenList">
							业务渠道开通列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/ctrlTPipBusiChnlOpenAdd">
							业务渠道开通添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/ctrlTPipBusiChnlOpenUpdate">
							业务渠道开通更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/ctrlTPipBusiChnlOpenDetail">
							业务渠道开通详情
						</a>
					</li>
				</ul>
