...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlBankList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">行名行号查询 </a></li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2">行名行号新增</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/comp/ctrl/oper/ctrlBank/action"
								...
								<thead style="">
									<tr>
										...
										<th data-field="BANK">银行号</th>
										<th data-field="APP_NAME">应用名称</th>
