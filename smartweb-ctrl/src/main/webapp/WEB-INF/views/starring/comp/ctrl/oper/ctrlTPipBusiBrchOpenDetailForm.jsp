...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiBrchOpenDetailForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="busiNo" name="busiNo" data-role="multiselect" data-max-height="300" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getBusiNo" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="brch" name="brch" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/getBrchNo" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
