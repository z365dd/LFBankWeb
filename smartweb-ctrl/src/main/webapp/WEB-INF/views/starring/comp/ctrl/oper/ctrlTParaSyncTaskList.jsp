...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaSyncTaskList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
						...
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-top:10px;">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<select id="stepNo" name="stepNo" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTParaDataSynConfig/getList" blank-item="true" blank-text="--请选择--">
											</select>
										</div>
									</div>
								</div>
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="input-group-sm col-sm-6">
											<input type="text" readonly="readonly" maxlength="20" class="form-control input-mini Wdate"
												value="" datetime-skin="twoer" datetime-date-fmt="yyyy-MM-dd"
												...
												datetime-value-fmt="yyyyMMdd" data-link-field="val_platDate"
												id="platDate" onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('platDate');}});"
												onchange="writeDateValue('platDate');">
											<input type="hidden" id="val_platDate" value="" name="platDate">
										</div>
									</div>
								</div>
								<div class="col-md-4 column">
					...
					<table class="table table-hover" id="ctrlTParaSyncTaskTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/comp/ctrl/oper/ctrlTParaSyncTask/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="stepNo" data-title="步骤号">步骤号</th>
								<th data-field="platDate" data-title="同步日期">同步日期</th>
								<th data-field="stat" data-title="处理状态" data-visible="false" data-switchable="false">处理状态的值</th>
								<th data-field="statStr" data-title="处理状态">处理状态</th>
								<th data-field="endDt" data-title="结束日期">结束日期</th>
								<th data-field="rsltMsg" data-title="处理结果">处理结果</th>
