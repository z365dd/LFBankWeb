...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/tParaTlrDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="tParaTlrForm" style="margin-top:10px;">
				<input type="hidden" value="" name="brch" id="HID_brch"/>
				<input type="hidden" value="" name="tlrNo" id="HID_tlrNo"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="brch" name="brch" data-role="multiselect" data-async="true" data-url="${ctx}/comp/ctrl/oper/tParaTlr/getBrch" blank-item="true" blank-text="--请选择--" checkbtn="brch" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="tlrNo" name="tlrNo" class="form-control "  maxlength="16" readonly="readonly">
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="tlrName" name="tlrName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="tlrLvl" name="tlrLvl" data-role="multiselect" data-async="true" data-url="${ctx}/sys/dict/selectData?type=TLR_LVL" 
								readonly="readonly" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="flg" name="flg" data-role="multiselect" data-async="true" data-url="${ctx}/sys/dict/selectData?type=TLR_FLG" 
								readonly="readonly" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
