...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/commonType.js"
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/cardTypeForm.js"
	charset="utf-8"></script>

<!-- change skin -->
<link
	href="${ctxStatic}/mainframe/${not empty cookie.theme.value ? cookie.theme.value : 'blue'}/index.css"
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="CARD_BIN_NO" name="CARD_BIN_NO" check-empty="true">
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3"
									class="col-sm-5 control-label control-label">账卡号标志</label>
								<div class="col-sm-4">
									<select data-role="multiselect" id="ACCT_CARD_FLG" class=""
										name="ACCT_CARD_FLG" data-max-height="300" checkbtn="ACCT_CARD_FLG">
							...
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-7">
									<select data-role="multiselect" id="LEGA_NO" class=""
										...
										data-async="true" blank-item=true  checkbtn="LEGA_NO">
										<option value="">请选择</option>
									</select>
								</div>
							</div>
						...
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-3 control-label">
									卡类型</label>
								<div class="col-sm-7">
									<select data-role="multiselect" id="CARD_TP" name="CARD_TP"
										class="form-control" data-max-height="300"  checkbtn="CARD_TP">
										<option value="">请选择</option>
										<option value="00">磁条借记卡</option>
										<option value="01">IC借记卡</option>
										<option value="10">磁条贷记卡</option>
										<option value="21">银联数据IC借记卡（托管IC借记卡）</option>
										<option value="31">银联数据IC贷记卡（托管IC贷记卡）</option>
									</select>
								</div>
							</div>
							<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder=""
										id="NET_NO" name="NET_NO" check-empty="true">
								</div>
							</div>
						</div>
					</div>
