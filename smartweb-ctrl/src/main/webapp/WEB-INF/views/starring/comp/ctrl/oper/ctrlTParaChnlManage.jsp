...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaChnlManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaChnlList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="渠道列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaChnl/ctrlTParaChnlList">
							渠道列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaChnl/ctrlTParaChnlAdd">
							渠道添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaChnl/ctrlTParaChnlUpdate">
							渠道更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaChnl/ctrlTParaChnlDetail">
							渠道详情
						</a>
					</li>
				</ul>
