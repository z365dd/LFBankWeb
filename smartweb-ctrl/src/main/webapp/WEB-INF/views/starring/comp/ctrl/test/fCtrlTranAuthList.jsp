...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/test/fCtrlTranAuthList.js" charset="utf-8"></script>
								...
								<div class="col-md-3 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											...
											name="TRAN_AMT">
											<input class="form-control" type="hidden" id="TRAN_AMT" name="TRAN_AMT" value="">
										</div>
									</div>
								</div>
							 </div>
