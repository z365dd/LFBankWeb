...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/relatTran/sysTestComm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column" style="margin-top:20px;">
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_885802">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="SYS_TP" name=SYS_TP class="" checkbtn="SYS_TP">
									<option value="00">
										行内系统
									</option>
									<option value="01"> 
