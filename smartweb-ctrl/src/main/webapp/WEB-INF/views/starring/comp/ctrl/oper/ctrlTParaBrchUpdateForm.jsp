...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaBrchUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaBrchForm" style="margin-top:10px;">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="brch" name="brch" class="form-control "  maxlength="20" check-empty="true" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="brchName" name="brchName" class="form-control "  maxlength="120"   >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="brchLvlNo" name="brchLvlNo" class="form-control "  maxlength="10"   >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column" id="upBrchDiv">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">
								上级机构
							</label>
							<div class="col-sm-6">
								<sys:treeselect id="upBrch" name="upBrch" value="" label_name="ctrlTParaBrch.upBrch" label_value="" 
									title="机构" url="/comp/ctrl/oper/ctrlTParaBrch/treeData?type=2" css_class="form-control input-small" allow_clear="true"   >
								</sys:treeselect>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="legaNo" name="legaNo" data-role="multiselect" data-async="true" data-url="${ctx}/comp/ctrl/oper/ctrlTParaLega/getLega" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="tntNo" name="tntNo" data-role="multiselect" data-async="true" data-url="${ctx}/comp/ctrl/oper/ctrlTParaTnt/getTnt" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="bank" name="bank" class="form-control "  maxlength="20"   >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="bankName" name="bankName" class="form-control "  maxlength="120"   >
								</input>
							</div>
						</div>
					</div>
