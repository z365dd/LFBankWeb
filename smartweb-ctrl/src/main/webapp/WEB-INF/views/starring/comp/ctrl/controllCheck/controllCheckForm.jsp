...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/controllCheck/controllCheckForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
				<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl=""
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" style="border-bottom: solid #ddd 1px;" id="commonDiv">
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" style="border-bottom: solid #ddd 1px; margin:18px 0 5px 0" id="addDiv">
						<div class="col-md-6 column">
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class="col-sm-6 control-label">
									控制类型 </label>
								<div class="col-sm-5">
									<select data-role="multiselect" id="TP_DESC" class=""
										name="TP_DESC" data-max-height="300" checkbtn="TP_DESC">
										<option value=''>请选择</option>
									</select>
								</div>
							</div>
					...
					<div ravo="rainbow_fx_layout" class="row clearfix" style="margin:10px 0 5px 0">
						<div class="col-md-6 column">
								...
								<div class="col-sm-7" >
										<table id="table" data-toggle="table" data-first-load="false"
											...
											data-pagination="false" data-search="false"
											 data-method="post"
											data-undefined-text="**" data-height="230"
											...
											<thead style="" >
												<tr>
													...
													<th data-field="CTRL_TP">控制类型</th>
													<th data-field="TP_DESC">控制名称</th>
