...
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/subsvccode/ctrlSubSvcList.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="modl" name="modl" class="form-control" data-max-height="300">
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="svcCode" name="svcCode" class="form-control" data-max-height="300">
									<option value="">
										请选择
									</option>
								</select>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-4 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="subSvcCode" name="subSvcCode" class="form-control" data-max-height="300">
									<option value="">
										请选择
									</option>
								</select>
		...
		<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/oper/subsvccode/CtrlSubSvcQry"
