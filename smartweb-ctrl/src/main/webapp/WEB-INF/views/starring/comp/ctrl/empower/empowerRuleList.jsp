...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/empower/empowerRuleList.js" charset="utf-8"></script>
...
<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-751707">
		...
		<div class="tab-content">
			<div class="tab-pane active in" id="panel1">
				...
				<table id="table" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/oper/empower/qry"
						...
						data-striped="true">
							<thead style="">
								<tr>
									...
									<th data-field="AUTH_METH">
										授权模式
									</th>
									<th data-field="EXPR_DESC">
										规则中文描述
									</th>
									<th data-field="EXPR" data-visible="false">
										授权规则定义
									</th>
									<th data-field="TRANL_EXPR" data-visible="false">
										规则翻译
									</th>
									<th data-field="TP_SHORT_NUM" data-visible="false">
										循环个数
									</th>
									<th data-field="AUTH_AMT_LIST_STR" data-visible="false">
										循环
									</th>
