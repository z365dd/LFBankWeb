...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaSyncTaskForm.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="navigations">
				...
				<div class="tab-content">
					<div class="tab-pane active in" id="tab1">
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_338934">
							<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-top:20px;">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7 btn-group col-sm-5">
											<select id="stepNo" name="stepNo" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTParaDataSynConfig/getList"
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="input-group-sm  col-sm-4">
											...
											data-link-field="val_platDate" id="platDate" onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('platDate');}});"
