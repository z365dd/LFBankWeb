...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/channel/tParaChnlMod.js" charset="utf-8"></script>
					...
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-3">
								...
								name="CHNL_NO" readonly="readonly" value="${CHNL_NO}">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								...
								name="CHNL_NAME" value="${CHNL_NAME}" check-empty="true">
							</div>
						</div>
					</div>
				</div>
