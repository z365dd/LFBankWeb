...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaBrchDetailForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaBrchForm" style="margin-top:10px;">
				<input type="hidden" value="" name="brch" id="HID_brch"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="brch" name="brch" class="form-control "  maxlength="20" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="brchName" name="brchName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="brchLvlNo" name="brchLvlNo" class="form-control "  maxlength="10" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="upBrchName" name="upBrch" class="form-control "  maxlength="20" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="bank" name="bank" class="form-control "  maxlength="20" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="bankName" name="bankName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
