...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaCardTypeDetailForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaCardTypeForm" style="margin-top:10px;">
				<input type="hidden" value="" name="cardBinNo" id="HID_cardBinNo"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="cardBinNo" name="cardBinNo" class="form-control " maxlength="20"
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="cardTp" name="cardTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CARD_TP"
								blank-item="true" blank-text="--请选择--" readonly="readonly" data-async="true">
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="acctCardFlg" name="acctCardFlg" class="form-control " maxlength="2" readonly="readonly">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="cardTpName" name="cardTpName" class="form-control " maxlength="120" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="intOutBankFlg" name="intOutBankFlg" class="form-control" maxlength="2"
								 readonly="readonly">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="hostSys" name="hostSys" class="form-control" maxlength="10" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="clrBankName" name="clrBankName" class="form-control " maxlength="280" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="legaNo" name="legaNo" data-role="multiselect" data-async="true"
								data-url="${ctx}/comp/ctrl/oper/ctrlTParaLega/getLega" blank-item="true"
								blank-text="--请选择--" class="" readonly="readonly">
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="stat" name="stat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CARD_STAT"
								blank-item="true" blank-text="--请选择--" class="" readonly="readonly" data-async="true">
								</select>
							</div>
						</div>
					</div>
