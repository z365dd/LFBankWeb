...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/relatTran/relatTranManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a href="#tab_refre" data-toggle="tab" class="" aria-expanded="true"
						url="${ctx}/comp/ctrl/oper/relatTran/tranRedisRefre">
							参数刷新
						</a>
					</li>
					<li class="">
						<a href="#tab_forcOut" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatTran/forceOutNoti">
							强制退出通知
						</a>
					</li>
					<li class="">
						<a href="#tab_login" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatTran/tranLogin">
							签到
						</a>
					</li>
					<li class="">
						<a href="#tab_logout" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatTran/tranLogout">
							签退
						</a>
					</li>
					<li class="">
						<a href="#tab_outNoti" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatTran/sysRunNotiOut">
							停运启运通知
						</a>
					</li>
					<li class="">
						<a href="#tab_stat" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatTran/sysStatChangeNoti">
							系统状态变更通知
						</a>
					</li>
					<li class="">
						<a href="#tab_pwd" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatTran/tranChangePwd">
							修改签到密码
						</a>
					</li>
					<li class="">
						<a href="#tab_comm" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatTran/sysTestComm">
							系统连接测试
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane in active" id="tab_refre">
						<iframe id="iframe_refre" name="iframe_refre" src="" style="width: 100%; height: 700px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_forcOut">
						<iframe id="iframe_forcOut" name="iframe_forcOut" src="" style="width: 100%; height: 650px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_login">
						<iframe id="iframe_login" name="iframe_login" src="" style="width: 100%; height: 650px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_logout">
						<iframe id="iframe_logout" name="iframe_logout" src="" style="width: 100%; height: 650px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_outNoti">
						<iframe id="iframe_outNoti" name="iframe_outNoti" src="" style="width: 100%; height: 650px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_stat">
						<iframe id="iframe_stat" name="iframe_stat" src="" style="width: 100%; height: 650px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_pwd">
						<iframe id="iframe_pwd" name="iframe_pwd" src="" style="width: 100%; height: 650px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe> 
					</div>
					<div class="tab-pane" id="tab_comm">
						<iframe id="iframe_comm" name="iframe_comm" src="" style="width: 100%; height: 650px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
				</div>
