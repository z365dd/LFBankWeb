...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaLoadDataManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaLoadDataList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="数据装载列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaLoadData/ctrlTParaLoadDataList">
							数据装载列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaLoadData/ctrlTParaLoadDataAdd">
							数据装载添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaLoadData/ctrlTParaLoadDataUpdate">
							数据装载更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaLoadData/ctrlTParaLoadDataDetail">
							数据装载详情
						</a>
					</li>
				</ul>
