...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiBrchOpenManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTPipBusiBrchOpenList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="业务机构开通列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiBrchOpen/ctrlTPipBusiBrchOpenList">
							业务机构开通列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiBrchOpen/ctrlTPipBusiBrchOpenAdd">
							业务机构开通添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiBrchOpen/ctrlTPipBusiBrchOpenUpdate">
							业务机构开通更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTPipBusiBrchOpen/ctrlTPipBusiBrchOpenDetail">
							业务机构开通详情
						</a>
					</li>
				</ul>
