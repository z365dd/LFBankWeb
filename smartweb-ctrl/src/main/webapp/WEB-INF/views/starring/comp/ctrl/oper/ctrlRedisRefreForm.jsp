...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlRedisRefreForm.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab1">
						<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_736421">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column" style="margin-top:20px;">
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label" id="">
								操作类型
							</label>
							<div class="col-sm-7">
								<select data-role="multiselect" id="OPER_TP" class="" name="OPER_TP">
									<option value="0">
										全量
									</option>
									<option value="2">
						...
						<div ravo="rainbow_fx" class="form-group" id="busiNameDiv">
							<label for="inputEmail3" class="col-sm-4 control-label">
								业务编号
							</label>
							<div class="col-sm-7">
							<select data-role="multiselect" id="BUSI_NO" name="BUSI_NO" class="" 
								
								checkbtn="BUSI_NO" data-url="${ctx}/comp/ctrl/oper/ctrlRedisRefre/getBusiNo"
								 data-enable-filtering="true" data-filter-placeholder="搜索" data-max-height="300">
								</select>
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group" id="tabNameDiv">
							<label for="inputEmail3" class="col-sm-4 control-label">
								表名称
							</label>
							<div class="col-sm-7">
							<select data-role="multiselect" id="TABLE_NAME" name="TABLE_NAME" class="" 
								
								checkbtn="TABLE_NAME" data-url="${ctx}/comp/ctrl/oper/ctrlRedisRefre/getParaName"
								data-enable-filtering="true" data-filter-placeholder="搜索"  data-max-height="300">
								</select>
							</div>
						</div>
