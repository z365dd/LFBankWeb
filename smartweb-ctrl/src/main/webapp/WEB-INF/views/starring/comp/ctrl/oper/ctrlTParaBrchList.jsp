...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaBrchList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input id="brch" name="brch" class="form-control "  >
											</input>
										</div>
									</div>
								</div>
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input id="brchName" name="brchName" class="form-control ">
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="ctrlTParaBrchTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="brch" data-title="机构">机构</th>
								<th data-field="brchName" data-title="机构名">机构名</th>
								<th data-field="brchLvlNo" data-title="机构等级">机构等级</th>
								<th data-field="upBrch" data-title="上级机构" data-visible="false" data-switchable="false">上级机构的值</th>
								<th data-field="upBrchName" data-title="上级机构">上级机构</th>
								...
								<th data-field="tntNo" data-title="租户号" data-visible="false" data-switchable="false">租户号的值</th>
								<th data-field="tntNoStr" data-title="租户号">租户号</th>
