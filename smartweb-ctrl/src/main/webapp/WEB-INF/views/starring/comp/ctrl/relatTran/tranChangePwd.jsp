...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/relatTran/tranChangePwd.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column" style="margin-top:20px;">
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_672549">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="password" class="form-control" placeholder="" id="NEW_PWD"
								name="NEW_PWD" check-empty="true">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="password" class="form-control" placeholder="" id="PWD" name="PWD" check-empty="true">
							</div>
						</div>
					</div>
				</div>
