...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaCardTypeManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaCardTypeList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="卡种类列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaCardType/ctrlTParaCardTypeList">
							卡种类列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaCardType/ctrlTParaCardTypeAdd">
							卡种类添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaCardType/ctrlTParaCardTypeUpdate">
							卡种类更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaCardType/ctrlTParaCardTypeDetail">
							卡种类详情
						</a>
					</li>
				</ul>
