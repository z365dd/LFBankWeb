...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaCardTypeAddForm.js" charset="utf-8"></script>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								...
								blank-item="true" blank-text="--请选择--" class="">
								</select>
							</div>
						</div>
					</div>
