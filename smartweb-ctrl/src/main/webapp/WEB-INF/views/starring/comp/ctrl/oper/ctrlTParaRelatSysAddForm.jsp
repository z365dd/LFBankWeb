...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaRelatSysAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="relatSys" name="relatSys" class="form-control "  maxlength="10" check-empty="true" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sysTp" name="sysTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=SYS_TP" blank-item="true" blank-text="--请选择--" checkbtn="sysTp" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="openStat" name="openStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=OPEN_STAT" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sysStat" name="sysStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_SYS_STAT" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="origSysStat" name="origSysStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_SYS_STAT" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="nodeStat" name="nodeStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_NOTE_STAT" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="loginStat" name="loginStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_LOGIN_STAT" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="hldFlg" name="hldFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_HLD_FLG" blank-item="true" blank-text="--请选择--"  >
								</select>
							</div>
						</div>
					</div>
