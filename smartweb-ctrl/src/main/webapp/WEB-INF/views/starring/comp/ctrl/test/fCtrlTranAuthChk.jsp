...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/test/fCtrlTranAuthChk.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="tab1" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="测试案例" aria-expanded="true" url="${ctx }/comp/ctrl/test/tranauthchk/toList">
							测试案例
						</a>
					</li>
					<li>
						<a id="tab2" href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/test/tranauthchk/toQry">
							载入案例
						</a>
					</li>
					<li>
						<a id="tab3" href="#tab_save" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/test/tranauthchk/toSave">
							另存为案例
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="tab_list">
						<iframe id="iframe_list" name="iframe_list" src="" style="width: 100%; height: 1600px; border: 0px;"
					...
					<div class="tab-pane" id="tab_save">
						<iframe id="iframe_save" name="iframe_save" src="" style="width: 100%; height: 300px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
				</div>
			</div>
		</div>
