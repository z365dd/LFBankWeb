...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/modl/ctrlModl.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						...
						title="组件查询" aria-expanded="true" url="${ctx }/comp/ctrl/oper/ctrlModlList">
							组件查询
						</a>
					</li>
					<li>
						<a id="tab2" href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/oper/toAdd">
							组件新增
						</a>
					</li>
					<li>
