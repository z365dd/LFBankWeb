...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaDataSynConfigDetailForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaDataSynConfigForm" style="margin-top:10px;">
				<input type="hidden" value="" name="stepNo" id="HID_stepNo"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="srcTp" name="srcTp" data-role="multiselect"  data-async="true"  readonly="readonly" >
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="uptTp" name="uptTp" data-role="multiselect"  data-async="true"  readonly="readonly" >
								<option value="">--请选择--</option>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="srcTabName" name="srcTabName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="srcDataSrc" name="srcDataSrc" data-role="multiselect"  data-async="true"  readonly="readonly" 
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="srcTabDesc" name="srcTabDesc" class="form-control "  maxlength="360" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								...
								data-url="${ctx}/comp/ctrl/oper/ctrlTParaRelatSys/getRelatSys"  readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sameDbFlg" name="sameDbFlg" data-role="multiselect"  data-async="true"  readonly="readonly" >
								<option value="">--请选择--</option>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="dstDataSrc" name="dstDataSrc" data-role="multiselect"  data-async="true"  readonly="readonly"
								data-url="${ctx}/comp/ctrl/oper/ctrlTParaDataSource/getList" >
								</select>
							</div>
						</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="dstTabName" name="dstTabName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="dstTabDesc" name="dstTabDesc" class="form-control "  maxlength="360" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
