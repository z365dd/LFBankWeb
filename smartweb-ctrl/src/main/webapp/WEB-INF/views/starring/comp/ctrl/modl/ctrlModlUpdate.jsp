...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/modl/ctrlModlUpdate.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_277049" style="margin-top: 20px">
				<input type="hidden" value="${modlType}" name="modlType_hidden" id="modlType_hidden">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="模型组件号" id="modlNo"
								name="modlNo" value="${modlNo}" readonly="readonly">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="模型组件名" id="modlName"
								name="modlName" value="${modlName}">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
						   		<select data-role="multiselect" id="modlType_sel" data-max-height="300">
									<option value="1">
										流程
									</option>
									<option value="2">
...
/*放在<body>标签前不生效，放在<body>标签后才生效*/
var modlType_hidden = $("#modlType_hidden").val();
if(modlType_hidden==1){
	$("#modlType_sel option[value='1']").attr("selected", "selected");
}else if(modlType_hidden==2){
	$("#modlType_sel option[value='2']").attr("selected", "selected");
}else{
	$("#modlType_sel option[value='3']").attr("selected", "selected");
}
</script>
</html>
