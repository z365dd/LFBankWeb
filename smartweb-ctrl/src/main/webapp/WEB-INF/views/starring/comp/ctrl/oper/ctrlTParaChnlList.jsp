...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaChnlList.js" charset="utf-8"></script>
				...
				<div class="panel-body" contenteditable="false">
					...
					<form id="listForm" ravo="rainbow_fx_layout_bd" class="form-horizontal breadcrumb">
						<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-top:10px;">
							...
							<div class="col-sm-5">
								<select id="chnlTp" name="chnlTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CHNL_TP" blank-item="true" blank-text="--请选择--" >
								</select>
							</div>
						</div>
								</div>
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input id="chnlName" name="chnlName" class="form-control"  >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="ctrlTParaChnlTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/comp/ctrl/oper/ctrlTParaChnl/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="chnlNo" data-title="渠道号">渠道号</th>
								<th data-field="chnlName" data-title="渠道名称">渠道名称</th>
								<th data-field="chnlStat" data-title="渠道状态" data-visible="false" data-switchable="false">渠道状态的值</th>
								<th data-field="chnlStatStr" data-title="渠道状态">渠道状态</th>
								<th data-field="chnlTp" data-title="渠道类型" data-visible="false" data-switchable="false">渠道类型的值</th>
								<th data-field="chnlTpStr" data-title="渠道类型">渠道类型</th>
								<th data-field="relatSys" data-title="关联系统">关联系统</th>
								<!-- <th data-field="relatSys" data-title="关联系统" data-visible="false" data-switchable="false">关联系统的值</th>
								<th data-field="relatSysStr" data-title="关联系统">关联系统</th> -->
