...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/relatSys/relatSysMod.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column" style="margin-top:20px;">
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_760972">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="SYS_NAME" name="SYS_NAME">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4 btn-group col-sm-4">
								<select data-role="multiselect" id="SYS_TP" class="" name="SYS_TP">
									<option value="">
										--请选择--
									</option>
									<option value="00">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="MEMB_ID">
							</div>
						</div>
					</div>
				</div>
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4 btn-group col-sm-4">
								<select data-role="multiselect" id="STAT" class="" name="STAT">
									<option value="">
										--请选择--
									</option>
									<option value="00">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="ORIG_SYS_STAT"
								name="ORIG_SYS_STAT">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="CLR_BANK" name="CLR_BANK">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-5 control-label">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" name="ORIG_OTH_DATE"
								id="ORIG_OTH_DATE">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="LOGIN_STAT" class="" name="LOGIN_STAT">
									<option value="">
										--请选择--
									</option>
									<option value="00">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="MSG_SKEY" name="MSG_SKEY">
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="SYS_STAT" name="SYS_STAT">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="CLR_BRCH" name="CLR_BRCH">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-3 control-label">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" name="OTH_DATE"
								id="OTH_DATE">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="NODE_STAT" class="" name="NODE_STAT">
									<option value="">
										--请选择--
									</option>
									<option value="00">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="SEQ_CRT_ID"
								name="SEQ_CRT_ID">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="LOGIN_ID" name="LOGIN_ID">
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-5 control-label">
					...
					<div class="col-md-6 column">
						...
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" placeholder="" id="LOGIN_PWD"
								name="LOGIN_PWD">
							</div>
						</div>
					</div>
					...
					<div class="col-md-12 column">
						<div ravo="rainbow_fx_checkbox" class="form-group">
							...
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="" >
										<input type="checkbox" value="0" data-bv-="true" id="forcOut" name="dimFlgCheck">
										强制签退通知
									</label>
								</div>
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="4" data-bv-="true" id="stat" name="dimFlgCheck">
										系统状态变更通知
									</label>
								</div>
							</div>
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="" >
										<input type="checkbox" value="1" data-bv-="true" id="login" name="dimFlgCheck">
										签到
									</label>
								</div>
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="5" data-bv-="true"  id="pwd" name="dimFlgCheck">
										修改签到密码
									</label>
								</div>
							</div>
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="2" data-bv-="true" id="logout" name="dimFlgCheck">
										签退
									</label>
								</div>
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="6" data-bv-="true"  id="comm" name="dimFlgCheck">
										系统连接测试
									</label>
								</div>
							</div>
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="3" data-bv-="true"  id="outNoti" name="dimFlgCheck">
										停运启运通知
									</label>
								</div>
							</div>  
