...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaRelatSysManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaRelatSysList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="关联系统列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaRelatSys/ctrlTParaRelatSysList">
							关联系统列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaRelatSys/ctrlTParaRelatSysAdd">
							关联系统添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaRelatSys/ctrlTParaRelatSysUpdate">
							关联系统更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaRelatSys/ctrlTParaRelatSysDetail">
							关联系统详情
						</a>
					</li>
				</ul>
