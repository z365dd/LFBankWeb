...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiChnlOpenList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-4 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-6">
												<select id="busiNo" name="busiNo" data-role="multiselect" data-async="true"
												data-max-height="300" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getBusiNo"
									...
									<div class="col-md-4 column">
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-6">
												<select id="chnlNo" name="chnlNo" data-async="true" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getChnlNo"
												data-role="multiselect" blank-item="true" blank-text="--请选择--" class=""
												data-max-height="300" blank-value="">
												</select>
											</div>
										</div>
									</div>
					...
					<table class="table table-hover" id="ctrlTPipBusiChnlOpenTable" data-side-pagination="server"
					data-toggle="table" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/list"
					ravo="rainbow_fx_bj" data-height="" data-undefined-text="" data-pagination="true"
					data-striped="true" data-single-select="true" data-query-params="queryParams"
					data-first-load="true">
						<thead>
							<tr>
								<th data-field="id" data-title="唯一主键ID" data-visible="false" data-switchable="false">
									唯一主键ID
								</th>
								<th data-field="busiNo" data-title="业务编号" data-visible="false" data-switchable="false">
									业务编号的值
								</th>
								<th data-field="busiNoStr" data-title="业务编号">
									业务编号
								</th>
								<th data-field="chnlNo" data-title="渠道号" data-visible="false" data-switchable="false">
									渠道号的值
								</th>
								<th data-field="chnlNoStr" data-title="渠道号">
									渠道号
								</th>
								<th data-field="flg" data-title="标志" data-visible="false" data-switchable="false">
									标志的值
								</th>
								<th data-field="flgStr" data-title="标志">
									标志
								</th>
