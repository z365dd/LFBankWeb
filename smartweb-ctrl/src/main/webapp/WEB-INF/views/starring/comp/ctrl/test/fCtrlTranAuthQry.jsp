...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/test/fCtrlTranAuthQry.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/test/tranauthchk/qryAuth"
			...
			data-query-params="queryParams" data-side-pagination="server" data-content-type="application/x-www-form"
