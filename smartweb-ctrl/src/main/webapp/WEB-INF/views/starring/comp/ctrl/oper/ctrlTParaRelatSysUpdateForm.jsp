...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaRelatSysUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaRelatSysForm" style="margin-top:10px;">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="relatSys" name="relatSys" class="form-control "  maxlength="10" check-empty="true" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sysTp" name="sysTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=SYS_TP" data-async="true" blank-item="true" blank-text="--请选择--" checkbtn="sysTp"  >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="sysName" name="sysName" class="form-control "  maxlength="120"   >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="membId" name="membId" class="form-control "  maxlength="64"   >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="openStat" name="openStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=OPEN_STAT" data-async="true" blank-item="true" blank-text="--请选择--"   >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sysStat" name="sysStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_SYS_STAT" data-async="true" blank-item="true" blank-text="--请选择--"   >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="origSysStat" name="origSysStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_SYS_STAT" data-async="true" blank-item="true" blank-text="--请选择--"   >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="clrBrch" name="clrBrch" class="form-control "  maxlength="20"   >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="clrBank" name="clrBank" class="form-control "  maxlength="20"   >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="input-group-sm col-sm-4">
								...
								data-link-field="val_othDate" id="othDate" onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('othDate');}});"
								onchange="writeDateValue('othDate');"   >
								<input type="hidden" id="val_othDate" value="" name="othDate" >
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="input-group-sm col-sm-4">
								...
								datetime-max-date="" datetime-is-show-clear="true" datetime-is-show-week="true"
								datetime-is-show-today="true" datetime-default-value="" datetime-value-fmt="yyyyMMdd"
								data-link-field="val_origOthDate" id="origOthDate" onclick="WdatePicker({skin: 'twoer',dateFmt: 'yyyy-MM-dd',minDate: '1900-01-01 00:00:00',maxDate: '2099-12-31 23:59:59',isShowClear: true,isShowWeek: true,isShowToday: true,onpicked:function(dp){	var newVal = dp.cal.getNewDateStr();  console.info(newVal);	writeDateValue('origOthDate');}});"
								onchange="writeDateValue('origOthDate');"   >
								<input type="hidden" id="val_origOthDate" value="" name="origOthDate" >
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="nodeStat" name="nodeStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_NOTE_STAT" data-async="true" blank-item="true" blank-text="--请选择--"   >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="loginStat" name="loginStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_LOGIN_STAT" data-async="true" blank-item="true" blank-text="--请选择--"   >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="hldFlg" name="hldFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_HLD_FLG" data-async="true" blank-item="true" blank-text="--请选择--"   >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="msgSkey" name="msgSkey" class="form-control "  maxlength="64"   >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="seqCrtId" name="seqCrtId" class="form-control "  maxlength="64"   >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="fileSvrId" name="fileSvrId" class="form-control "  maxlength="64"   >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="loginId" name="loginId" class="form-control "  maxlength="64"   >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="loginPwd" name="loginPwd" class="form-control "  maxlength="80"   >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="reasnDesc" name="reasnDesc" class="form-control "  maxlength="360"   >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						<div ravo="rainbow_fx_checkbox" class="form-group">
							...
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="" >
										<input type="checkbox" value="0" data-bv-="true" id="forcOut" name="dimFlg">
										强制签退通知
									</label>
								</div>
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="4" data-bv-="true" id="statMod" name="dimFlg">
										系统状态变更通知
									</label>
								</div>
							</div>
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="" >
										<input type="checkbox" value="1" data-bv-="true" id="login" name="dimFlg">
										签到
									</label>
								</div>
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="5" data-bv-="true"  id="pwd" name="dimFlg">
										修改签到密码
									</label>
								</div>
							</div>
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="2" data-bv-="true" id="logout" name="dimFlg">
										签退
									</label>
								</div>
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="6" data-bv-="true"  id="comm" name="dimFlg">
										系统连接测试
									</label>
								</div>
							</div>
							<div class=" col-sm-2">
								<div class="checkbox">
									<label style="visibility:visible" class="">
										<input type="checkbox" value="3" data-bv-="true"  id="outNoti" name="dimFlg">
										停运启运通知
									</label>
								</div>
							</div>
				...
				<!-- <div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="dimFlg" name="dimFlg" class="form-control "  maxlength="20"   >
								</input>
							</div>
						</div>
					</div>
