...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/test/fCtrlTranExmQry.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/test/tranctrlchk/qryExm"
			data-show-export="false" data-show-refresh="false" data-show-toggle="false"
			data-show-columns="false" data-pagination="true" data-search="false" 
			data-query-params="queryParams" data-side-pagination="server" data-content-type="application/x-www-form-urlencoded"
			data-height="500" ravo="rainbow_fx_bj" class="table table-hover" data-striped="true">
				<thead style="">
					<tr>
						<th data-field="ORDER_NO">
							序号
						</th>
						<th data-field="CASENAME">
							案例名称
						</th>
