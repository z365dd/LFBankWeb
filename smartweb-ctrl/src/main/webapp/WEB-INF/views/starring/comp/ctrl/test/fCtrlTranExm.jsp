...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/test/fCtrlTranExm.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						...
						title="测试案例" aria-expanded="true" url="${ctx }/comp/ctrl/test/tranctrlchk/toList">
							测试案例
						</a>
					</li>
					<li>
						<a id="tab2" href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/test/tranctrlchk/toQry">
							载入案例
						</a>
					</li>
					<li>
						<a id="tab3" href="#tab_save" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/test/tranctrlchk/toSave">
							另存为案例
						</a>
					</li>
				</ul>
				<div class="tab-content">
					...
					<div class="tab-pane" id="tab_save">
						<iframe id="iframe_save" name="iframe_save" src="" style="width: 100%; height: 600px; border: 0px;" scrolling="no" frameborder="no"></iframe>
					</div>
				</div>
			</div>
		</div>
