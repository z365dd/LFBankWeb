...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/mngdim/fCtrlMngDimList.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="column col-md-4">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="COMP_NO" name="COMP_NO" class="form-control" data-max-height="300">
								</select>
							</div>
						</div>
					</div>
					<div class="column col-md-3">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select data-role="multiselect" id="DIM_KEY" name="DIM_KEY" class="form-control" data-max-height="300">
		...
		<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/oper/mngdim/FCtrlMngDimQry"
		...
		data-show-header="true" data-striped="true">
			<thead style="">
				<tr>
					...
					<th data-field="DIM_KEY">
						维度
					</th>
					<th data-field="DIM_DESC">
						维度描述
					</th>
					<th data-field="TAB_NAME">
						维度值表名
					</th>
