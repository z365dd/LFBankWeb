...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/relatTran/tranLogout.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column" style="margin-top:20px;">
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_94318">
				<div ravo="rainbow_fx_layout" class="row clearfix">
