...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiChnlOpenAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="busiNo" name="busiNo" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getBusiNo"
								blank-item="true" blank-text="--请选择--" checkbtn="busiNo" data-max-height="300">
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chnlNo" name="chnlNo" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getMulChnlNo"
								blank-item="true" blank-text="--请选择--" blank-value="" checkbtn="chnlNo" class="" data-async="true"
