...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/quota/quotaRuleList.js" charset="utf-8"></script>
			...
			<div class="tab-pane active in" id="panel1">
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="MODL_NO" class="" name="MODL_NO">
									...
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="SUB_SVC" class="" name="SUB_SVC">
												<option value="">
													请选择
												</option>
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7">
											<select data-role="multiselect" id="SVC_CODE" class="" name="SVC_CODE">
												<option value="">
													请选择
												</option>
												...
												<div class="col-md-2 column">
													<shiro:haspermission name="anno">
														<button ravo="rainbow_fx" type="button"
															...
															id="saveBtn" name="saveBtn">保存</button>
													</shiro:haspermission>
												</div>
						...
						<table id="table" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/oper/quota/qry"
						...
						ravo="rainbow_fx_bj" class="table table-hover" data-side-pagination="server" data-single-select="true"
						>
							<thead style="">
								<tr>
									<th data-field="state" data-checkbox="true" >
									</th>
									<th data-field="EXCT_SER">
										序号
									</th>
									<th data-field="SVC_CODE">
										服务码
									</th>
									<th data-field="SUB_SVC">
										子服务码
									</th>
									<th data-field="RULE_EXP">
										限额规则定义
									</th>
									<th data-field="SER_NO" data-visible="false">
										规则表达式序号
									</th>
									<th data-field="MODL_NO" data-visible="false">
										模型号
									</th>
