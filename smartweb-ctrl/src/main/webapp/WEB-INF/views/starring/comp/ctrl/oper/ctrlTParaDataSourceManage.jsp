...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaDataSourceManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaDataSourceList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="数据源列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSource/ctrlTParaDataSourceList">
							数据源列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSource/ctrlTParaDataSourceAdd">
							数据源添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSource/ctrlTParaDataSourceUpdate">
							数据源更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSource/ctrlTParaDataSourceDetail">
							数据源详情
						</a>
					</li>
				</ul>
