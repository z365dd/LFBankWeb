...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiChnlOpenUpdateForm.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTPipBusiChnlOpenForm" style="margin-top:10px;">
				<input type="hidden" value="" name="flg" id="flg"/>
				<input type="hidden" value="" name="busiNo" id="HID_busiNo"/>
				<input type="hidden" value="" name="ORI_chnlNo" id="ORI_chnlNo"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column"> 
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="busiNo" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getBusiNo" data-async="true" blank-item="true" blank-text="--请选择--" checkbtn="busiNo" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chnlNo" name="chnlNo" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getChnlNo" data-async="true" blank-item="true" blank-text="--请选择--" checkbtn="chnlNo" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
