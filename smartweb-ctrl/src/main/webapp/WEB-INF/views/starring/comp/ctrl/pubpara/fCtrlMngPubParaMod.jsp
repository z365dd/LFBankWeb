...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/pubpara/fCtrlMngPubParaMod.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-12 column">
						...
						<div ravo="rainbow_fx_radio" class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label" id="AUTH_TYPE_NAME">
								高级别柜员是否可授权 </label>
							<div class="col-sm-8">
								<div class="radio-inline">
									<label style="visibility: visible"> 
									   <input id="AUTH_TYPE_Y" type="radio" value="Y"
										name="AUTH_TYPE">
										可以
									</label>
								</div>
								...
								<div class="radio-inline">
									<label style="visibility: visible"> <input
										id="AUTH_TYPE_N" type="radio" value="N"
										name="AUTH_TYPE">
										不可以
									</label>
								</div>
						...
						<div ravo="rainbow_fx_radio" class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label" id="CTRL_MODE_NAME">
								控制检查方式 </label>
							<div class="col-sm-8">
								<div class="radio-inline">
									<label style="visibility: visible"> <input
										id="CTRL_MODEE_1" type="radio" value="1"
										name="CTRL_MODE">
										所有检查点均执行检查并返回所有结果
									</label>
								</div>
								...
								<div class="radio-inline">
									<label style="visibility: visible"> <input
										id="CTRL_MODE_2" type="radio" value="2"
										name="CTRL_MODE">
										检查到第一个不允许交易的检查点即返回
									</label>
								</div>
						...
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class="col-sm-4 control-label" id="DAYS_NAME">
								数据同步任务记录保留天数
							</label>
							<div class="col-sm-2">
								<input type="number" class="form-control" placeholder="" id="DAYS"
								name="DAYS">
							</div>
						</div>
