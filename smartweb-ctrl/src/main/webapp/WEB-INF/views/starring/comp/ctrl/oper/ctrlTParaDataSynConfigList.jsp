...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaDataSynConfigList.js"
	charset="utf-8"></script>
			...
			<div class="col-md-12 column">
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
					<div class="panel-body" contenteditable="false">
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-6 control-label">
													来源类型 </label>
												<div class="col-sm-6">
													<select id="srcTp" name="srcTp" data-role="multiselect">
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-4 control-label">
													来源表名 </label>
												<div class="col-sm-6">
													<input id="srcTabName" name="srcTabName"
						...
						<table class="table table-hover" id="ctrlTParaDataSynConfigTable"
							data-side-pagination="server" data-toggle="table"
							data-url="${ctx}/comp/ctrl/oper/ctrlTParaDataSynConfig/list"
							...
							<thead>
								<tr>
									...
									<th data-field="srcTp" data-title="来源类型" data-visible="false"
										data-switchable="false">来源类型的值</th>
									<th data-field="srcTpStr" data-title="来源类型">来源类型</th>
									<th data-field="srcTabName" data-title="来源表名">来源表名</th>
									<th data-field="relatSys" data-title="关联系统"
										data-visible="false" data-switchable="false">关联系统的值</th>
									<th data-field="relatSysStr" data-title="关联系统">关联系统</th>
									<th data-field="dstDataSrc" data-title="目的数据源"
										data-visible="false" data-switchable="false">目的数据源的值</th>
									<th data-field="dstDataSrcStr" data-title="目的数据源">目的数据源</th>
									<th data-field="dstTabName" data-title="目标表名">目标表名</th>
