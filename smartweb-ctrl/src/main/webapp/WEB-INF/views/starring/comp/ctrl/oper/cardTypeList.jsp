...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/cardTypeList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">卡种类查询 </a></li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2">卡种类新增</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
										...
										<div ravo="rainbow_fx" class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" placeholder=""
													id="CARD_BIN_NO" name="CARD_BIN_NO">
											</div>
										</div>
									</div>
									<div class="col-md-5 column">
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/comp/ctrl/oper/cardType/action"
								...
								<thead style="">
									<tr>
										<th data-field="CARD_BIN_NO">卡BIN号</th>
										<th data-field="CARD_TP">卡类型</th>
										<th data-field="ACCT_CARD_FLG">帐卡号标志</th>
										<th data-field="LEGA_NO">法人号</th>
										<th data-field="NET_NO">网络编号</th>
