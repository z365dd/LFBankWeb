...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaChnlAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="chnlNo" name="chnlNo" class="form-control "  maxlength="6" check-empty="true" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chnlTp" name="chnlTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CHNL_TP" blank-item="true" blank-text="--请选择--" checkbtn="chnlTp" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="chnlFlg" name="chnlFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_CHNL_FLG" blank-item="true" blank-text="--请选择--" >
								</select>
							</div>
						</div>
					</div>
