...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaLoadDataList.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
				<div class="panel-body" contenteditable="false">
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input id="paraName" name="paraName" class="form-control "  >
											</input>
										</div>
									</div>
								</div>
								<div class="col-md-4 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-6">
											<input id="tabName" name="tabName" class="form-control "  >
											</input>
										</div>
									</div>
								</div>
					...
					<table class="table table-hover" id="ctrlTParaLoadDataTable" data-side-pagination="server"
						data-toggle="table" data-url="${ctx}/comp/ctrl/oper/ctrlTParaLoadData/list" ravo="rainbow_fx_bj"
						...
						<thead>
							<tr>
								...
								<th data-field="paraName" data-title="参数名称">参数名称</th>
								<th data-field="tabName" data-title="表名称">表名称</th>
