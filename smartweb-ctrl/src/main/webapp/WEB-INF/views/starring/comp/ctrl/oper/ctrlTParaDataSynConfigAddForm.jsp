...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaDataSynConfigAddForm.js" charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="srcTp" name="srcTp" data-role="multiselect"  checkbtn="srcTp" >
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="uptTp" name="uptTp" data-role="multiselect"  checkbtn="uptTp" >
								<option value="">--请选择--</option>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="srcDataSrc" name="srcDataSrc" data-role="multiselect"  data-url="${ctx}/comp/ctrl/oper/ctrlTParaDataSource/getList" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="relatSys" name="relatSys" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTParaRelatSys/getRelatSys">
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sameDbFlg" name="sameDbFlg" data-role="multiselect"  checkbtn="sameDbFlg" >
								<option value="">--请选择--</option>
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="dstDataSrc" name="dstDataSrc" data-role="multiselect" data-url="${ctx}/comp/ctrl/oper/ctrlTParaDataSource/getList"  >
								</select>
							</div>
						</div>
					</div>
