...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/fCtrlTParaDayManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="fCtrlTParaDayForm" href="#tab_add" data-toggle="tab" contenteditable="false"
						title="平台日切" aria-expanded="true" url="${ctx}/comp/ctrl/oper/fCtrlTParaDay/fCtrlTParaDayForm">
							平台日切列表
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="tab_add">
						<iframe id="iframe_add" name="iframe_add" src="" style="width: 100%; height: 800px; border: 0px;"
