...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaSyncTaskManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaSyncTaskList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="数据同步任务查询" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaSyncTask/ctrlTParaSyncTaskList">
							数据同步任务查询
						</a>
					</li>
				</ul>
