...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaBrchManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaBrchList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="机构列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/ctrlTParaBrchList">
							机构列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/ctrlTParaBrchAdd">
							机构添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/ctrlTParaBrchUpdate">
							机构更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/ctrlTParaBrchDetail">
							机构详情
						</a>
					</li>
				</ul>
