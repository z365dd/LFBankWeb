...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/compParaForm.js"
	charset="utf-8"></script>
						...
						<div class="col-md-6 column">
							...
							<div ravo="rainbow_fx" class="form-group">
								<label for="inputEmail3" class=" col-sm-5 control-label">
									KEY值</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="" id="KV"
										name="KV" check-empty="true">
								</div>
							</div>
						</div>
						<div class="col-md-6 column">
							...
							<div class="col-md-2 column">
								<shiro:haspermission name="anno">
									<button ravo="rainbow_fx" type="button" class="btn btn-default"
										contenteditable="false" id="addBtnRow">增加一行</button>
								</shiro:haspermission>
							</div>
							<div class="col-md-2 column">
								<shiro:haspermission name="anno">
									<button ravo="rainbow_fx" type="button" class="btn btn-default"
										contenteditable="false" id="reviceBtnRow">确认修改</button>
								</shiro:haspermission>
							</div>
						</div>
						</div>
							...
							<div ravo="rainbow_fx_layout" class="row clearfix">
								...
								<div class="col-sm-7">
									<table id="table" data-toggle="table" data-first-load="false"
										...
										<thead style="">
											<tr>
												<th data-field="KEY_NAME">KEY名</th>
												<th data-field="KEY_NO">KEY</th>
												<th data-field="KV">KEY值</th>
