...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/switches/ruleCommon.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_286247" style="margin-top:20px">
				
						<div ravo="rainbow_fx" class="form-group">
							<label for="inputEmail3" class=" col-sm-1 control-label">
								规则输入
							</label>
							<div class=" 0 col-sm-11">
								<textarea class="form-control" rows="3" id="RULE_EXP" name="RULE_EXP">
								</textarea>
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class=" 0 col-sm-11">
								<textarea class="form-control" rows="3" id="EXP_DESC" name="EXP_DESC" readonly>
								</textarea>
							</div>
						</div>
						<div ravo="rainbow_fx" class="form-group hidden">
							<label for="inputEmail3" class=" col-sm-1 control-label">
								规则描述
							</label>
							<div class=" 0 col-sm-11">
								<textarea class="form-control " rows="3" id="EXPR_DESC" name="EXPR_DESC">
								</textarea>
							</div>
						</div>
						<!-- <div ravo="rainbow_fx_layout" class="row clearfix">
							<div class="col-md-6 column"> -->
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="RULE_EXP_S" class="" name="RULE_EXP_S" data-max-height="100">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="DIM_NO" class="" name="DIM_NO" data-max-height="100">
											<option value=''>请选择</option>
										</select>
									</div>
								</div>
								...
								<div ravo="rainbow_fx" class="form-group">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="OPR_NO" class="" name="OPR_NO" data-max-height="100">
											<option value=''>请选择</option>
										</select>
									</div>
									<label for="inputEmail3" class=" col-sm-2 control-label">
									...
									<div class="col-sm-4">
										<select data-role="multiselect" id="DIM_VALUE" name="DIM_VALUE" class="" data-max-height="100">
											<option value=''>请选择</option>
										</select>
									</div>
								</div>
