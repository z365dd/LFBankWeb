...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/relatSys/relatSysList.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
		...
		<form ravo="rainbow_fx_layout_bd" class="form-horizontal" pourl="" id="formId_220315">
							<div ravo="rainbow_fx_layout" class="row clearfix" style="margin-top:20px">
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" placeholder="" id="RELAT_SYS"
											name="RELAT_SYS">
										</div>
									</div>
									<div ravo="rainbow_fx" class="form-group">
								...
								<div class="col-md-6 column">
									<div ravo="rainbow_fx" class="form-group">
										...
										<div class="col-sm-7 btn-group col-sm-4">
											<select data-role="multiselect" id="SYS_TP" name="SYS_TP" class="">
												<option value="">
													--请选择--
												</option>
												<option value="00">
						...
						<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/comp/ctrl/oper/relatSys/qry"
							...
							<thead style="">
								<tr>
									<th data-field="relatSys">
										关联系统号
									</th>
									<th data-field="sysTpStr">
										系统类型
									</th>
									<th data-field="sysName">
										关联系统名称
									</th>
									<th data-field="statStr">
										本地状态
									</th>
									<th data-field="clrBrch">
										清算机构
									</th>
