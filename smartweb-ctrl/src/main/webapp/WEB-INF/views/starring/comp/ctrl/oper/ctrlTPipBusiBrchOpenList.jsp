...
<!-- Self reference JS-->
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTPipBusiBrchOpenList.js"
	charset="utf-8"></script>
			...
			<div class="col-md-12 column">
				<div ravo="rainbow_fx_layout_panel" class="panel panel-default">
					<div class="panel-body" contenteditable="false">
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-6 control-label">
													业务编号 </label>
												<div class="col-sm-6">
													<select id="busiNo" name="busiNo" data-role="multiselect"
														data-max-height="300"
														data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiChnlOpen/getBusiNo"
										...
										<div class="col-md-4 column">
											<div ravo="rainbow_fx" class="form-group">
												<label for="inputEmail3" class="col-sm-4 control-label">
													机构 </label>
												<div class="col-sm-6">
													<select id="brch" name="brch" data-role="multiselect"
														data-max-height="300"
														data-url="${ctx}/comp/ctrl/oper/ctrlTParaBrch/getBrchNo"
														blank-item="true" blank-text="--请选择--">
													</select>
												</div>
											</div>
						...
						<table class="table table-hover" id="ctrlTPipBusiBrchOpenTable"
							data-side-pagination="server" data-toggle="table"
							data-url="${ctx}/comp/ctrl/oper/ctrlTPipBusiBrchOpen/list"
							...
							<thead>
								<tr>
									...
									<th data-field="busiNo" data-title="业务编号" data-visible="false"
										data-switchable="false">业务编号的值</th>
									<th data-field="busiNoStr" data-title="业务编号">业务编号</th>
									<th data-field="brch" data-title="机构" data-visible="false"
										data-switchable="false">机构的值</th>
									<th data-field="brchStr" data-title="机构">机构</th>
									<th data-field="flg" data-title="标志" data-visible="false"
										data-switchable="false">标志的值</th>
									<th data-field="flgStr" data-title="标志">标志</th>
