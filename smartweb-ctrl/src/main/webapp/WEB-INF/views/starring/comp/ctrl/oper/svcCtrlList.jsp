...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/svcCtrlList.js"
	charset="utf-8"></script>
				...
				<div ravo="rainbow_fx_layout_tab" class="tabbable" id="tabs-999600">
					...
					<ul class="nav nav-tabs" data-toggle="tabs">
						...
						<li class="active"><a href="#panel1" data-toggle="tab"
							class="" id="tab1" name="tab1" aria-expanded="true">服务码控制查询 </a></li>
						<li class=""><a href="#panel2" data-toggle="tab"
							aria-expanded="false" class="" id="tab2" name="tab2">服务码控制新增</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane in active" id="panel1">
							...
							<form ravo="rainbow_fx_layout_bd" class="form-horizontal"
								...
								<div ravo="rainbow_fx_layout" class="row clearfix">
									<div class="col-md-6 column">
										...
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3"
												class="col-sm-5 control-label control-label">状态 </label>
											<div class="col-sm-4">
												<select data-role="multiselect" id="STAT" class=""
													name="STAT" data-max-height="300">
													<option value="">请选择</option>
									...
									<div class="col-md-6 column">
										<div ravo="rainbow_fx" class="form-group">
											<label for="inputEmail3" class="col-sm-3 control-label">
												服务码 </label>
											<div class="col-sm-7">
												<select data-role="multiselect" id="SVC_CODE" name="SVC_CODE"
													class="form-control" data-max-height="300">
													<option value="">请选择</option>
												</select>
											</div>
										</div>
							...
							<table id="table" data-toggle="table" data-first-load="true"
								data-url="${ctx}/comp/ctrl/oper/svcCtrl/action"
								...
								<thead style="">
									<tr>
										<th data-field="COMP_NAME">组件</th>
										<th data-field="COMP_NO">组件号</th>
										<th data-field="SVC_DESC">服务码描述</th>
										<th data-field="SVC_CODE">服务码</th>
