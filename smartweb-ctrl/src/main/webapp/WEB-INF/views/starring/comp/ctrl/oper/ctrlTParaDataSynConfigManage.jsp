...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaDataSynConfigManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a id="ctrlTParaDataSynConfigList" href="#tab_list" data-toggle="tab" contenteditable="false"
						title="数据同步列表" aria-expanded="true" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSynConfig/ctrlTParaDataSynConfigList">
							数据同步列表
						</a>
					</li>
					<li>
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSynConfig/ctrlTParaDataSynConfigAdd">
							数据同步添加
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSynConfig/ctrlTParaDataSynConfigUpdate">
							数据同步更新
						</a>
					</li>
					<li>
						<a href="#tab_detail" data-toggle="tab" aria-expanded="false" url="${ctx}/comp/ctrl/oper/ctrlTParaDataSynConfig/ctrlTParaDataSynConfigDetail">
							数据同步详情
						</a>
					</li>
				</ul>
