...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/subsvccode/ctrlSubSvc.js" charset="utf-8"></script>
			...
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						...
						title="子服务码查询" aria-expanded="true" url="${ctx }/comp/ctrl/oper/subsvccode/toList">
							子服务码查询
						</a>
					</li>
					<li>
						<a id="tab2" href="#tab_add" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/oper/subsvccode/toAdd">
							子服务码新增
						</a>
					</li>
					<li>
						<a href="#tab_update" data-toggle="tab" aria-expanded="false" url="${ctx }/comp/ctrl/oper/subsvccode/toUpdate">
							子服务码修改
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="tab_list">
						<iframe id="iframe_list" name="iframe_list" src="" style="width: 100%; height: 600px; border: 0px;"
