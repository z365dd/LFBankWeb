...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/oper/ctrlTParaRelatSysDetailForm.js" charset="utf-8"></script>
	...
	<div ravo="rainbow_fx_layout" class="row clearfix">
		<div class="col-md-12 column">
			...
			id="ctrlTParaRelatSysForm" style="margin-top:10px;">
				<input type="hidden" value="" name="relatSys" id="HID_relatSys"/>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="relatSys" name="relatSys" class="form-control "  maxlength="10" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sysTp" name="sysTp" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=SYS_TP" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="sysName" name="sysName" class="form-control "  maxlength="120" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="membId" name="membId" class="form-control "  maxlength="64" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="openStat" name="openStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=OPEN_STAT" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="sysStat" name="sysStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_SYS_STAT" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="origSysStat" name="origSysStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_SYS_STAT" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="clrBrch" name="clrBrch" class="form-control "  maxlength="20" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="clrBank" name="clrBank" class="form-control "  maxlength="20" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="input-group-sm col-sm-4">
								...
								onchange="writeDateValue('othDate');" readonly="readonly" >
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="input-group-sm col-sm-4">
								...
								onchange="writeDateValue('origOthDate');" readonly="readonly" >
					...
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="nodeStat" name="nodeStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_NOTE_STAT" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="loginStat" name="loginStat" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_LOGIN_STAT" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<select id="hldFlg" name="hldFlg" data-role="multiselect" data-url="${ctx}/sys/dict/selectData?type=CTRL_HLD_FLG" data-async="true" blank-item="true" blank-text="--请选择--" readonly="readonly" >
								</select>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="msgSkey" name="msgSkey" class="form-control "  maxlength="64" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="seqCrtId" name="seqCrtId" class="form-control "  maxlength="64" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="fileSvrId" name="fileSvrId" class="form-control "  maxlength="64" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="loginId" name="loginId" class="form-control "  maxlength="64" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="loginPwd" name="loginPwd" class="form-control "  maxlength="80" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="reasnDesc" name="reasnDesc" class="form-control "  maxlength="360" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="col-md-6 column">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-4">
								<input id="dimFlg" name="dimFlg" class="form-control "  maxlength="20" readonly="readonly" >
								</input>
							</div>
						</div>
					</div>
