...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/svccode/ctrlSvcList.js" charset="utf-8"></script>
...
<div class="">
	<div ravo="rainbow_fx_layout" class="row clearfix">
				...
				<div ravo="rainbow_fx_layout" class="row clearfix">
					<div class="column col-md-4">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="modlNo" name="modlNo" class="form-control" data-max-height="300">
								</select>
							</div>
						</div>
					</div>
					<div class="column col-md-4">
						<div ravo="rainbow_fx" class="form-group">
							...
							<div class="col-sm-7">
								<select data-role="multiselect" id="svcCode" name="svcCode" class="form-control" data-max-height="300" data-button-width="50%">
									<option value="">
									   请选择
									</option>
								</select>
		...
		<table id="qryTable" data-toggle="table" data-first-load="false" data-url="${ctx}/comp/ctrl/oper/svccode/CtrlSvcQry"
