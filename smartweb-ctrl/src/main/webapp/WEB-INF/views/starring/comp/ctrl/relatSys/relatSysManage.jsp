...
<!-- Self reference JS-->
<script type="text/javascript" src="<%=basePath%>/b_base/views/starring/comp/ctrl/relatSys/relatSysManage.js" charset="utf-8"></script>
		...
		<div class="col-md-12 column">
			<div ravo="rainbow_fx_layout_tab" class="tabbable" id="myTabs">
				...
				<ul class="nav nav-tabs" data-toggle="tabs">
					<li class="active">
						<a href="#tab_list" data-toggle="tab" class="" aria-expanded="true"
						url="${ctx}/comp/ctrl/oper/relatSys/relatSysList">
							关联系统信息管理
						</a>
					</li>
					<li class="">
						<a href="#tab_add" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatSys/relatSysForm">
							关联系统信息新增
						</a>
					</li>
					<li class="">
						<a href="#tab_mod" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatSys/relatSysMod">
							关联系统信息修改
						</a>
					</li>
					<li class="">
						<a href="#tab_det" data-toggle="tab" aria-expanded="false" class="" 
						url="${ctx}/comp/ctrl/oper/relatSys/relatSysDet">
							关联系统信息详情查询
						</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane in active" id="tab_list">
						<iframe id="iframe_list" name="iframe_list" src="" style="width: 100%; height: 700px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_add">
						<iframe id="iframe_add" name="iframe_add" src="" style="width: 100%; height: 700px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_mod">
						<iframe id="iframe_mod" name="iframe_mod" src="" style="width: 100%; height: 700px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
					<div class="tab-pane" id="tab_det">
						<iframe id="iframe_det" name="iframe_det" src="" style="width: 100%; height: 700px; border: 0px;"
						scrolling="no" frameborder="no">
						</iframe>
					</div>
				</div>
