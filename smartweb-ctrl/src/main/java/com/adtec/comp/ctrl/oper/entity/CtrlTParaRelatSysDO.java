...
* 功能描述: 关联系统管理数据定义
* 类 名 称  : CtrlTParaRelatSysDO.java
* 软件版权: 北京先进数通信息技术股份公司
* 开发人员: chenyl <br>
* 开发时间: 20200310<br>
* 系统版本: V1.0.0<br>
 ...
 * @version 20200310
 */
public class CtrlTParaRelatSysDO extends BaseDO {
	...
	public CtrlTParaRelatSysDO() {
		super();
	}

	public CtrlTParaRelatSysDO(String id){
		super(id);
	}
	...
	@Length(min=0, max=5, message="运行状态长度必须介于 0 和 5 之间")
	...
	@Length(min=0, max=5, message="通讯状态长度必须介于 0 和 5 之间")
	public String getCommStat() {
		return commStat;
	}

	public void setCommStat(String commStat) {
