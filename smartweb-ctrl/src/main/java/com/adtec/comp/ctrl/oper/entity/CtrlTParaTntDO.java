 ...
 * @version 20200310
 */
public class CtrlTParaTntDO extends BaseDO {
	
	private static final long serialVersionUID = 1L;
	private String tntNo;		// 租户号
	private String tntName;		// 租户名称
	...
	public CtrlTParaTntDO() {
		super();
	}

	public CtrlTParaTntDO(String id){
		super(id);
	}

	@Length(min=1, max=20, message="租户号长度必须介于 1 和 20 之间")
	...
	@Length(min=0, max=120, message="租户名称长度必须介于 0 和 120 之间")
	...
	public String toString() {
		...
		sb.append("CtrlTParaTntDO [ ");
		sb.append("tntNo="+tntNo+" , ");
		sb.append("tntName="+tntName+" , ");
