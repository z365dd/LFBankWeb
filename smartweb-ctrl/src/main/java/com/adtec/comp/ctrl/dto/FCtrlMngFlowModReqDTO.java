 ...
 *
 */
public class FCtrlMngFlowModReqDTO {
	...
	private long NUM;
	/*循环*/
	private List<FCtrlMngFlowModListDTO> FLOW_LIST;
	...
	public List<FCtrlMngFlowModListDTO> getFLOW_LIST() {
		return FLOW_LIST;
	}
	public void setFLOW_LIST(List<FCtrlMngFlowModListDTO> fLOW_LIST) {
		FLOW_LIST = fLOW_LIST;
	}
