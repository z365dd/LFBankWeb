 ...
 *
 */
public class FCtrlMngAuthModListDTO {
	/*模型组件号*/
	...
	private long TP_NUM;
	/*小循环*/
	private List<FCtrlMngAuthModList1DTO> AUTH_AMT_LIST = new ArrayList<FCtrlMngAuthModList1DTO>();
	...
	public List<FCtrlMngAuthModList1DTO> getAUTH_AMT_LIST() {
		return AUTH_AMT_LIST;
	}
	public void setAUTH_AMT_LIST(List<FCtrlMngAuthModList1DTO> aUTH_AMT_LIST) {
