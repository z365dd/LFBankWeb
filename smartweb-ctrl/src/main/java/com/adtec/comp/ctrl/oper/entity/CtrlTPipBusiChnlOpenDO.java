...
* 功能描述: 业务渠道开通数据定义
* 类 名 称  : CtrlTPipBusiChnlOpenDO.java
* 软件版权: 北京先进数通信息技术股份公司
* 开发人员: chenyl <br>
* 开发时间: 20200324<br>
* 系统版本: V1.0.0<br>
 ...
 * @version 20200324
 */
public class CtrlTPipBusiChnlOpenDO extends BaseDO {
	...
	public CtrlTPipBusiChnlOpenDO() {
		super();
	}

	public CtrlTPipBusiChnlOpenDO(String id){
		super(id);
	}
	...
	public String toString() {
		...
		sb.append("CtrlTPipBusiChnlOpenDO [ ");
